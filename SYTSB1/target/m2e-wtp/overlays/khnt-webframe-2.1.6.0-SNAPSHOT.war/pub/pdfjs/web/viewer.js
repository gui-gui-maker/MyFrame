...
PDFJS.imageResourcesPath = 'pub/pdfjs/web/images/';
  PDFJS.workerSrc = 'pub/pdfjs/build/pdf.worker.js';
...
function webViewerInitialized() {
  ...
  var file = $("base").attr("href")+"fileupload/download.do?id=" + params.fid;
