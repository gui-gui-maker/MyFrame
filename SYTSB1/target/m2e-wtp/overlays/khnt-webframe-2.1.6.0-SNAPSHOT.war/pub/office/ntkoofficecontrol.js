...
function initNtkoEditorContainer(containerId,cuser){
	...
	if (_browser == "IE") {
		...
		'<SPAN STYLE="color:red">不能装载文档控件。请在检查浏览器的选项中检查浏览器的安全设置。如果您尚未安装此控件，<a href="pub/tools/dowload_soft.jsp?fpath=T0ZGSUNFzsS1tb/YvP6wstews8zQ8i5tc2k=">请点击这里下载</a></SPAN> ' +
		'</object>';
