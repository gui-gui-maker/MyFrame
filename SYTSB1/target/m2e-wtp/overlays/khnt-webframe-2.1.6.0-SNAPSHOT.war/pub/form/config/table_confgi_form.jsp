...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head pageStatus="${param.status}">
		...
		<link href="k/kui/skins/Aqua/css/ligerui-all.css" rel="stylesheet"
			type="text/css" />
		<!-- ligerui框架css -->
		<link href="k/app/skins/Aqua/css/ligerui-all.css" rel="stylesheet"
			type="text/css" />
...
function bulidMainGrid(columns)
{
    ...
    $(columns).each(function ()
    {
        var row = {
            ...
            search_newline : this.search_newline,
            inlist: this.inlist,
    ...
    window.grid =  gridPanle.ligerGrid({
        columns: [
            ...
            { display: '是否新行', name: 'search_newline', width: 55, render: checkboxRender },
             { display: '是否发送', name: 'isSend', width: 55, render: checkboxRender }, 
            { display: '是否可配', name: 'isConfig', width: 55, render: checkboxRender }, ]
            },
            ...
            { display: '标签宽度', name: 'labelwidth', align: 'right', width: 55, editor: { type: 'text'} },
            { display: '控件宽度', name: 'width', align: 'right', width: 55, editor: { type: 'text'} },
            { display: '间隔宽度', name: 'space', align: 'right', width: 55, editor: { type: 'text'} },
...
function createGridToolbar(tName)
{
    ...
    items.push({ text: '导出JSON', click: outjson, img: "pub/form/config/icons/printer_48.png" });
    ...
    function preview()
    {
        ...
        out.push('          <span>搜索</span><img src="pub/form/config/Source/lab/icons/searchtool.gif" />');
        ...
        {
            var items = [];
            items.push({ text: '增加', click: grid_add, img: "pub/form/config/Source/lab/icons/page_add.png" });
            items.push({ text: '修改', click: grid_edit, img: "pub/form/config/Source/lab/icons/edit.gif" });
            items.push({ text: '删除', click: grid_delete, img: "pub/form/config/Source/lab/icons/delete.png" });
...
{ 
    ...
    function getFieldData(o, search)
    {
        ...
        var field = {
            ...
            isConfig: o.isConfig,
            dataBind:o.dataBind,
            search_newline:o.search_newline
        }; 
        if (!search)
        {
