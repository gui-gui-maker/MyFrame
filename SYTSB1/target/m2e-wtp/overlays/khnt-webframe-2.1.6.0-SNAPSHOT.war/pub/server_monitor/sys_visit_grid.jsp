...
$(function() {
	...
	window["dataGrid"] = $("#dataGrid").ligerGrid({
		columns: [{
			id:"name", name:"name", display:"资源名称", width:355, align:"left",render:function(rowData,idx){
				if(rowData.url){
...
function openList(uri){
	winOpen({
		...
		lock: true,
		content:"url:pub/server_monitor/sys_visit_list.jsp?showUrl=0&url=" + uri
	});
}
function doQuery(){
	var cparam = "{";
...
<body class="p5" style="overflow:auto;">
	...
	<div class="wrap" style="width:100%">
        <div class="cnwp">
            <div class="caption_div">系统功能模块访问统计情况</div>
            <div id="dataGrid"></div>
        </div>
    </div>
</body>
