	...
	$(function() {
		...
		toolbarManager = $("#toptoolbar").ligerToolBar(
			...
			items: [ {
				...
				text: '删除',id: 'del',click: del,icon: "delete",disable: true
			}, "-", {
            ...
            { text:'授权', id:'per',icon:'setting', click:authorized,disable:true },
            "-",
            { text:'导出 ', id:'exp',icon:'export', click:exportCode,disable:true },
            "-",
            { text:'导入 ', id:'imp',icon:'basket-put', click:importCode }
			, "-", {
			...
			<sec:authorize ifNotGranted="super_administrate">
				<tbar:toolBar type="ligerToolBar" code="codetable">
				</tbar:toolBar>
			</sec:authorize>
		);
		...
		$.getJSON("pub/codetable/codetableTree.do",function(data){
			treeData = data;
			createTree(treeData);
			//treeManager.selectNode("system_code_table");
		});
