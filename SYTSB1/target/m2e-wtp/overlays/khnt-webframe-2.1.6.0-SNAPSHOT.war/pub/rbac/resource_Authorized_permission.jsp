...
<script type="text/javascript">
	...
	$(function() {
		...
		api.button({
			name : '授权',
			callback : doAuthorizedPermission,
			icon : 'setting',
			id : "authorized"
		});
	...
	function initPermisstionList() {
		...
		if ("" == "${param.rid}") {
			...
			$("body").mask("正在初始化列表...");
			$.getJSON("rbac/resource/initResourcePermission.do?resourceId=${param.rid}", function(response) {
