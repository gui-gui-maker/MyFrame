...
<head>
	...
	<script type="text/javascript">
		...
		function renderImage(t,url) {
			...
			$("#imgLoading").show();
			loadImage(t==1?url:"fileupload/download.do?id=" + api.data.images[_current_image_index].id,function(){
		...
		function pageInit(){
			...
			if (imageUrl) {
				...
				$("#imgWrap").append("<img class='current' />");
				renderImage(1,"fileupload/download.do?id=" + urlId);
...
<style type="text/css">
	...
	.nav{width:50px;height:100%;cursor:pointer;position:fixed;top:33px;z-index:999;}
	.nav.nav-prev{left:0;background: url("pub/fileupload/images/prev-gray.png") no-repeat center center;}
	.nav.nav-next{right:0;background: url("pub/fileupload/images/next-gray.png") no-repeat center center;}
	.nav.nav-prev:HOVER {background: url("pub/fileupload/images/prev.png") no-repeat #EDEDED center center;}
	.nav.nav-next:HOVER {background: url("pub/fileupload/images/next.png") no-repeat #EDEDED center center;}
