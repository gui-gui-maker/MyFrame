...
<head pageKeys="login">
	...
	<link rel="stylesheet" type="text/css" href="app/public/login/2/login.css" media="all" />
	<link rel="stylesheet" type="text/css" href="app/public/login/2/login2.css" media="all" />
	...
	<script type="text/javascript">
		...
		var imageJson=[
			...
			//		{img:"k/kui/public/images/login2/loginbg_05.jpg"},
			{img:"app/szh/loginbg_16.jpg"}
		];
	...
	<script type="text/javascript" src="app/public/login/2/login.js"></script>
</head>
<body>
