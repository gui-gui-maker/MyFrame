...
kFrameConfig=$.extend(true,{},kFrameConfig,{
	loginOnLoadBefore:function(){//登录页面载入事件 2013-01-31 15:59:59 lybide
		...
		//===========================================================
		var str1='';
		str1+='<div id="caption" class="tabeffect logintab ">';
		str1+='<ul>';
		str1+='<li><a href="javascript:void(0);" title="" tabId="tablink1" class="loginapp"><span></span> 扫码登录</a></li>';
		str1+='<li><a href="javascript:void(0);" title="" tabId="tablink2">帐号登录</a></li>';
		str1+='</ul>';
		str1+='</div>';

		str1+='<div class="tent-list" tabId="tablink1" >';
		str1+='<div class="qrcode-mod">';
		str1+='<div class="qrcode-main">';
		str1+='<div class="qrcode-img"></div>';
		str1+='</div>';
		str1+='<p class="qrcode-desc">打开 手机APP 扫一扫登录</p>';
		str1+='</div>';
		str1+='<div class="qrlogin-other">';
		str1+='<div><a href="#" target="_blank" >下载手机端APP ></a></div>';
		str1+='</div>';
		str1+='</div>';

		str1+='<div class="login-check-mobile">';
		str1+='<div class="lcm-img"></div>';
		str1+='<div class="lcm-txt">请在手机上确认登录操作</div>';
		str1+='</div>';
		$("#k-login-box").append(str1);console.log(str1);
		...
		if (isShell) {
			...
			if (autoLogin=="1" || autoRememberPass=="1") {
				//var oneExe1=setTimeout(function(){
					...
					//2017年08月08日 16:54:15 星期二 lybide 解决在ie8外壳中，不显示登陆提示
					setTimeout(function(){$("#TxtUserName-msg,#TxtPassword-msg").hide();},1);
				//},10);
			}
			if (autoLogin=="1") {
				var oneExe1=setTimeout(function(){
