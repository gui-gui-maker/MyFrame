/**
 * jQuery ligerUI 1.3.3 ligerPanel
 *
 * http://ligerui.com
 *
...
(function($) {
	...
	$.ligerui.controls.Panel.ligerExtend($.ligerui.core.UIComponent, {
		...
		_setShowToggle: function(v) {
			...
			if (v) {
				var toggle = $("<a class='l-panel-icon iconfont l-panel-header-toggle'></a>");
		...
		_setShowClose: function(v) {
			...
			var header = g.panel.find(".l-panel-header:first");
			if (v) {
				var btn = $("<a class='l-panel-icon iconfont l-panel-header-close'></a>");
		...
		_setShowRefresh: function(v) {
			...
			var header = g.panel.find(".l-panel-header:first");
			if (v) {
				var btn = $("<a class='l-panel-icon iconfont l-panel-header-refresh'></a>");
				btn.appendTo(header.find(".icons"));
