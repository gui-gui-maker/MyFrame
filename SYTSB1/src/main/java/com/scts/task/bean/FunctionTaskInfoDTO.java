...
/**
 * 检验和质量管理软件功能开发（修改）任务书数据传输对象
 * FunctionTaskInfoDTO. 
 * @author GaoYa
 * @date 2016-11-22 上午11:50:00
 */

public class FunctionTaskInfoDTO{

	private String id;					// ID
	private String sn;					// 业务流水号（格式例如2016-001）
	...
	private String create_user_id;		// 任务下达人ID
	private String create_user_name;	// 任务下达人姓名
	private Date   create_date;			// 任务下达日期
	private String issue_user_id;		// 签发人ID
	private String issue_user_name;		// 签发人姓名
	...
	private String data_status;			// 数据状态（0：任务下达 1：任务签发 2：任务接收 3：任务开发中 
										// 4：任务开发完成 5：任务测试中 6：任务测试完成 7：任务确认完成 99：已删除）
