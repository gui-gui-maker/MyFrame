...
/**
 * 系统运行维护台账明细表
 * MaintenanceInfo entity. 
 * @author GaoYa
 * @date 2015-09-08 下午01:15:00
 * @update 2017-08-03 下午04:30:00
 */
@Entity
@Table(name = "TZSB_MAINTENANCE_INFO")
@JsonIgnoreProperties(ignoreUnknown = true, value = { "maintenance"})
public class MaintenanceInfo implements BaseEntity {
	...
	@JoinColumn(name = "fk_maintenance_id")
