...
@Entity
@Table(name = "TJY2_QUALITY_NOTE")
@JsonIgnoreProperties(ignoreUnknown=true)
public class QualityNote implements BaseEntity{
    ...
    private String inspectorPeopleId;//监检机构技术负责人ID

    private String inspectorPeople;//监检机构技术负责人

    private java.util.Date inspectorPeopleDate;//日期
    ...
    private String sealPeopleId;//盖章人ID

    private String sealPeopleName;//盖章人姓名

    private java.util.Date sealDate;//盖章时间
    
    private String sealStatus;//盖章状态
    ...
    public void setInspectorPeopleId(String value){
        this.inspectorPeopleId = value;
    }
    public void setInspectorPeople(String value){
        this.inspectorPeople = value;
    }
    public void setInspectorPeopleDate(java.util.Date value){
        this.inspectorPeopleDate = value;
    }
    ...
    public void setSealPeopleId(String value){
        this.sealPeopleId = value;
    }
    public void setSealPeopleName(String value){
        this.sealPeopleName = value;
    }
    public void setSealStatus(String value){
        this.sealStatus = value;
    }
    ...
    @Column(name ="INSPECTOR_PEOPLE_ID",unique=false,nullable=true,insertable=true,updatable=true,length=32)
    public String getInspectorPeopleId(){
        return this.inspectorPeopleId;
    }
    @Column(name ="INSPECTOR_PEOPLE",unique=false,nullable=true,insertable=true,updatable=true,length=100)
    public String getInspectorPeople(){
        return this.inspectorPeople;
    }
    @Column(name ="INSPECTOR_PEOPLE_DATE",unique=false,nullable=true,insertable=true,updatable=true,length=7)
    public java.util.Date getInspectorPeopleDate(){
        return this.inspectorPeopleDate;
    }
    ...
    @Column(name ="SEAL_PEOPLE_ID",unique=false,nullable=true,insertable=true,updatable=true,length=32)
    public String getSealPeopleId(){
        return this.sealPeopleId;
    }
    @Column(name ="SEAL_PEOPLE_NAME",unique=false,nullable=true,insertable=true,updatable=true,length=32)
    public String getSealPeopleName(){
        return this.sealPeopleName;
    }
    @Column(name ="SEAL_STATUS",unique=false,nullable=true,insertable=true,updatable=true,length=32)
