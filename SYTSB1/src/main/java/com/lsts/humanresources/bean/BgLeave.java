...
public class BgLeave implements BaseEntity{
    ...
    @Column(name = "REVOKE_BUS_ID")
    public String getRevokeBusId() {
        return revokeBusId;
    }

    public void setRevokeBusId(String revokeBusId) {
        this.revokeBusId = revokeBusId;
    }
}
