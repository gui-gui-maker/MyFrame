 ...
 * </p>
 * 
 * @ClassName Tjy2RlUploadDao
 * @JDK 1.5
 * @author 
 * @date  
 */
@Repository("uploadsDao")
public class UploadsDao extends EntityDaoImpl<Uploads> {
	/**
	 * 取得合同文档
	 * 
	 * @param id
	...
	public byte[] getFile(String id) {
		String sqlString = "select t.upload_doc from TJY2_ARCHIVES_UPLOAD t where t.id = ?";
	...
	public String saveO(InputStream inputStream, Uploads uploads) {
			...
			// 新建记录
			this.createSQLQuery(
					"update TJY2_ARCHIVES_UPLOAD set upload_doc=? where id=?",
					in_b,uploads.getId()).executeUpdate();
		/*}*/
