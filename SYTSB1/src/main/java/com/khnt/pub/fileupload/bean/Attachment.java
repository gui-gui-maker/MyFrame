package com.khnt.pub.fileupload.bean;
...
public class Attachment implements BaseEntity {
	...
	private String tz_category;		// 运行维护台账附件类型（任务说明附件：task 完成更新说明附件：update）
	...
	@Column(name = "TZ_CATEGORY")
	public String getTz_category() {
		return tz_category;
	}

	public void setTz_category(String tz_category) {
		this.tz_category = tz_category;
	}
