...
<style type="text/css">
	...
	.l-fieldset1 { padding:5px;border:1px solid #a2c8fb;margin:100px 200px 100px 200px;border-radius:5px 5px 5px 5px;}
...
<body>
	<form name="formObj2" id="formObj2" method="post"
		...
		<input type="hidden" name="request_uri" 
<%-- 		value="/app/supplies/warehousing/bx_detail.jsp?zje=${param.zje }&hb=${param.bh}&ids=${param.ids}&fgld=${param.fgld}"/> --%>
		value="/app/supplies/warehousing/bx_detail.jsp?zje=${param.zje }&hb=${param.bh}&ids=${param.ids}&fgld=${param.fgld}"/>
