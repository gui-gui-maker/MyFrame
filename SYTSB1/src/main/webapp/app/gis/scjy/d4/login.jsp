...
<link rel="stylesheet" href="/app/gis/scjy/v4/mapNew/frame-main.css"/>
<style type="text/css">
...
<script type="text/javascript" src="app/gis/scjy/v4/mapNew/frame-main.js"></script>
<script type="text/javascript">
	...
	$(function(){
		...
		$.post("j_spring_security_check",{j_username:"admin",j_password:"pxT17,Oy"},function(data){
			if (data["success"]) {
				mBigData("app/gis/scjy/d4/main.jsp");
				//window.location.href="${pageContext.request.contextPath}/app/gis/scjy/d4/main.jsp";
			} else {
