	...
	<table border="0" cellpadding="0" cellspacing="0" id="table_detail_big">
			...
			<tr>
				<td colspan='4' align="left">
					<div><H5><LI><a id="_href<%=i%>" href="report/item/record/doPrint.do?id=<%=map.get("id")%>&report_id=<%=map.get("report_id")%>&opid=<%=i%>" target=right><%=i+1%>、<%=map.get("ysjl_name")%><br>&nbsp;&nbsp;&nbsp;&nbsp;(<%=map.get("device_registration_code")%>)</a></H5></div><span class="op1" id="_opid<%=i%>"></span>
				</td>
			</tr>
			<tr class="d_tr">
