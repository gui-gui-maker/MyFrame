...
<%
    ...
    String pSql= "select a.id,a.pid,a.name as code"
    		 +" from (select o.id, decode(o.parent_id,null,'0',o.parent_id) pid, o.org_name name"
    		 +"         from SYS_org o "
    		 +"        where o.property = 'dep' "
    		 +"           or o.id = '100000' "
    		 +"          and o.status = 'used' "
    		 +"       union "
    		 +"      select t.id, t.org_id pid, t.name "
    		 +"        from SYS_USER t "
    		 +"       where t.status = '1') a "
    ...
    Object typeN = request.getSession().getAttribute("type");
    if(typeN!=null&&StringUtil.isNotEmpty(typeN.toString())){
    	type = typeN.toString().split(",");
    }
    //{id:'JXGZ_BY',text:'绩效工资备用'},
    String gzColum = "[{id:'JBGZ_GWGZ',text:'基本工资岗位工资'},{id:'JBGZ_XJGZ',text:'基本工资薪级工资'},"
                     +" {id:'JBGZ_BLBT',text:'基本工资保留补贴'},{id:'JBGZ_LT',text:'基本工资粮贴'},"
                     +"{id:'JBGZ_BFX',text:'基本工资补发项'},{id:'JBGZ_DZ',text:'基本工资独子'},{id:'JBGZ_XJ',text:'基本工资小计'},"
                     ...
                     +"{id:'JXGZ_BT_QT',text:'绩效工资补贴其他'}, {id:'JXGZ_XJ',text:'绩效工资小计'},"
                     ...
                     +" {id:'KKX_GHJF',text:'扣款项工会经费'},{id:'KKX_SDS',text:'扣款项所得税'},{id:'KKX_XJ',text:'扣款项小计'},"
                     +"{id:'KKX_OLDBX_MY',text:'扣款项养老保险每月'},{id:'KKX_OLDBX_BF',text:'扣款项养老保险补发'},"
                     +" {id:'FSALARY',text:'应发合计'}]";
   %>
...
<script type="text/javascript" src="pub/selectUser/selectUnitOrUser.js"></script>
  ...
  //获取数据
    function getRows(isInitSelect){
        ...
        var unit = $("#unit").ligerGetComboBoxManager().getValue();
        ...
        $.post("finance/feeSalaryAction/salaryFee.do",
        		{"start":startDate,"end":endDate,'dept':dept,'unit':unit,'gzItem':gzItem,'peoId':peoId,'types':typess}, 
        		function(res){
        			//接收数据
		            var data = res.data;
		            //组装数据
    				 ...
    				 depts = [];
		            	for(var k=0;k<data.length;k++){
		            		...
		            		row['NAME'] = data[k][0];
		            		if(gzItem!=""){
		            			var gzItems = gzItem.split(",");
		            			for(var i=0;i<gzItems.length;i++){
		            				row[gzItems[i]] = data[k][i+1];
		            			}
		            		}else{
	...
	function loadGrid(rows,fix){
	    ...
	    var columns = [];
					...
					columns.push({
						...
						if (((selected != null && selected['基本工资岗位工资'] == true) || selected == null)
								&& items.indexOf(",JBGZ_GWGZ,") != -1) {
							columns
									.push({
										display : '基本工资岗位工资',
										name : 'JBGZ_GWGZ',
						...
						if (((selected != null && selected['基本工资薪级工资'] == true) || selected == null)
								&& items.indexOf(",JBGZ_XJGZ,") != -1) {
							columns
									.push({
										display : '基本工资薪级工资',
										name : 'JBGZ_XJGZ',
						...
						if (((selected != null && selected['基本工资保留补贴'] == true) || selected == null)
								&& items.indexOf(",JBGZ_BLBT,") != -1) {
							columns
									.push({
										display : '基本工资保留补贴',
										name : 'JBGZ_BLBT',
						...
						if (((selected != null && selected['基本工资粮贴'] == true) || selected == null)
								&& items.indexOf(",JBGZ_LT,") != -1) {
							columns.push({
								display : '基本工资粮贴',
								name : 'JBGZ_LT',
								align : 'center',
						...
						if (((selected != null && selected['基本工资补发项'] == true) || selected == null)
								&& items.indexOf(",JBGZ_BFX,") != -1) {
							columns.push({
								display : '基本工资补发项',
								name : 'JBGZ_BFX',
								align : 'center',
						...
						if (((selected != null && selected['基本工资独子'] == true) || selected == null)
								&& items.indexOf(",JBGZ_DZ,") != -1) {
							columns.push({
								display : '基本工资独子',
								name : 'JBGZ_DZ',
								align : 'center',
						...
						if (((selected != null && selected['基本工资小计'] == true) || selected == null)
								&& items.indexOf(",JBGZ_XJ,") != -1) {
							columns.push({
								display : '基本工资小计',
								name : 'JBGZ_XJ',
								align : 'center',
						...
						if (((selected != null && selected['绩效工资基础绩效每月'] == true) || selected == null)
								&& items.indexOf(",JXGZ_JCJX_MY,") != -1) {
							columns.push({
								display : '绩效工资基础绩效每月',
								name : 'JXGZ_JCJX_MY',
								align : 'center',
						...
						if (((selected != null && selected['绩效工资基础绩效补发'] == true) || selected == null)
								&& items.indexOf(",JXGZ_JCJX_BF,") != -1) {
							columns.push({
								display : '绩效工资基础绩效补发',
								name : 'JXGZ_JCJX_BF',
								align : 'center',
						...
						if (((selected != null && selected['绩效工资季度绩效'] == true) || selected == null)
								&& items.indexOf(",JXGZ_JDJX,") != -1) {
							columns.push({
								display : '绩效工资季度绩效',
								name : 'JXGZ_JDJX',
								align : 'center',
						...
						if (((selected != null && selected['绩效工资补贴驻场补贴'] == true) || selected == null)
								&& items.indexOf(",JXGZ_BT_ZCBT,") != -1) {
							columns.push({
								display : '绩效工资补贴驻场补贴',
								name : 'JXGZ_BT_ZCBT',
								align : 'center',
						...
						if (((selected != null && selected['绩效工资补贴其他'] == true) || selected == null)
								&& items.indexOf(",JXGZ_BT_QT,") != -1) {
							columns.push({
								display : '绩效工资补贴其他',
								name : 'JXGZ_BT_QT',
								align : 'center',
						...
						if (((selected != null && selected['绩效工资备用'] == true) || selected == null)
								&& items.indexOf(",JXGZ_BY,") != -1) {
							columns.push({
								display : '绩效工资备用',
								name : 'JXGZ_BY',
								align : 'center',
						...
						if (((selected != null && selected['绩效工资小计'] == true) || selected == null)
								&& items.indexOf(",JXGZ_XJ,") != -1) {
							columns.push({
								display : '绩效工资小计',
								name : 'JXGZ_XJ',
								align : 'center',
						...
						if (((selected != null && selected['扣款项职业年金每月'] == true) || selected == null)
								&& items.indexOf(",KKX_ZYNJ_MY,") != -1) {
							columns.push({
								display : '扣款项职业年金每月',
								name : 'KKX_ZYNJ_MY',
								align : 'center',
						...
						if (((selected != null && selected['扣款项职业年金补扣'] == true) || selected == null)
								&& items.indexOf(",KKX_ZYNJ_BK,") != -1) {
							columns.push({
								display : '扣款项职业年金补扣',
								name : 'KKX_ZYNJ_BK',
								align : 'center',
						...
						if (((selected != null && selected['扣款项医疗保险每月'] == true) || selected == null)
								&& items.indexOf(",KKX_YLBX_MY,") != -1) {
							columns.push({
								display : '扣款项医疗保险每月',
								name : 'KKX_YLBX_MY',
								align : 'center',
						...
						if (((selected != null && selected['扣款项医疗保险补发'] == true) || selected == null)
								&& items.indexOf(",KKX_YLBX_BF,") != -1) {
							columns.push({
								display : '扣款项医疗保险补发',
								name : 'KKX_YLBX_BF',
								align : 'center',
						...
						if (((selected != null && selected['扣款项失业每月'] == true) || selected == null)
								&& items.indexOf(",KKX_SY_MY,") != -1) {
							columns.push({
								display : '扣款项失业每月',
								name : 'KKX_SY_MY',
								align : 'center',
						...
						if (((selected != null && selected['扣款项失业补发'] == true) || selected == null)
								&& items.indexOf(",KKX_SY_BF,") != -1) {
							columns.push({
								display : '扣款项失业补发',
								name : 'KKX_SY_BF',
								align : 'center',
						...
						if (((selected != null && selected['扣款项公积金每月'] == true) || selected == null)
								&& items.indexOf(",KKX_GJJ_MY,") != -1) {
							columns.push({
								display : '扣款项公积金每月',
								name : 'KKX_GJJ_MY',
								align : 'center',
						...
						if (((selected != null && selected['扣款项公积金补发'] == true) || selected == null)
								&& items.indexOf(",KKX_GJJ_BF,") != -1) {
							columns.push({
								display : '扣款项公积金补发',
								name : 'KKX_GJJ_BF',
								align : 'center',
						...
						if (((selected != null && selected['扣款项工会经费'] == true) || selected == null)
								&& items.indexOf(",KKX_GHJF,") != -1) {
							columns.push({
								display : '扣款项工会经费',
								name : 'KKX_GHJF',
								align : 'center',
						...
						if (((selected != null && selected['扣款项所得税'] == true) || selected == null)
								&& items.indexOf(",KKX_SDS,") != -1) {
							columns.push({
								display : '扣款项所得税',
								name : 'KKX_SDS',
								align : 'center',
						...
						if (((selected != null && selected['扣款项小计'] == true) || selected == null)
								&& items.indexOf(",KKX_XJ,") != -1) {
							columns.push({
								display : '扣款项小计',
								name : 'KKX_XJ',
								align : 'center',
						...
						if (((selected != null && selected['扣款项养老保险每月'] == true) || selected == null)
								&& items.indexOf(",KKX_OLDBX_MY,") != -1) {
							columns.push({
								display : '扣款项养老保险每月',
								name : 'KKX_OLDBX_MY',
								align : 'center',
						...
						if (((selected != null && selected['扣款项养老保险补发'] == true) || selected == null)
								&& items.indexOf(",KKX_OLDBX_BF,") != -1) {
							columns.push({
								display : '扣款项养老保险补发',
								name : 'KKX_OLDBX_BF',
								align : 'center',
						...
						if (((selected != null && selected['应发合计'] == true) || selected == null)
								&& items.indexOf(",FSALARY,") != -1) {
							columns.push({
								display : '应发合计',
								name : 'FSALARY',
								align : 'center',
					...
					function out() {
						...
						$("#form1").attr("action",
								"finance/feeSalaryAction/exportSalaryFee.do");
						if (!hasOut) {
							if (selected != null) {
								var item = '';
								...
								$("#form1")
										.append(
												'<input type="hidden" name="items" id="items" value="'+item+'"/>');
							} else {
								$("#form1").append(
										'<input type="hidden" name="items" id="items" value="'
												+ $("#gzItem").val() + '"/>');
							}
							var itemV = $("#gzItem").ligerGetComboBoxManager()
									.getValue();
							$("#form1")
									.append(
											'<input type="hidden" name="gzItemV" id="gzItemV" value="'+itemV+'"/>');
						} else {
							if (selected != null) {
								var item = '';
								for ( var key in selected) {
...
<div class="item-tm">
    <div class="l-page-title2 has-icon has-note" style="height: 120px">
        ...
        <div class="l-page-title-content" style="top:5px;height:80px;"> 
                ...
                <tr>
                    ...
                    <td width="110px">
                       <input id="unit" name="unit"
							...
							ligerui="{isTextBoxMode:true,width:200,
							initValue:'检验院',
                    ...
                    <td width="60" class = "dept" style="text-align: right;">部门：</td>
                    <td width="110px" class = "dept">
                       <input id="dept" name="dept"
							type="text" ltype="select" value=""
							ligerui="{width:200,
							tree:{checkbox:false,
							data: <u:dict sql="select o.id,o.parent_id pid,o.id code,o.org_name text from SYS_ORG o where  o.id <> '100042' and o.parent_id<>'100042' and o.status='used'" />}
							}" />
                 ...
                 <tr>
                 	<td width="80" style="text-align: right;width:80px;">工资项目：</td>
                    <td  colspan="7">
                 ...
                 <tr>
                 	<td width="80" style="text-align: right;width:80px;">选择人员：</td>
                    <td  colspan="7">
                    <input type = "hidden" name="peoId" id="peoId" >
                    	 <input id="peoName" name="peoName"
							type="text" ltype="text" value=""
							onclick="selectUnitOrUser(1,1,'peoId','peoName')"
					ligerui="{iconItems:[
							{icon:'user',click:function(val,e,srcObj){selectUnitOrUser(1,1,'peoId','peoName')}}
							]}" />
                    </td>
                </tr>
            </table>
