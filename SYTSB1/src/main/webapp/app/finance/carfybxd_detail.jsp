     ...
     <input type="hidden" id="projectItemId4" name="projectItemId4"/>
            ...
            <th style="border:0px;width:40px"></th>
                ...
                <tr>
                  ...
                  <td class="l-t-td-right" colspan="2">
                    <input  validate="{maxlength:50}" ltype="text"  name="costItem1" type="text"/>
                  <td class="l-t-td-right" colspan="2">
                ...
                <tr>
                  <td class="l-t-td-right" colspan="2">
                   <input ltype='text'  name="projectItemName2" type="text" id="projectItemName2" readonly="readonly" onclick="selectCarNo('projectItemName2')" 
                  ...
                  <td class="l-t-td-right" colspan="2">
                    <input ltype='text' name="costItem2" type="text" id="costItem2"/></div></td>
                  <td class="l-t-td-right" colspan="2">
                ...
                <tr>
                  ...
                  <td class="l-t-td-right" colspan="2">
                      <input ltype='text'  name="costItem3" type="text" id="costItem3"/>
                  <td class="l-t-td-right" colspan="2">
                ...
                <tr>
                  <td class="l-t-td-right" colspan="2">
                    ...
                    ligerui="{iconItems:[{img:'k/kui/images/icons/16/icon-down.png',click:function(val,e,srcObj){selectCarNo('projectItemName4')}}]}"/></td>
                  <td class="l-t-td-right" colspan="2">
