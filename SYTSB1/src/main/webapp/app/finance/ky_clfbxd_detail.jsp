...
String lb_type_sql = "select  t.id as code,t.project_name as text from TJY2_SCIENTIFIC_RESEARCH t where t.status='0'";
%>
<!--获取当前登录人  -->
<%
...
<form id="form1" action="finance/clfbxd/save.do" getAction="finance/clfbxd/detail.do?id=${param.id}">
  ...
  <input  name="clSj" type="text" ltype="date" validate="{required:true}" 
              ...
              <tr id="data_tr1">
                ...
                <td class="l-t-td-right" colspan="2">
                    <input  validate="{maxlength:32}" ltype='text'   name="clZdDd1" id='clZdDd1' type="text"  />
                </td>
