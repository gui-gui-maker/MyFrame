...
<script type="text/javascript">
	var qmUserConfig = {
		...
		tbar:[
             { text:'差旅费详情', id:'detail',icon:'detail', click: detailUser},
              { text:'费用报销详情', id:'detail',icon:'detail', click: detailUser1}
        ],
        listeners: {
	...
	function detailUser1() {
		top.$.dialog({
			...
			data : {"window" : window},
			cancel : true,
			content : 'url:app/finance/fcp_fybxd_list.jsp?status=detail&id=' + Qm.getValueByName("employee_id")
		});
	}
...
<body>
	<qm:qm pageid="TJY2_FCP1" script="false" singleSelect="true">
