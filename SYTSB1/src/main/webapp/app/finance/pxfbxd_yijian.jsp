        ...
        $("#fgld").hide();
           ...
           if ("${param.pageStatus}"=="modify"){
            var tbar=[{ text: '保存', id: 'up', icon: 'save', click: save},
                       {
    			text:'审核', id: 'submitsh', icon: 'dispose', click:submitsh
        ...
        /* function submitsh(){ 
            ...
            $.ajax({
                ...
                success: function (data, stats) {
                    ...
                    if (data["success"]) {
                        toDetail();
                        $("#form1").setValues("finance/pxfbxd/detail.do?id=${param.id}");
                        top.$.dialog.notice({content:'操作成功！'});
                		...
                		top.$.dialog({
                			...
                			title: "审核",
                			content: 'url:app/finance/pxfbxd_yijian.jsp?id=' + id + '&pageStatus=detail'
                		});
                    }else{
                        $.ligerDialog.error('提示：' + data.msg);
			...
			<tr>
				...
				<td colspan="11" class="l-t-td-right" id="reader_td"><input
					...
					id="clCcid" type="hidden" /> <c:if
						...
						<span id="addReader" class="l-button label" title="添加接收人">
