            ...
            <th style="border:0px;width:40px"></th>
                ...
                <tr>
                  <td class="l-t-td-right" colspan="2">
                    <input ltype="text" id="projectItemName1" name="projectItemName1" type="text" onclick="selectCarNo('projectItemName1')"
                ...
                <tr>
                  <td class="l-t-td-right" colspan="2">
                    <input ltype="text" id="projectItemName2"  name="projectItemName2" type="text" onclick="selectCarNo('projectItemName2')"
