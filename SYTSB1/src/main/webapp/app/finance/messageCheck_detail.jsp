            ...
            var dhhm=$("#account").val();
         	...
         	if(yzm==yzm1){
         		...
         		var formData = $("#form1").getValues();
           	 	var obj=$("#form1").validate().form();
      		 	$.ajax({
	          		url : 'finance/messageCheckAction/savetime.do',
	          		type : "POST",
	          		dataType : "json",
	          		contentType : "application/json; charset=utf-8",
	          		data: $.ligerui.toJSON(formData),
	          		success : function(data, stats) {
	          			if(data.sc123){
		         			...
		         			JavaScript:window.location.href=projectName+"/finance/importSalary_list.jsp"; 
	          			}else{
	          				$("body").unmask();
...
//           			$.ligerDialog.confirm('验证码失效，请刷新后重新发送！！', function (yes){
//        		    		location.reload();
//        				});
//           		 $("body").unmask();
...
<form id="form1" action="mobileMessage/nk/saveBasic.do" getAction="mobileMessage/nk/detail.do?id=${param.id}">
   ...
   <%--  <table  class="l-table" align="center">
        <tr>
            <td class="l-t-td-left"><font >电话号码</br>或</br>微信账号</font></td>
             <!--当前登录人号码不可改变  -->
            <td class="l-t-td-right"><input readonly="readonly"  value="<%=user.getSysUser().getEmployee().getMobileTel() %>" style="width: 200px" id="account"  name="account" type="text" ltype="text" validate="{required:true,maxlength:11}" /></td>
            
            <td  style="width: 200px" align="center">
                <a class="l-button-warp l-button" href="javascript:send();"><span class="l-button-main l-button-hasicon"><span class="l-button-text">发短信</span><span class="l-button-icon l-icon-comment"></span></span></a>
            </td>
            <td>
                <a  class="l-button-warp l-button" href="javascript:sendwx();" style="margin-top:2px"><span class="l-button-main l-button-hasicon"><span class="l-button-text">发微信</span><span class="l-button-icon l-icon-discuss"></span></span></a>
            </td>
        </tr>
        <tr>
            <td class="l-t-td-left">验证码</td>
            <td class="l-t-td-right"><input  style="width: 200px" name="yzm" id="yzm" validate="{maxlength:6}"></input></td>
            <td colspan="2" align="center">
                <a class="l-button-warp l-button" href="javascript:submit();"><span class="l-button-main l-button-hasicon"><span class="l-button-text">提　交</span><span class="l-button-icon l-icon-check"></span></span></a><input  type="hidden"   value="" id="fkMsg" name=fkMsg />
            </td>
        </tr>
	</table> --%>
	...
	<table id="tab1" border="0" cellpadding="3" cellspacing="0" style="width: 60%"   align="center">
        ...
        <tr>
			<td class="l-t-td-left"></td>
			<td   class="l-t-td-right">
			  <input  type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;" onclick="aas();" />
			</td>
			<td align="center" class="l-t-td-right"></td>
		</tr>
