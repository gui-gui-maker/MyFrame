...
// 						data : {
// 							"window" : window,id:'402883a260d5251a0160de022f6a3f5f'
// 						}
// 					}); 
    ...
    window.onload = function() { 
    	$('#unit-txt').change(function() {
			...
			if("四川省特种设备检验研究院" == unit || "中共四川省特种设备检验研究院委员会" == unit || "四川省特种设备检验检测协会" == unit){
    			...
    			$("#department").val(unit);
			}else if("特检协会及司法鉴定中心联合工会委员会" == unit){
    			$("#department").val(unit);
			}
		});
    }; 
      ...
      <input type="hidden" value="" id="departmentId" name="departmentId">
            ...
            <th style="border:0px;width:40px"></th>
                ...
                <tr>
                  ...
                  <td class="l-t-td-right" colspan="3">
                    <input  validate="{maxlength:50}" ltype="text"  name="costItem1" type="text" /></td>
                ...
                <tr>
                  ...
                  <td class="l-t-td-right" colspan="3">
                   <input ltype='text'  name="costItem2" type="text" id="FinancialItemsName2" /></td>
                  <td class="l-t-td-right" colspan="2">
                ...
                <tr>
                  ...
                  <td class="l-t-td-right" colspan="3">
                      <input ltype='text'  name="costItem3" type="text" id="FinancialItemsName3" /></td>
                  <td class="l-t-td-right" colspan="2">
                ...
                <tr>
                  ...
                  <td class="l-t-td-right" colspan="3">
                    <input ltype='text'  name="costItem4" type="text" id="FinancialItemsName4" />
                  </td>
                  <td class="l-t-td-right" colspan="2">
