		...
		listeners: {
			/* rowClick: function(rowData, rowIndex) {
				...
				if(type.indexOf("派车中") >= 0 || type.indexOf("用车中") >= 0){
					Qm.setTbar({edit:false,del:false,infoServe:false,serveMainIndex:false,customerMarketSituation:false,mainEconomicsIndex:false,submitAuditing:false,serveCompanySynopsis:false,ownEvaluation:false,serveAddScore:false});
				}
			}, */
