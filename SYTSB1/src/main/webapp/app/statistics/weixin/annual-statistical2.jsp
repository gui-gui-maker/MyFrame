...
<div id="slider" class="swipe" style="visibility:visible;">  
    <div class="swipe-wrap">  
        ...
        <figure>  
            <div class="face faceInner">  
              	检验特种设备报告 ${data.report. lr_count} 份<br/>
              	占 ${fn:substring((data.report. lr_count)/(data.reportAll. lr_count)*100, 0, 5)}%<br/>
              	审核报告 ${data.report. sh_count} 份
            </div>  
        </figure>  
        <figure>  
            <div class="face faceInner">  
