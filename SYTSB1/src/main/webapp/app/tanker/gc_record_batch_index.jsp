	...
	<script type="text/javascript">
		...
		function save(data){
			...
			top.$.dialog({
				...
				title:'原始记录校核',
				parent:api,
				content: 'url:app/tanker/gc_record_batch_check.jsp?ids='+data.ids,
				data : {"window" : window}
			});
		}
	...
	<table border="0" cellpadding="0" cellspacing="0" id="tree_big_tb" height="100%">
		<tr>
			<td id="tree_big_tb_td_left">
				<iframe name="left" src="report/item/record/showGcChecks.do?ids=${param.ids}" width="100%" height="100%" scrolling="auto" frameborder="0" border="0"></iframe>
			</td>
