...
<body>
	<form id="form-insp" action="inspectionInfo/basic/changePlan.do?infoId=${param.infoId}">
			...
			<table border="1" cellpadding="3" cellspacing="0" width=""
				...
				<!--  <input name="check_unit_id" value='' type="hidden" />-->
					...
					<td class="l-t-td-right" colspan="3"><input type="text"
						...
						ligerui="{
							//initValue:'3000',
							readonly:true,
							data: <u:dict sql="select distinct t.fk_report_id,t.report_name   from base_unit_flow t where  t.device_type='2000' "/>,
							}" />
					</td>
				...
				<td class="l-t-td-left">检验日期：</td>
					...
					<td class="l-t-td-right"><input name="item_op_name"
						...
						<input type="text" name="item_op_id" id="item_op_id" ltype="select"  validate="{required:false}" ligerui="{
							readonly:true,
				...
				<tr>
					...
					<input type="text" name="check_op_id" id="check_op_id" ltype="select"  validate="{required:false}" ligerui="{
							readonly:true,
