...
%>
		...
		function selectionChange() {
	     	...
	     	if(count == 1){
	            Qm.setTbar({detail: true, turnHistory: true, showReport: true, print: true,printTags:true,printEnd:true,payTotal:true,printInfo:true,doPrintReport:true});            	
	 		}else if(count > 1){
	       		Qm.setTbar({detail: false, turnHistory: false, showReport: false, print: true,printTags:true,printEnd:true,payTotal:true,printInfo:true,doPrintReport:true});
	    	}else{
	    		Qm.setTbar({detail: false, turnHistory: false, showReport: false, print: false,printTags:false,printEnd:false,payTotal:false,printInfo:false,doPrintReport:false});
	    	}
		}
		...
		function showReport(){	
			...
			if(is_user_defined==""){
				...
				var reportType = Qm.getValueByName("reportType").toString();	// 新老报表识别代码
				var ispdf =  Qm.getValuesByName("export_pdf").toString();	// 老报告导出pdf盖章标记
