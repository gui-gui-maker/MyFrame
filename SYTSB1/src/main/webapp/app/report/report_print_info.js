...
function createReportPrintRecordGrid() {
    var columns=[
        ...
        { display: '报告编号', width: '15%', name: 'report_sn', type: 'text', required:true,maxlength:200},
        { display: '台数', width: '8%', name: 'report_count', type: 'int', required:false,maxlength:32},
        { display: '使用/制造/安装单位', width: '30%', name: 'com_name', type: 'text', required:false,maxlength:200},     
        ...
        { display: '录入人', width: '8%', name: 'enter_op_name', type: 'text', required:false,maxlength:20},
        { display: '录入时间', width: '10%', name: 'enter_date', type:'date', format:'yyyy-MM-dd', required:false},
        { display: '报送人', width: '8%', name: 'commit_user_name', type: 'text', required:false,maxlength:20},
        { display: '报送时间', width: '10%', name: 'commit_time', type:'date', format:'yyyy-MM-dd', required:false},
        { display: '接收人', width: '8%', name: 'receive_user_name', type: 'text', required:false, maxlength:20},
        { display: '接收时间', width: '10%', name: 'receive_time', type:'date', format:'yyyy-MM-dd', required:false},
