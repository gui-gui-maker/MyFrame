...
var category_08 = <u:dict code="BASE_EQ_HC_CATEGORY"/>
	...
	function selEquipment(){	
		top.$.dialog({
			...
			lock : true, 
			title:"选择设备信息",
			content: 'url:app/equipment/base/equipment_basic_choose_list.jsp?isStop=1',
	...
	function callBack(data){
		...
		$('#eq_use_department').val(data.eq_use_department);	// 设备位置（所在部门）
...
<div class="navtab">
	...
	<div title="停用设备详情" tabId="certTab">
  	...
  	<script type="text/javascript">
   	$("#detailForm").initFormList({
        ...
        columns:[
            ...
            { display:'内设备编号', name:'baseEquipment2.eq_no', width:'15%'},
            ...
            { display:'停用日期', name:'conduct_date', width:'15%'},
