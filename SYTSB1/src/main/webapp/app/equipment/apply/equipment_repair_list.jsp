...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        function detail(id){
			...
			top.$.dialog({
				...
				lock:true,
				title:"详情",
				content: 'url:app/equipment/apply/equipment_repair_detail.jsp?status=detail&id=' + id+'&apply_type=02',
				data:{window:window},
				cancel:true
			});
		}
        ...
        function add(){
			top.$.dialog({
				...
				title:"新增",
				data: {window:window},
				content: 'url:app/equipment/apply/equipment_repair_detail.jsp?status=add&apply_type=02'
			});
        }
        ...
        function modify(){
			...
			top.$.dialog({
				...
				title:"修改",
				data: {window:window},
				content: 'url:app/equipment/apply/equipment_repair_detail.jsp?status=modify&id='+Qm.getValueByName("id")+'&apply_type=02'
			});
        } 
	...
	<body>
		<qm:qm pageid="eq2_repair" singleSelect="false">
			<qm:param name="apply_type" value="02" compare="="/>
		</qm:qm>
	</body>
</html>
