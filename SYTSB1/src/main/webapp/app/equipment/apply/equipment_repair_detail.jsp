...
<div class="navtab">
	...
	<div title="维修设备详情" tabId="certTab">
  	...
  	<script type="text/javascript">
   	$("#detailForm").initFormList({
        ...
        columns:[
            ...
            { display:'维修单位', name:'repair_com', width:'15%'},
            { display:'维修费用', name:'repair_price', width:'15%'},
            { display:'维修要求', name:'repair_requirement', width:'30%'},
            { display:'维修日期', name:'conduct_date', width:'15%'},
