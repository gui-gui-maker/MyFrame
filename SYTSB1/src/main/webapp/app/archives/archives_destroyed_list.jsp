...
<script type="text/javascript">
	var qmUserConfig = {
		...
		sp_fields:[
	         ...
	         {group: [
	  				{name: "op_time", compare: ">=", width:100},
		...
		tbar: [ {
			...
			text: '销毁申请', id: 'add', icon: 'add', click: add
		}/*, "-", {
	...
	function add() {
		...
		top.$.dialog({
			...
			title: "申请",
			content: 'url:app/archives/archives_destroy_detail.jsp?ids='+ids+'&report_sn='
					+report_sn
		});
	}
	function add1() {
...
<body>
	...
	<qm:qm pageid="TJY2_ARCHIVES_gq" singleSelect="false"></qm:qm>
</body>
</html>