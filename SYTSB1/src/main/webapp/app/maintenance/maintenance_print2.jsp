...
<script type="text/javascript">
	...
	function CreateOneFormPage(){		
		...
		<%
			...
			printReportContent += "<td colspan='3' align='center'>&nbsp;&nbsp;<%=StringUtil.isNotEmpty(maintenanceInfoDTO.getProve_user_name())?maintenanceInfoDTO.getProve_user_name():"" %></td></tr>";
	...
	<table width="700" cellpadding="6" cellspacing="0" align="center" border="1" id="table">
		<caption><center><font size="3"><b>四川省特检院检验软件管理平台<br/>运行维护日志</b></font></center></caption>
			<div style="text-align:left;padding-left:30px">业务编号：<c:out value="${sessionScope.maintenanceInfoDTO.sn}"></c:out></div>
       		...
       		<tr align="center">
       			<td>论证人</td>
         		<td colspan="3" align="center">&nbsp;&nbsp;<c:out value="${sessionScope.maintenanceInfoDTO.prove_user_name}"></c:out></td>         		
       		</tr>
       		<tr align="center">
       			<td>论证结论</td>
