 	...
 	function zlbsh(){
 		top.$.dialog({
			...
			content: 'url:app/qualitymanage/sgcjjybg_zlbyj.jsp?pageStatus=add&serviceId='+serviceId+
					'&activityId='+activityId+"&areaFlag="+areaFlag+'&processId='+processId+'&st='+"F"
		});
 	}
    function submitSh(){
    	var serviceId = "${requestScope.serviceId}";//提交数据的id
...
//     	         }
    		 ...
    		 var njtss=$("#njts").val();
    		 var njtss2=$("#njts2").val();
    		 var njtss3=$("#njts3").val();
    		 var njtss4=$("#njts4").val();
    		 var njtss5=$("#njts5").val();
    		 var njtss6=$("#njts6").val();
    		 var njtss7=$("#njts7").val();
    		 //判断检验任务单是否必填------开始
    		 var tj=true;
...
//         	   if(equipmentName=="null" && njts=="null" ){
//           		 	$.ligerDialog.error("亲，这条没有数据不可以选择哦！！！");
//         	   }else{
		        	top.$.dialog({
						parent: api,
						width : 660, 
						...
						lock : false, 
						title:"选择报告/证书编号",
						content: 'url:app/qualitymanage/sgcjjybg_xuanze.jsp?abc='+"1"+"&fid="+serviceId,
    	 ...
    	 function setFwbjhbg2(){
             if(areaFlag=="1" || areaFlag=="2" || areaFlag=="3"){
	  	        	top.$.dialog({
	  					...
	  					lock : false, 
	  					title:"选择报告/证书编号",
	  					content: 'url:app/qualitymanage/sgcjjybg_xuanze.jsp?abc='+"2"+"&fid="+serviceId,
	  					data : {"parentWindow" : window}
	  				});
             }else{
          	   $.ligerDialog.error("亲，你不可以选择哦！！！");
      	...
      	function setFwbjhbg3(){
            if(areaFlag=="1" || areaFlag=="2" || areaFlag=="3"){
 	        	top.$.dialog({
 					...
 					lock : false, 
 					title:"选择报告/证书编号",
 					content: 'url:app/qualitymanage/sgcjjybg_xuanze.jsp?abc='+"3"+"&fid="+serviceId,
 					data : {"parentWindow" : window}
 				});
            }else{
         	   $.ligerDialog.error("亲，你不可以选择哦！！！");
     	...
     	function setFwbjhbg4(){
            if(areaFlag=="1" || areaFlag=="2" || areaFlag=="3"){
 	        	top.$.dialog({
 					...
 					lock : false, 
 					title:"选择报告/证书编号",
 					content: 'url:app/qualitymanage/sgcjjybg_xuanze.jsp?abc='+"4"+"&fid="+serviceId,
 					data : {"parentWindow" : window}
 				});
            }else{
         	   $.ligerDialog.error("亲，你不可以选择哦！！！");
     	...
     	function setFwbjhbg5(){
            if(areaFlag=="1" || areaFlag=="2" || areaFlag=="3"){
 	        	top.$.dialog({
 					...
 					lock : false, 
 					title:"选择报告/证书编号",
 					content: 'url:app/qualitymanage/sgcjjybg_xuanze.jsp?abc='+"5"+"&fid="+serviceId,
 					data : {"parentWindow" : window}
 				});
            }else{
         	   $.ligerDialog.error("亲，你不可以选择哦！！！");
     	...
     	function setFwbjhbg6(){
            if(areaFlag=="1" || areaFlag=="2" || areaFlag=="3"){
 	        	top.$.dialog({
 					...
 					lock : false, 
 					title:"选择报告/证书编号",
 					content: 'url:app/qualitymanage/sgcjjybg_xuanze.jsp?abc='+"6"+"&fid="+serviceId,
 					data : {"parentWindow" : window}
 				});
            }else{
         	   $.ligerDialog.error("亲，你不可以选择哦！！！");
     	...
     	function setFwbjhbg7(){
            if(areaFlag=="1" || areaFlag=="2" || areaFlag=="3"){
 	        	top.$.dialog({
 					...
 					lock : false, 
 					title:"选择报告/证书编号",
 					content: 'url:app/qualitymanage/sgcjjybg_xuanze.jsp?abc='+"7"+"&fid="+serviceId,
 					data : {"parentWindow" : window}
 				});
            }else{
         	   $.ligerDialog.error("亲，你不可以选择哦！！！");
...
<!-- 设置报告编号 -->
    ...
    <input type="hidden" id="statusa" name="statusa" value="0"/>
    ...
    <table id="sg" border="1" cellpadding="3" class="l-detail-table" width="720px">
    	<tr>
            ...
            <th style="border:0px;width:30px"></th>
            <th style="border:0px;width:75px"></th>
            <th style="border:0px;width:45px"></th>
        </tr>
        <tr>
         ...
         <tr>
        	...
        	<td colspan="2" class="l-t-td-right"><input name="bjwtsj" type="text" ltype='date' ligerui="{format:'yyyy-MM-dd'}" value="<%=nowTime%>" /></td>
         	<td class="l-t-td-left" colspan="2">手工出具报告/证书的原因</td>
         	<td class="l-t-td-right"  colspan="3">
         		<input type="radio" name="reason" id="reason" ltype="radioGroup"
					ligerui="{value:'01',data: [ { text:'检验软件无此项功能', id:'01' }, { text:'检验软件故障', id:'02' },
					{ text:'其他', id:'03' }]}"/>	
         	</td>
        </tr>
        <tr>
			...
			<td align="center">设备种类（注）</td>
			<td align="center">设备品种（注）</td>
			<td align="center">检验类别（注）</td>
			<td align="center">检验任务单</td>
			<td align="center">服务部计划的报告/证书编号</td>
			<td align="center">备注</td>
        </tr>
        <tr>
        	<td class="l-t-td-right"><input name="num" id="num" type="text" ltype="text" validate="{maxlength:2}"/></td>
        	<td class="l-t-td-right" ><input name="equipmentName" id="equipmentName" type="text" ltype="text"/></td>
        	...
        	<td class="l-t-td-right"><u:combo name="equipmentVariety" code="TJY2_SBPZ" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	
        	<td class="l-t-td-right"><u:combo name="equipmentCategory" code="TJY2_JYLB" validate="required:false"  attribute="isMultiSelect:false" /></td>
<!--         	<input name="equipmentType" id="equipmentType" type="text" ltype="text"/> -->
<!--         	<input name="equipmentVariety" id="equipmentVariety" type="text" ltype="text"/> -->
<!--         	<input name="equipmentCategory" id="equipmentCategory" type="text" ltype="text"/>                onclick="setFwbjhbg();"-->
        	<td class="l-t-td-right">
        	<input name="rwdId1" id="rwdId1" type="hidden"/>
        	<input name="rwdSn1" id="rwdSn1" type="text" readonly="readonly" ltype="text" onclick="valChk(1)"/>
        	</td>
        	<td class="l-t-td-right" id="fwbjhbg"><input readonly="readonly" name="fwbjhbg" id="fwbjhbg" type="text" ltype="text" onclick="setFwbjhbg();" ligerui="{iconItems:[{icon:'add',click:setFwbjhbg}]}"/></td>
        ...
        <tr>
        	...
        	<td class="l-t-td-right" ><input name="equipmentName2" id="equipmentName2" type="text" ltype="text"/></td>
        	...
        	<td class="l-t-td-right"><u:combo name="equipmentVariety2" code="TJY2_SBPZ" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right"><u:combo name="equipmentCategory2" code="TJY2_JYLB" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right">
        	<input name="rwdId2" id="rwdId2" type="hidden"/>
        	<input name="rwdSn2" id="rwdSn2" type="text" readonly="readonly" ltype="text" onclick="valChk(2)"/>
        	</td>
        	<td class="l-t-td-right" id="fwbjhbg2"><input readonly="readonly" name="fwbjhbg2" id="fwbjhbg2" type="text" ltype="text" onclick="setFwbjhbg2();" ligerui="{iconItems:[{icon:'add',click:setFwbjhbg2}]}"/></td>
        ...
        <tr>
        	...
        	<td class="l-t-td-right" ><input name="equipmentName3" id="equipmentName3" type="text" ltype="text"/></td>
        	...
        	<td class="l-t-td-right"><u:combo name="equipmentVariety3" code="TJY2_SBPZ" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right"><u:combo name="equipmentCategory3" code="TJY2_JYLB" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right">
        	<input name="rwdId3" id="rwdId3" type="hidden"/>
        	<input name="rwdSn3" id="rwdSn3" type="text" readonly="readonly" ltype="text" onclick="valChk(3)"/></td>
        	<td class="l-t-td-right" id="fwbjhbg3"><input readonly="readonly" name="fwbjhbg3" id="fwbjhbg3" type="text" ltype="text" onclick="setFwbjhbg3();" ligerui="{iconItems:[{icon:'add',click:setFwbjhbg3}]}"/></td>
        ...
        <tr>
        	...
        	<td class="l-t-td-right" ><input name="equipmentName4" id="equipmentName4" type="text" ltype="text"/></td>
        	...
        	<td class="l-t-td-right"><u:combo name="equipmentVariety4" code="TJY2_SBPZ" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right"><u:combo name="equipmentCategory4" code="TJY2_JYLB" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right">
        	<input name="rwdId4" id="rwdId4" type="hidden"/>
        	<input name="rwdSn4" id="rwdSn4" type="text" readonly="readonly" ltype="text" onclick="valChk(4)"/></td>
        	<td class="l-t-td-right" id="fwbjhbg4"><input readonly="readonly" name="fwbjhbg4" id="fwbjhbg4" type="text" ltype="text" onclick="setFwbjhbg4();" ligerui="{iconItems:[{icon:'add',click:setFwbjhbg4}]}"/></td>
        ...
        <tr>
        	...
        	<td class="l-t-td-right" ><input name="equipmentName5" id="equipmentName5" type="text" ltype="text"/></td>
        	...
        	<td class="l-t-td-right"><u:combo name="equipmentVariety5" code="TJY2_SBPZ" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right"><u:combo name="equipmentCategory5" code="TJY2_JYLB" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right">
        	<input name="rwdId5" id="rwdId5" type="hidden"/>
        	<input name="rwdSn5" id="rwdSn5" type="text" readonly="readonly" ltype="text" onclick="valChk(5)"/></td>
        	<td class="l-t-td-right" id="fwbjhbg5"><input readonly="readonly" name="fwbjhbg5" id="fwbjhbg5" type="text" ltype="text" onclick="setFwbjhbg5();" ligerui="{iconItems:[{icon:'add',click:setFwbjhbg5}]}"/></td>
        ...
        <tr>
        	...
        	<td class="l-t-td-right" ><input name="equipmentName6" id="equipmentName6" type="text" ltype="text"/></td>
        	...
        	<td class="l-t-td-right"><u:combo name="equipmentVariety6" code="TJY2_SBPZ" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right"><u:combo name="equipmentCategory6" code="TJY2_JYLB" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right">
        	<input name="rwdId6" id="rwdId6" type="hidden"/>
        	<input name="rwdSn6" id="rwdSn6" type="text" readonly="readonly" ltype="text" onclick="valChk(6)"/></td>
        	<td class="l-t-td-right" id="fwbjhbg6"><input readonly="readonly" name="fwbjhbg6" id="fwbjhbg6" type="text" ltype="text" onclick="setFwbjhbg6();" ligerui="{iconItems:[{icon:'add',click:setFwbjhbg6}]}"/></td>
        ...
        <tr>
        	...
        	<td class="l-t-td-right" ><input name="equipmentName7" id="equipmentName7" type="text" ltype="text"/></td>
        	...
        	<td class="l-t-td-right"><u:combo name="equipmentVariety7" code="TJY2_SBPZ" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right"><u:combo name="equipmentCategory7" code="TJY2_JYLB" validate="required:false"  attribute="isMultiSelect:false" /></td>
        	<td class="l-t-td-right">
        	<input name="rwdId7" id="rwdId7" type="hidden"/>
        	<input name="rwdSn7" id="rwdSn7" type="text" readonly="readonly" ltype="text" onclick="valChk(7)"/></td>
        	<td class="l-t-td-right" id="fwbjhbg7"><input readonly="readonly" name="fwbjhbg7" id="fwbjhbg7" type="text" ltype="text" onclick="setFwbjhbg7();" ligerui="{iconItems:[{icon:'add',click:setFwbjhbg7}]}"/></td>
        ...
        <tr>
<!--         ,iconItems:[{icon:'',click:choosePerson}]选择人员 -->
...
<!--             <textarea readonly="readonly" name="departmentMan" id="departmentMan" rows="3" ltype="text" ></textarea> -->
        ...
        <tr>	
            ...
            <td class="l-t-td-right1" colspan="7"><textarea readonly="true" name="zlshyj" id="zlshyj" rows="7" cols="25" class="l-textarea" ></textarea></td>
        </tr>
         <tr>
           	<td class="l-t-td-left" colspan="1"><br></br>签字<br></br></td>
        	<td class="l-t-td-right" colspan="2"><input readonly="true" id="zlshman" name="zlshman" type="text" ltype="text" /></td>
     		<td class="l-t-td-left" colspan="2">日期</td>
