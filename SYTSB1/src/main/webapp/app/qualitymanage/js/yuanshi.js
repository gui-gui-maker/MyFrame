...
function createReportPrintRecordGrid() {
	var columns=[
	             ...
	             { display: '外键', name: 'reportFk', hide:true},
...
var gridConfig={
	reportPrintRecords:{manager:reportPrintGrid,delUrl:""}
    /*reportPrintRecords:{manager:reportPrintGrid,delUrl:"QualityZssqSubAction/delete.do"}*/
};
