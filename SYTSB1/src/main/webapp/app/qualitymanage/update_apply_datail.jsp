 	...
 	$(function () {
    	if(isChecked!="" && typeof(isChecked)!="undefined"){
        	$("#xgsq").transform("detail",function(){});
   	    	$("#xgsq").setValues("quality/updateFile1/detail.do?id=${requestScope.serviceId}");
   	    	$("#xgsq1").setValues("quality/updateFile1/detail.do?id=${requestScope.serviceId}");
...
<body >
<form id="form1" action="quality/updateFile1/save1.do" getAction="quality/updateFile1/detail.do?id=${param.id}">
