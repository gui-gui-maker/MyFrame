...
<!-- 		<input type="hidden" id="fwbjhbgNum" name="fwbjhbgNum"/> -->
		<input type="hidden" id="identifierType" name="identifierType" value="2"/>
		<table border="1" cellpadding="3" cellspacing="0" width="" class="l-detail-table" id="">
			<tr>
	         	<td class="l-t-td-left">方案编号</td>
	         	<td class="l-t-td-right"><input validate="{required:true}" ltype="text" name="fwbjhbgNum" id="fwbjhbgNum" type="text"/></td>
			</tr>
			<tr>
