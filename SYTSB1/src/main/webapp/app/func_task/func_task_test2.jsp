...
var com_ids = "${param.com_ids}";
	...
	$(function () {
	    ...
	    function save(){
	    	// 验证表单数据
	   		var is_pass =$('#test_result2').ligerGetRadioGroupManager().getValue();
	   		if(is_pass=="2"){	// 1：满意 2：存在问题或建议
	   			var check_remark = $('#test_remark2').val();
			...
			if($('#formObj').validate().form()){
		        ...
		        $.ajax({
		            url: "functionTaskInfo/test2.do?ids="+ids,
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="l-t-td-right" colspan="3"><textarea
							name="test_remark2" id="test_remark2" rows="3" cols="25"
				...
				<tr>
					...
					<td class="l-t-td-right">
						<input name="test_user_name2" id="test_user_name2" type="text" ltype='text' validate="{required:true,maxlength:20}" value=""/>
					</td>
					<td class="l-t-td-left">测试日期：</td>
							<td class="l-t-td-right">
								<input name="test_date2" id="test_date2"
