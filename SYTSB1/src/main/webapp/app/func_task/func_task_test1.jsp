...
var com_ids = "${param.com_ids}";
	...
	$(function () {
	    ...
	    function save(){
	    	// 验证表单数据
	   		var is_pass =$('#test_result1').ligerGetRadioGroupManager().getValue();
	   		if(is_pass=="2"){	// 1：满意 2：存在问题或建议
	   			var check_remark = $('#test_remark1').val();
			...
			if($('#formObj').validate().form()){
		        ...
		        $.ajax({
		            url: "functionTaskInfo/test1.do?ids="+ids,
			...
			<table width="100%">
				...
				<tr>
					...
					<td class="l-t-td-right" colspan="3"><textarea
							name="test_remark1" id="test_remark1" rows="3" cols="25"
				...
				<tr>
					...
					<td class="l-t-td-right">
						<input name="test_user_name1" id="test_user_name1" type="text" ltype='text' validate="{required:true,maxlength:20}" value=""/>
					</td>
					<td class="l-t-td-left">测试日期：</td>
							<td class="l-t-td-right">
								<input name="test_date1" id="test_date1"
