	...
	<div data-role="content">
		<div id="a-guide-menu" class="a-guide-menu">
			...
			<div id="a_menu_item_an_ywbl" class="bar bar02">
					<div class="item" onclick="tiao('${pageContext.request.contextPath}/app/weixin/hys/meeting_add.jsp');">
						<div id="aMenu_wb_new" class="a" href="javascript:void(0);"
							...
							<div class="bartxt">会议室申请</div>
						</div>
					</div>
					<div class="item" onclick="tiao('${pageContext.request.contextPath}/app/weixin/hys/meeting_list.jsp');">
						<div id="aMenu_wb_new" class="a" href="javascript:void(0);"
							menuid="wb_new" url="">
							<div class="icon clr_1" style="background-color:#EEB422;">
								<img src="app/k/jqm/skins/default/images/app-ytmz/jd_01.png" alt="">
							</div>
							<div class="bartxt">审批进度</div>
						</div>
					</div>
