...
<div class="wrap">
	...
	<table border="0" align="center" cellpadding="0" cellspacing="0" width="620" class="first">
		...
		<tr>
			<td><strong>考试地点</strong></td>
			<td colspan="4">${examRoom.remark }</td>
		</tr>
	</table>
	<table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td height="60" align="right" valign="bottom" style="padding-right:50px; font-size:14px; line-height:22px;">四川烹饪高等专科学校
&nbsp;&nbsp;<br /></td>
		</tr>
	</table>
	<br />
