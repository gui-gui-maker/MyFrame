...
<head  pageStatus="${param.status}">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //根据体检情况动态改变页面上的参数
            $('#testResults').ligerRadioGroup().bind("change",function(data){
                if(data=="1"){
...
<form id="formObj" action="app/zp/jltd/saveAssessTestResult.do"  >
    ...
    <fieldset class="l-fieldset">
        ...
        <fieldset class="l-fieldset">
            ...
            <table border="1" cellpadding="3" cellspacing="0" width="" class="l-detail-table">
                <tr>
                    <td class="l-t-td-left">体检结果:</td>
                    <td class="l-t-td-right" colspan="3">
                        <input type="radio" id="testResults" name="testResults" ltype="radioGroup" validate="{required:true}"
                               ligerui="{onChange:function(data){test1(data)},value:'1', data: [ { text:'合格', id:'1' }, { text:'不合格', id:'0' }, { text:'未体检', id:'2' }  ]}"/>
                    </td>
                </tr>
