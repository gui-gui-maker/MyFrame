        ...
        <fieldset class="l-fieldset">
	        ...
	        <table border="1" cellpadding="3" cellspacing="0" width="" class="l-detail-table">
	            <tr>
                    ...
                    <td class="l-t-td-right">
                        <input type="radio" name="sex" id="sex" ltype="radioGroup" validate="{required:true}"
                ...
                <tr>
                    ...
                    <td rowspan="5" class="l-t-td-right">
                        ...
                        <img id="photos" src="app/zpmanage/open/image/psb.png" width="126" height="160" alt="" />
                    </td>
                </tr>
                <tr>
            ...
            <tr>
                ...
                <td class="l-t-td-right" colspan="3">
                    <textarea name="yqzy" id="yqzy" title="填写详细的专业信息" cols="70" rows="2" class="l-textarea"
                              style="width:100%" validate="{required:true}" readonly="true" ligerui="{disabled:true}" ></textarea>
                </td>
            </tr>
            <tr>
