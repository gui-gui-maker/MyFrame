    ...
    <script type="text/javascript">
        var qmUserConfig = {
            ...
            tbar:[
                ...
                "-",
                { text:'考核', id:'check',icon:'check', click:check},
                "-",
...
//                { text:'查看', id:'detail',icon:'detail', click:detail}
        ...
        function selectionChange(){
            ...
            if(count==0){
                Qm.setTbar({test:false,recheck:false,check:false,publicity:false,enroll:false,detail:false});
            }else if(count==1){
                if(sign=="18"){
                    //等待体检
                    Qm.setTbar({test:true,recheck:false,check:false,publicity:false,enroll:false,detail:true});
                }else if(sign=="11" || sign=="19"){
                    //体检通过
                    Qm.setTbar({test:false,recheck:false,check:true,publicity:false,enroll:false,detail:true});
                }else if(sign=="13"){
                    //体检未通过
                    Qm.setTbar({test:false,recheck:false,check:false,publicity:true,enroll:false,detail:true});
                }else if(sign=="15"){
                    //公示通过
                    Qm.setTbar({test:false,recheck:false,check:false,publicity:false,enroll:true,detail:true});
                }
                else if(sign=="12"){
                    //体检未通过
                    Qm.setTbar({test:false,recheck:true,check:false,publicity:false,enroll:false,detail:true});
                }else{
                    Qm.setTbar({test:false,recheck:false,check:false,publicity:false,enroll:false,detail:false});
                }

            }else{
                Qm.setTbar({test:false,check:false,publicity:false,enroll:false,detail:false});
            }
        }
        ...
        function test(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"录入体检结果",
                content: 'url:app/zp/jltd/showDetail.do?status='+status+'&id='+selectedId+'&flag=1',
                data: {"window": window}
            });
        }
        ...
        function recheck(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"录入复检结果",
                content: 'url:app/zp/jltd/showDetail.do?status='+status+'&id='+selectedId+'&flag=2',
                data: {"window": window}
            });
        }
        //考核结果
        function check(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"录入考核结果",
                content: 'url:app/zp/jltd/showDetail.do?status='+status+'&id='+selectedId+'&flag=3',
                data: {"window": window}
            });
        }
        //公示结果
        function publicity(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"录入公示结果",
                content: 'url:app/zp/jltd/showDetail.do?status='+status+'&id='+selectedId+'&flag=4',
                data: {"window": window}
            });
        }
        ...
        function result(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"进入部门选择",
                content: 'url:app/zp/jltd/showDetail.do?status='+status+'&id='+selectedId+'&flag=5',
                data: {"window": window}
            });
        }
...
<body>
<qm:qm pageid="hr_zp_013" script="false" singleSelect="true" >
