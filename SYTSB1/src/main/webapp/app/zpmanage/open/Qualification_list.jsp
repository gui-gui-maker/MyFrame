    ...
    <script type="text/javascript">
        ...
        function sh(item){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"资格审核",
                content: 'url:app/zpmanage/open/Qualification_detail.jsp?status='+status+'&check=1&id='+selectedId+'&xqId='+Qm.getValueByName("fk_hr_zp_xqxx_id")+'&jlId='+Qm.getValueByName("fk_hr_zp_jlxx_id")+'',
                data: {"window": window}
            });
        }
		...
		function cx()
		{
    		...
    		{ 
    			...
    			{
    				//撤销不通过
                    $.getJSON('app/zp/jltd/cx.do',{id:selectedId,status:status},function(data){
                        if(data.success){
...
<div class="item-tm" id="titleElement">
    <div class="l-page-title">
		<div class="l-page-title-note">提示：列表数据项
			<font color="red">“红色”</font>代表状态为待审核。
			<font color="blue">“蓝色”</font>代表状态为审核不通过。
			<font color="black">“黑色”</font>代表状态审核通过。
			双击可查看数据详情。
		</div>
	</div>
</div>
<qm:qm pageid="hr_zp_005" script="false" singleSelect="true" >

</qm:qm>
<!-- 
<script type="text/javascript">
   Qm.config.columnsInfo.fk_dep_id.binddata=<u:dict sql="select t.id ,t.parentdeptcode ,t.id,t.deptname from SYS_ORG t"></u:dict>;
</script>
 -->
</body>
</html>