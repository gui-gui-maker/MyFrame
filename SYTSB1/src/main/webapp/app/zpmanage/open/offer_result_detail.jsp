...
<form id="formObj" action="app/zp/jltd/saveOfferResult.do"  >
    ...
    <fieldset class="l-fieldset">
        ...
        <fieldset class="l-fieldset">
            ...
            <table border="1" cellpadding="3" cellspacing="0" width="" class="l-detail-table">
                ...
                <td class="l-t-td-right" ="3">
                        <input name="fkDepId" id="dep_id" type="text" title="选择机构下面的部门" ltype='select' validate="{required:true}"/> 		
