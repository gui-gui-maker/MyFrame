    ...
    <script type="text/javascript">
        ...
        function jf(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"面试费缴费",
                content: 'url:app/zp/jltd/interviewPaymentDetail.do?status='+status+'&id='+selectedId+'&xqId='+Qm.getValueByName("fk_hr_zp_xqxx_id")+'&jlId='+Qm.getValueByName("fk_hr_zp_jlxx_id")+'',
                data: {"window": window}
            });
        }
        function cx()
...
<body>
<qm:qm pageid="hr_zp_021" script="false" singleSelect="true" >
