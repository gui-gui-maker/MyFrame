...
<html xmlns="http://www.w3.org/1999/xhtml">
			...
			function save(url)
			{
				...
				//判断是否是报告签发 报告签发回退分2步 一步回退上一步，一步回退到报告起草
					if(Type=="05"){
						...
						url = "department/basic/backCheck.do?type=${param.type}&flow_num=${param.flow_num}&acc_id=${param.acc_id}&infoId=${param.infoId}&backType="+backType;
						
					}else{
									
				
						url = "department/basic/backCheck.do?type=${param.type}&flow_num=${param.flow_num}&acc_id=${param.acc_id}&infoId=${param.infoId}";
					}
				//验证表单数据
	...
	<form id="form1"  >
					...
					<tr>
						...
						<td class="l-t-td-right"  colspan="2"><textarea name="revise_remark" id="revise_remark" rows="3" cols="" ext_type="string" ext_maxLength="200" ext_name="备注" isNull="Y" class="area_text"></textarea></td>
