...
<script type="text/javascript">
	...
	function backs(){
		if(confirm("亲，确认撤销所选报告的盖章吗？撤销后无法撤回哦！")){
				$.getJSON("inspectionInfo/basic/backs.do?ids="+Qm.getValuesByName("id").toString(), function(resp){
					if(resp.success){
						top.$.dialog.notice({
				             content: "撤销成功！"
						});
						...
						$.ligerDialog.error("撤销失败，未找到系统相关业务流程，请联系系统管理员！");
					}
			})
		}
	}
