...
<body>
	<form name="formObj2" id="formObj2" method="post"
		action="employee/basic/mdyPrintPwd.do" style="margin:2em">
		<table id="tab1" border="0" cellpadding="3" cellspacing="0" width=""
			...
			<tr>
				...
				<td class="l-t-td-right">
					<div class="mdy">
					方法一：联系系统管理员重置。系统会将印章密码恢复成初始密码；<br/>
					方法二：直接点击<a href="javascript:void();" onclick="javascript:doReset();">重置</a>。系统会生成新的印章密码，并以微信和短信的形式发送至您的手机。
					</div>
				</td>	
			</tr>
		</table>
