...
<body>
	<form name="formObj" id="formObj" action="remindMessageAction/saveRMessages.do?messageType=retireRemind
	&ids=<%=ids %>"getAction="">
		...
		<table class="l-detail-table">
			...
			<tr>
				...
				<td ><textarea  name="retireRemind" id="retireRemind" rows="2" cols="25" class="l-textarea">“XXX”的退休时间就要到了，请做好退休工作准备！【人力资源管理部】</textarea></td>
			</tr>
			<tr>
				<!-- 当事人退休提醒内容 -->
