...
function addPdfPlugin(){
	document.getElementById("TANGER_OCX").AddDocTypePlugin(".pdf","PDF.NtkoDocument","4.0.0.2","app/humanresources/js/ntkooledocall.cab",51,false);
}
...
function initNtkoEditorContainer(containerId,cuser){
	...
	if (_browser == "IE") {
		...
		'<SPAN STYLE="color:red">不能装载文档控件。请在检查浏览器的选项中检查浏览器的安全设置。如果您尚未安装此控件，<a href="app/humanresources/dowload_soft.jsp?fpath=T0ZGSUNFzsS1tb/YvP6wstews8zQ8i5tc2k=">请点击这里下载</a></SPAN> ' +
		'</object>';
		...
		'<SPAN STYLE="color:red">尚未安装NTKO Web FireFox跨浏览器插件。请点击<a href="app/humanresources/dowload_soft.jsp?fpath=T0ZGSUNFzsS1tb/YvP6wstews8zQ8i5tc2k=">安装组1件</a></SPAN>' +
		'</object>';
