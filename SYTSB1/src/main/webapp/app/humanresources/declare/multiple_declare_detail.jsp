...
<head pageStatus="${param.pageStatus}">
    ...
    <script type="text/javascript">
        ...
        var areaFlag;//改变状态
        <bpm:ifPer function="MULTIPLE_DIRECTOR_CHECK" activityId = "${requestScope.activityId}">areaFlag = "2";</bpm:ifPer>//部门主任审核
        <bpm:ifPer function="MULTIPLE_OFFICE_CHECK" activityId = "${requestScope.activityId}">areaFlag = "3";</bpm:ifPer>//办公室主任审核
        <bpm:ifPer function="MULTIPLE_HRD_CHECK" activityId = "${requestScope.activityId}">areaFlag = "4";</bpm:ifPer>//人事审核
        ...
        function turnback(){
        	$.ligerDialog.confirm('是否退回？', function (yes) {
                ...
                $("body").mask("正在处理，请稍后！");
                $.getJSON("multiple/declare/turnback.do?activityId="+activityId+"&id="+serviceId,
                        function(resp){
                            if(resp){
                            	alert(resp.success);
                                top.$.notice("操作成功！",3);
