...
<body>
	<form name="formObj" id="formObj" action="remindMessageAction/saveRMessages.do?
	messageType=birthdayRemind&ids=<%=ids %>" getAction="">
		...
		<table class="l-detail-table">
			...
			<tr>
				...
				<td ><textarea  name="birthdayRemind" id="birthdayRemind" rows="2" cols="25" class="l-textarea">“XXX”的生日(XX月XX日)就要到了，送个祝福吧！【人力资源管理部】</textarea></td>
			</tr>
			<tr>
				<!-- 当事人生日到期提醒内容 -->
				<td class="l-t-td-left">当事人<br />接收内容</td>
				<td ><textarea  name="birthdayRemindSelf" id="birthdayRemindSelf" rows="2" cols="25" class="l-textarea">您的生日(XX月XX日)就要到了，祝你生日快乐！【人力资源管理部】</textarea></td>
			</tr>
	</table>
  </form>
</body>
