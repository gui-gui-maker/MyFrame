...
<body>
	<form name="formObj" id="formObj" action="remindMessageAction/saveRMessage.do?messageType=stopRemind" 
	getAction="">
		...
		<table class="l-detail-table">
			...
			<tr>
				...
				<td ><textarea  name="stopRemind" id="stopRemind" rows="2" cols="25" class="l-textarea">“<%=name%>”即将聘用到期，请及时通知！【人力资源管理部】</textarea></td>
			</tr>
			<tr>
				<!-- 当事人聘用到期提醒内容 -->
