...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/css/header.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/css/content.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/css/selectFilter.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/laydate/laydate.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/js/jquery.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/js/selectFilter.js"></script>
...
var param='';
  $(function(){
		...
		$("#next3").click(function() {
			location.href="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/leave_index.jsp";
		});
          ...
          opt.default = {
            ...
            $('#leaveType').change(function(){
                ...
                if(type=='SHIJ'||type=='TQJ'){
                	$.ajax({
        	        	url: "BgLeaveAction/queryYearDays.do?peopleId="+"<%=employee_id %>",
        	            type: "POST",
        	            datatype: "json",
        	            contentType: "application/json; charset=utf-8",
        	            success: function (resp) {
...
<body >
	...
	<section id="web" class="holiday">
		<header id="header"> <img src="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/images/tb.png"> </header>
		<section id="content">
			<section class="department">
				<section class="departmentCenter">
					<section class="top"><strong><b>*</b>姓名：</strong>
					...
					<section class="top"><strong><b>*</b>种类：</strong>
						<select id="leaveType" name="leaveType" ext_name="假期种类" ext_isNull="1" maxLength="18" ></select>
						<!-- <select>
							<option>休假</option>
						</select> -->
						<span class="arrow"><img src="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/images/dropDown.png"></span></section>
					...
					<section class="top"><strong><b>*</b>天数：</strong>
					...
					<section class="top"><strong><b>*</b>理由：</strong>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/app/humanresources/wx_leave/02/js/time.js"></script>
</html>
