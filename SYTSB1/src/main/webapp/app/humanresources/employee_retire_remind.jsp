...
var qmUserConfig = {
        ...
        function setting(){
         	 top.$.dialog({
  		         ...
  		         title: "退休提醒设置",
  		         content: 'url:app/humanresources/employee_retire_setting.jsp?pageStatus=modify&name='+encodeURI(encodeURI(Qm.getValueByName("emp_name")))+'&id='+Qm.getValueByName("id")
  	          });
        ...
        function settings(){
        	 top.$.dialog({
 		         ...
 		         title: "退休提醒批量设置",
 		         content: 'url:app/humanresources/employee_retire_settings.jsp?pageStatus=modify&ids='+Qm.getValuesByName("id")
 	          });
        	
        }
        function send(){
        	$.ajax({
            	url: "remindMessageAction/sendRetireRemind.do",
                type: "POST",
                datatype: "json",
