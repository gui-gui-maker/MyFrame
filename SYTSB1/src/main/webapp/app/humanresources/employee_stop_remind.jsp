...
var qmUserConfig = {
        ...
        function setting(){
         	 top.$.dialog({
  		         ...
  		         title: "聘用到期提醒设置",
  		         content: 'url:app/humanresources/employee_stop_setting.jsp?pageStatus=modify&name='+encodeURI(encodeURI(Qm.getValueByName("emp_name")))+'&id='+Qm.getValueByName("id")
  	          });
        ...
        function settings(){
        	 top.$.dialog({
 		         ...
 		         title: "聘用到期批量提醒设置",
 		         content: 'url:app/humanresources/employee_stop_settings.jsp?pageStatus=modify&ids='+Qm.getValuesByName("id")
 	          });
        	
        }
        function send(){
        	$.ajax({
            	url: "remindMessageAction/sendStopRemind.do",
                type: "POST",
                datatype: "json",
