...
<head>
	...
	<script type="text/javascript">
		...
		function close()
		{	
			if(api.data.print_type==null || api.data.print_type==undefined || api.data.print_type==""){
				api.data.window.Qm.refreshGrid();
			}else{
				if(api.data.print_type == "0"){
					api.data.window.Qm.refreshGrid();
				}else{
		...
		function initLeft(){
			document.getElementById("leftIframe").src='report/query/showPrint.do?id='+api.data.id+'&acc_id='+api.data.acc_id+'&flow_num='+api.data.flow_num+'&printType=${param.printType}&print_type='+api.data.print_type+'&print_count='+api.data.print_count+'&print_remark='+encodeURI(encodeURI(api.data.print_remark)); 
		}
	</script>	
</head>
			...
			<table border="0" cellpadding="0" cellspacing="0" id="tree_big_tb" height="100%">
				<tr>
					<td id="tree_big_tb_td_left">
						<iframe name="left" id="leftIframe"src="" width="100%" height="100%" scrolling="auto" frameborder="0" border="0"></iframe>
					</td>
