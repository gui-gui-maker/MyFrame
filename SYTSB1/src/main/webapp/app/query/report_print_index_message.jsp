...
<head>
	...
	<script type="text/javascript">
		...
		function close(url)
			{	
				api.data.window.submitAction();api.close();
			}
			function save(url)
			{
				left.printAll();
			...
			<table border="0" cellpadding="0" cellspacing="0" id="tree_big_tb" height="100%">
				<tr>
					<td id="tree_big_tb_td_left">
						<iframe name="left" src="report/query/showPrintMessage.do?id=${param.ids}&report_type=${param.report_type}" width="100%" height="100%" scrolling="atuo" frameborder="0" border="0"></iframe>
					</td>
