...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        var qmUserConfig = {
            ...
            sp_fields:[
            	...
            	{name:"area_id", compare:"="},
            	{name:"inspection_conclusion", compare:"like"},
            	{name:"unitname", compare:"like"},
            	...
            	{name:"report_com_address", compare:"like"},
            	{name:"advance_time", compare:"="},
            	{name:"last_check_time", compare:"="}
            ],
            tbar:[
		...
		function selectionChange() {
	     	...
	     	if(count == 1){
	            Qm.setTbar({detail: true, del:true,turnHistory: true, showReport: true, print: true});            	
	 		}else if(count > 1){
	       		Qm.setTbar({detail: false, del:true, turnHistory: false, showReport: false, print: false});
	    	}else{
	    		Qm.setTbar({detail: false,del:false, turnHistory: false, showReport: false, print: false});
	    	}
		}
		...
		function doPrintReport(){	
			...
			if(is_user_defined==""){
				top.$.dialog({
					...
					lock : true, 
					title:"打印报告",
					content: 'url:app/query/report_print_index.jsp?id='+id,
					data : {"window" : window}
				}).max();
				...
				alert("自定义报告请通过“查看报告”按钮下载报告文档进行打印");
			}
		}
	...
	<body>	
		<qm:qm pageid="finished_list" singleSelect="false">
		</qm:qm>
		<script type="text/javascript">
