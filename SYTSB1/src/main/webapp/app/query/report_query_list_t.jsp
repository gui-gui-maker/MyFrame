...
%>
        ...
        var qmUserConfig = {
            ...
            tbar:[
				...
				'-',
				{ text:'打印合格证', id:'printTagsE',icon:'print', click: printTagsEBylodop}          
            ],
            listeners: {
		...
		function selectionChange() {
	     	...
	     	if(count == 1){
	            Qm.setTbar({detail: true, turnHistory: true, showReport: true, print: true,
	            	...
	            	export_pdf2:true, startFlows:true, modifyDevices:true, exportReportToExcel:true,printT:true});            	
	 		}else if(count > 1){
	 			var big_class = Qm.getValueByName("big_class");
	       		...
	       		Qm.setTbar({detail: false, turnHistory: false, showReport: false,
	       			...
	       			export_pdf:true, export_pdf2:true, startFlows:true, modifyDevices:true, exportReportToExcel:true,printT:true});
	    	}else{
	    		Qm.setTbar({detail: false, turnHistory: false, showReport: false, 
	    			...
	    			modifyDevices:false, exportReportToExcel:false,printT:false});
	    	}
		}
	...
	<body>	
		...
		<qm:qm pageid="report_query_list_t" singleSelect="false">
			<%
