...
%>
        ...
        var qmUserConfig = {
            ...
            sp_fields:[
            	...
            	{name:"company_name", compare:"like"},
            	{name:"com_code", compare:"like"}
            ],
            tbar:[
	...
	<body>	
		<qm:qm pageid="report_query_list2" singleSelect="false">
			<%
				if("region".equals(userType)){	// 市行政区划
					%>
					<qm:param name="device_area_code" value="<%=org_code%>" compare="=" />
					<%
				}
			%>
		</qm:qm>
