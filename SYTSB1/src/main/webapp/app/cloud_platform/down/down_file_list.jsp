...
document.onkeydown=function(event){
	...
	$(function() {
		...
		if(n!="0"){
			$("#cloadList").append('<div class="title"> <div class="icon_box"><a href="javascript:detailCloud()"><p>下载中心</p></a></div>'
					+' </div>'
				    +'<div class="Per_info">'
	...
	function indexSerachClick(){
		...
		//window.location.href= $("base").attr("href")+"resourceInfo/queryDownFile.do?spaceType=9&name="+EncodeUtf8($("#search").val());
...
<div align="center" style="font-size: 16px;color: black;display: none;" id="filePages">
	<span style="cursor:default;" id="pre" onmouseover="hoverThis(this)"  onmouseout="outThis(this)" onclick="toPerPage()" >上一页</span>
	   <span style="margin-right: 20px;margin-left: 20px;font-size: 14px;" >第<span id="nowPage">1</span>页,共${sumC }页</span>
