...
/* 	
	...
	$("#formObj").initForm({
		  ...
		  toolbar:[{text:"隐藏模式显示", icon:"settings",id:'hiddenModel', click:function(){
...
function refreshData(next_id){
	//alert("${param.spaceType}")
	pid = next_id;
	select = {};
	ids = [];
	$.post("resourceSpace/queryResourceByType.do",{userId:"<%=userid%>",spaceType:"${param.spaceType}",resourceType:"6"},function(res){
			queryInfo =res.queryInfo;
			pid = res.pathId;
			$("#mainT").html("");
			 beans = [];
