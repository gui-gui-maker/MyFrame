  ...
  <div class="m-center">
    <div class="m-center-wrap wow bounceInUp">
      <div class="m-center-main">
        ...
        <a href="app/cloud_platform/owner/show_file_index.jsp?status=modify&spaceType=7&user=<%=sessionUser.getSysUser().getId() %>" class="nav_img">
        ...
        <div class="iconboxes icosml ico_shjz wow fadeInUpBig" data-wow-delay="0.3s">
         <a href="app/cloud_platform/owner/show_file_picture.jsp?spaceType=7" class="nav_img">
        ...
        <div class="iconboxes icoorg ico_yfaz wow fadeInUpBig" data-wow-delay="0.6s">
         <a href="app/cloud_platform/owner/show_file_video.jsp?spaceType=7" class="nav_img ">
        ...
        <div class="iconboxes icosml ico_jzjj wow fadeInUpBig" data-wow-delay="0.8s" >
         <a href="app/cloud_platform/owner/show_file_office.jsp?spaceType=7" class="nav_img ">
        ...
        <div class="iconboxes icosml ico_shsw wow fadeInUpBig" data-wow-delay="1.0s">
         <a href="app/cloud_platform/owner/show_file_pdf.jsp?spaceType=7" class="nav_img ">
        ...
        <a href="app/cloud_platform/owner/show_file_zip.jsp?spaceType=7" class="nav_img ">
        ...
        <div class="iconboxes icobig ico_qhdm wow fadeInUpBig" data-wow-delay="1.5s">
         <a href="app/cloud_platform/owner/show_file_recycle.jsp?spaceType=7" class="nav_img ">
