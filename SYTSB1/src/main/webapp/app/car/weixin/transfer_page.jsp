			...
			$.post("j_spring_security_check", {
				...
				if (data["success"]) {
					if("<%=businessId%>"!=""&&"<%=businessId%>"!="null"&&"<%=businessId%>"!="undefined"){
						window.location="${pageContext.request.contextPath}/app/car/weixin/car_apply_detail.jsp?businessId=<%=businessId%>&businessStatus=<%=businessStatus%>";
					}else{
						window.location="${pageContext.request.contextPath}/app/car/weixin/car_apply_pending.jsp";
					}
				} else {
