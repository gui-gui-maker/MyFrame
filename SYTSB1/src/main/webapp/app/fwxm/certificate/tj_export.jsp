...
<script type="text/javascript">
	...
	function exportToExcel() { 
    	...
    	winname.document.writeln(strHTML); 
     	winname.document.execCommand('saveas','','科研项目统计（${sessionScope.org_name}）.xls'); 
     	winname.close(); 
  		closeCurWin();
	}
...
<div id="tableExcel"> 
	<table width="700" cellpadding="6" cellspacing="0" bgcolor="#cccccc" border="1" id="table">
    	<tr align="center">
        	<td colspan="8">
        		<font size="3"><b>持证统计（${sessionScope.org_name}）</b></font>
        	</td>
    	</tr>
    	<tr>
            ...
            <tr>
				...
				<td align="center">证书性质</td>
				<td align="center">证书项目</td>
