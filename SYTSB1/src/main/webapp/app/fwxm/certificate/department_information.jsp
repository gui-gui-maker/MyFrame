...
<div id="layout1">
	...
	<div position="center" align="center" title="在职人员信息">
		<iframe id="rightFrame" name="rightFrame" src="app/fwxm/certificate/registration_list.jsp" frameborder="0" 
			width="100%" height="100%" scrolling="no"></iframe>
	</div>
     </c:if>
     <c:if test='${param.status=="certificate"}'>
	<div position="center" align="center" title="证件信息">
		<iframe id="rightFrame" name="rightFrame" src="app/fwxm/certificate/certificate_list.jsp" frameborder="0" 
			width="100%" height="100%" scrolling="no"></iframe>
	</div>
     </c:if>
     <c:if test='${param.status=="zx"}'>
	<div position="center" align="center" title="旧证件信息">
		<iframe id="rightFrame" name="rightFrame" src="app/fwxm/certificate/certificate_zx_list.jsp" frameborder="0" 
			width="100%" height="100%" scrolling="no"></iframe>
	</div>
     </c:if>
       </div>
