...
<script type="text/javascript">
	var qmUserConfig = {
		...
		tbar: [ {
			...
			text: '作废', id: 'invalid', icon: 'recycle', click: invalid
		},"-", {
			text: '流转记录', id: 'flow', icon: 'follow', click: flow
		},"-", {
	...
	function add() {
		top.$.dialog({
			...
			title: "新增",
			content: 'url:app/fwxm/library/book_detail.jsp?pageStatus=add&identifier=0'
		});
	}
	...
	function edit() {
		...
		top.$.dialog({
			...
			title: "修改",
			content: 'url:app/fwxm/library/book_detail.jsp?id=' + id + '&pageStatus=modify&identifier=0'
		});
	}
	function flow() {
		var id = Qm.getValueByName("id");
...
<body>
	<qm:qm pageid="lib_book" script="false" singleSelect="false">
    	 <qm:param name="identifier" compare="=" value="0"/>
    	 <qm:param name="status" value="6" compare="!=" />
    </qm:qm>
</body>
</html>