...
//                 {display: "税额", name: "se", width: 80, align: "right"},
        ...
        function _submitForm() {
            if ($("#form1").validate().form()) {
                ...
                $.ajax({
                    url: "chlq/usualSave.do?processToType=0",
                    data: JSON.stringify(formDatas),
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
                    type: "post",
        ...
        <table class="l-detail-table">
            ...
            <tr>
                ...
                <td class="l-t-td-right"><input id="lqName" name="lqName" type="text" ltype="text"
                                                value="<%=user.getName()%>" ligerui="{disabled:true}"/>
                </td>
            </tr>
            <tr>
                <td class="l-t-td-left">申请日期：</td>
                <td class="l-t-td-right"><input id="createTime" name="createTime" type="text" ltype="date"
                                                ligerui="{disabled:true,format:'yyyy-MM-dd'}" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(new Date())%>" /></td>
