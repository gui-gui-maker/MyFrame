	...
	tbar:[
     ...
     listeners: {
     	selectionChange : function(rowData,rowIndex){
			...
			if(count==1){
				if(rowData.kj_id!="<sec:authentication property='principal.id' htmlEscape='false' />"){
	        		Qm.setTbar({
	        			submit:false
					});
        		}
	...
	function detail(id){
     ...
     function submit(){
    	 ...
    	 top.$.dialog({
 			...
 			title:"审核",
 			data: {window:window},
 			content: 'url:app/fwxm/scientific/instruction/instructionRw_detail.jsp?status=modify&id='+Qm.getValueByName("id")+"&type="+type+"&tj=3"
 		});
//     	 top.$.dialog({
//   			width: 720,
//   			height: 530,
...
//   			title:"批准",
//   			data: {window:window},
//   			content: 'url:app/fwxm/scientific/instruction/choose_opinion_rws.jsp?status=modify&type=sp&id='+Qm.getValueByName("id")
//   		});
 	}
