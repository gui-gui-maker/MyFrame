...
var qmUserConfig = {
	...
	tbar:[
        ...
        "-",
        { text:'批准', id:'submit',icon:'submit',click:submit},
        "-",
...
//   			title:"批准",
//   			data: {window:window},
//   			content: 'url:app/fwxm/scientific/instruction/choose_opinion_rw.jsp?status=modify&type=sp&id='+Qm.getValueByName("id")
//   		});
 	}
...
<body>
	...
	<qm:param name="status" value="8" compare="=" />
	</qm:qm>
