...
var qmUserConfig = {
	...
	tbar:[
        ...
        "-",
        { text:'审查', id:'submit',icon:'submit',click:submit},
        "-",
     ...
     listeners: {
     	selectionChange : function(rowData,rowIndex){
			...
			if(count==1){
				console.log(rowData.review_man);
				console.log("<sec:authentication property='principal.id' htmlEscape='false' />");
        		if(rowData.review_man!="<sec:authentication property='principal.name' htmlEscape='false' />"){
        		Qm.setTbar({
        			submit:false
				});
        	}
...
//      			title:"批准",
//      			data: {window:window},
//      			content: 'url:app/fwxm/scientific/instruction/choose_opinion_rw.jsp?status=modify&type=sc&id='+Qm.getValueByName("id")
//      		});
