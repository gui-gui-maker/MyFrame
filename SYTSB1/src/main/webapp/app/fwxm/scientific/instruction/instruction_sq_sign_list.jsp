	...
	tbar:[
     ...
     listeners: {
     	selectionChange : function(rowData,rowIndex){
			...
			if(count==1){
        		if(rowData.sign_id!="<sec:authentication property='principal.id' htmlEscape='false' />"){
	        		Qm.setTbar({
						sign:false
					});
        		}
	...
	function detail(id){
     ...
     function sign(){
    	 ...
    	 top.$.dialog({
 			...
 			title:"审核",
 			data: {window:window},
 			content: 'url:app/fwxm/scientific/instruction/instruction_sq_detail.jsp?status=modify&type=modify&id='+Qm.getValueByName("id")+"&tj=2"
 		});
...
//  			title:"批准",
//  			data: {window:window},
//  			content: 'url:app/fwxm/scientific/instruction/choose_opinion_sq.jsp?status=modify&type=sign&id='+Qm.getValueByName("id")
//  		});
      }
