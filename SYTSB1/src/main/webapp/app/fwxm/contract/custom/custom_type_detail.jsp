...
<body>
<form name="formObj" id="formObj" method="post" Action="contractCustomTypeAction/save.do"
			getAction="contractCustomTypeAction/detail.do?id=${param.id}">
<br/>
<table cellpadding="3" cellspacing="0" class="l-detail-table">
		...
		<tr> 
        	...
        	<td class="l-t-td-right"> 
        		<input id="type" name="type" type="text" ltype='text' validate="{required:true,maxlength:100}"
        	</td>
		</tr>
