...
%>
    ...
    var qmUserConfig = {
    		...
    		tbar: [{text: '详情', id: 'detail', icon: 'detail', click: detail},"-",
    		       ...
    		       {text: '审核', id: 'edit', icon: 'edit', click: edit},"-",
	   		...
	   		success:function(data){
	      		try{
	      			top.$.dialog({
	        			...
	        			title: "新增",
	        			content: 'url:app/fwxm/dining/SOAD.jsp?status=detail&id=' + id
	        		});
				}catch(e){
    	   		...
    	   		success:function(data){
    	      		try{
    	      			top.$.dialog({
    	        			...
    	        			data: {"window": window,"foods":data.data},
    	        			title: "新增",
    	        			content: 'url:app/fwxm/dining/SOAD.jsp?status=add'
    	        		});
    				}catch(e){
    	   		...
    	   		success:function(data){
    	      		try{
    	      			top.$.dialog({
    	        			...
    	        			data: {"window": window,"foods":data.data},
    	        			title: "新增",
    	        			content: 'url:app/fwxm/dining/SOAD.jsp?status=modify&id=' + id
    	        		});
    				}catch(e){
...
<body>
	<qm:qm pageid="food_seat_order" singleSelect="false"></qm:qm>
</body>
</html>
