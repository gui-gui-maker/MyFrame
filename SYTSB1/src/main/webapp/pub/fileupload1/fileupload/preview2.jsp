...
<head>
	...
	<script type="text/javascript">
		...
		function renderImage(t,url) {
			...
			$("#imgLoading").show();
			var url1 = "fileupload2/downloadCompress.do?proportion=0&id=";
			if("${param.resource_type}"=="3"){
				url1 = "fileupload2/downloadByPath.do?id="; 
			}
			loadImage(t==1?url:url1 + api.data.images[_current_image_index].id,function(){
