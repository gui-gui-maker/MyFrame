...
<link rel="stylesheet" type="text/css"
	href="rtbox/app/templates/default/assets/skin/default_skin/css/theme.css">
...
<script type="text/javascript"
	src="rtbox/app/templates/default/tpl01.js"></script>
...
.bzhu span {
	...
	border-top: 4px solid #e22118;
	border-left: 4px solid #e22118;
}
...
.bzhu:hover .bzhu_box, .bzhu:focus .bzhu_box, .bzhu:active .bzhu_box,
	...
	<div id="main">
		<c:if test="${param.status!='detail'}">
			...
			<div class="navbar navbar-fixed-top navbar-shadow ">
				...
				<ul class="nav navbar-nav navbar-left">
					<c:if
						test="${param.pageStatus!='detail'||(param.pageStatus==''||param.pageStatus==null)}">
						<li>
							<div class="navbar-btn btn-group">
								<a href="javascript:saveRight();"> <span
									class="edui-save btn btn-sm" title="提交"></span>
								</a>
							</div>
						</li>
						<li>
							<div class="navbar-btn btn-group">
								<a href="JavaScript:dir();"> <span
									class="edui-for-Catalog btn btn-sm" title="目录"></span>
								</a>
							</div>
						</li>
						<li>
							<div class="navbar-btn btn-group">
								<a href="javascript:void(0);"> <select id="fontSizes"
									onchange="fontSizes();">
						...
						<li>
							<div class="navbar-btn btn-group">
								<input type="color" id="tsColor">
							</div>
						</li>
						<li>
							<div class="navbar-btn btn-group">
								<a href="javascript:void(0);" onclick="window.rightFrame.sup();">
									<span class="edui-for-superscript btn btn-sm" title="上标"></span>
								</a>
							</div>
						</li>
						<li>
							<div class="navbar-btn btn-group">
								<a href="javascript:void(0);" onclick="window.rightFrame.sub();">
									<span class="edui-for-subscript btn btn-sm" title="下标"></span>
								</a>
							</div>
						</li>
						<li>
						...
						<li>
							<div class="navbar-btn btn-group">
								<a href="#"> <span class="edui-for-print btn btn-sm"
									title="打印"></span>
								</a>
							</div>
						</li>
						<li>
							<div class="navbar-btn btn-group">
								<a href="JavaScript:sf();"> <span
									class="edui-for-spechars btn btn-sm" title="特殊字符"></span>
								</a>
							</div>
						</li>
						...
						<li>
							<div class="navbar-btn btn-group">
								<a href="JavaScript:copyToRow();"> <span
									class="edui-for-Copyrow btn btn-sm" title="复制内容到整行"></span>
								</a>
							</div>
						</li>
						<li>
							<div class="navbar-btn btn-group">
								<a href="JavaScript:sequence();"> <span
									class="edui-for-insertorderedlist btn btn-sm" title="生成序号"></span>
								</a>
							</div>
						</li>
					</c:if>
						...
						<li>
							<div class="navbar-btn btn-group">
								<a href="javascript:void(0);" onclick="markColor();"> <span
									class="edui_fontcolor btn btn-sm" title="上色"></span>
								</a>
							</div>
						</li>
						<li>
							<div class="navbar-btn btn-group">
								<a href="JavaScript:drawMarker();"> <span
									class="edui-for-Tagging btn btn-sm" title="标注"></span>
								</a>
							</div>
						</li>
					</c:if>
		...
		<div id="content_wrapper">
			<div class="cont_center">
				...
				<iframe marginwidth="0" id="rightFrame" name="rightFrame"
					marginheight="0" frameborder="0" valign=top src="" name="rtree"
