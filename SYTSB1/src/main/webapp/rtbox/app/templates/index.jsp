...
<![endif]-->
<script type="text/javascript"> var relColumn='fk_report_id=${param.fk_report_id}&fk_inspection_info_id=${param.fk_inspection_info_id}&isBatchBusiness=${param.isBatchBusiness}';</script>
						...
						<li>
							<div class="navbar-btn btn-group">
								<a href="javascript:void(0);"> <select id="fontFamilys"
									onchange="fontFamilys(this.value);">
