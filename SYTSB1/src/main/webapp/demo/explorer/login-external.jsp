...
<script type="text/javascript" src="demo/explorer/ui-ext/ui-ie-external.js"></script>
<script type="text/javascript" src="demo/explorer/ui-ext/login.js"></script>
<style type="text/css">
body { margin:0; padding:0; font:12px "宋体"; overflow:hidden; }
form, label { margin:0; padding:0; }
div.layout { width:255px; height:168px; padding:82px 0px 0px 125px; margin:0 auto; background:url(demo/explorer/img/loginbj.png) no-repeat left bottom; overflow-y:hidden; }
...
div.rowck input { margin:0; padding:0; vertical-align:middle; }
div.rowbtn { overflow:hidden; text-align:right; padding-right:26px; }
div#logining { overflow:hidden; text-align:center; padding-right:14px;color:red;display:none;font-weight:bold;}
div.rowbtn span { margin:0px 7px; }
div.rowbtn input { margin:0; padding:0; border:0; width:50px; height:29px; font-weight:bold;}
div.rowbtn input.btnlogin { background:url(demo/explorer/img/btn_login.png) no-repeat center; color:#1c78c3; }
div.rowbtn input.btncanle { background:url(demo/explorer/img/btn_loginc.png) no-repeat center; color:#707070; }
</style>
</head>
<body>
