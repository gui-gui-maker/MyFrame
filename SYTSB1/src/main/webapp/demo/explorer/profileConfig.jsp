...
<script type="text/javascript" src="k/kui/ui-ext/ui-ie-external.js"></script>
		...
		<table class="l-detail-table">
			...
			<tr class="c_f_t">
				...
				<td class="l-t-td-right">
					...
					<input type="radio" name="main_close_btn" value="hide" id="main_close_btn2" /><label for="main_close_btn2">隐藏到任务栏</label>
				</td>
			</tr>
			<tr>
				<td class="btn_td" colspan="2">
					<input class="l-button l-button-submit" type="button" value=" 保存 " onclick="configUserProfile()" />
				</td>
			</tr>
		</table>
	</form>
