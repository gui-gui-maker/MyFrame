                ...
                $.post("j_spring_security_check", {
                    ...
                    if ( data["success"] ) {
                        if ( "<%=businessId%>" != "" && "<%=businessId%>" != "null" && "<%=businessId%>" != "undefined" ) {
                            window.location = "${pageContext.request.contextPath}/app/discipline/wx/zdjr_wx_handle_view?id=<%=businessId%>&pageStatus=check&skip=pending&state=<%=state%>&process_id=<%=processId%>&activity_id=<%=activityId%>";
                        } else {
                            window.location = "${pageContext.request.contextPath}/app/discipline/wx/zdjr_wx_handle_list.jsp";
                        }
                    } else {
