...
<div id="tableExcel"> 
	<table width="700" cellpadding="6" cellspacing="0" bgcolor="#cccccc" border="1" id="table">
    	<tr align="center">
        	<td colspan="<%=clsses_in.size()+clsses_out.size()+2%>">
        		<font size="3"><b><%=title%></b></font>
        	</td>
    	</tr>
    	<tr>
    		<td colspan="<%=clsses_in.size()+clsses_out.size()+2%>" align="center">
			...
			<tr align="center">
				...
				%>
				<td align="center"><%=(in_total.subtract(out_total)).divide(d2,2,BigDecimal.ROUND_HALF_UP).toString() %></td>
			</tr>
			<%
			}
			%>
			<tr>
				...
				%>
				<td align="center"><%=(in_total_sum.subtract(out_total_sum)).divide(d2,2,BigDecimal.ROUND_HALF_UP).toString()%></td>
		    </tr>
	</table>
</div>
</body>
