...
$(function() {
	$("#layout1").ligerLayout({
		...
		var treeData=<u:dict code="TJY2_TXWJFL_NEW" />;
...
<body class="p5">
	<div id="layout1">
		<div position="left" title="质量体系文件云" class="overflow-auto">
		
			<ul id="tree1" class="ztree"></ul>
		</div>
		<div position="center" align="center" title="文件列表">
			<iframe id="rightFrame" frameborder="0" name="userFrame" width="100%" height="100%" scrolling="no" src="app/qualitymanage/file_management_list2.jsp?mdy_drc=${param.mdy_drc}" /></iframe>
		</div>
	</div>
</body>
</html>
