...
var videoOpenType = '${param.videoOpenType}';
$(function () {
	//加载grid
	initFormBase();
	initFormDownLx();
...
function initFileGrid(gridId) {
    var columns = [
        {display: "操作", name: "picture",type: 'text', width: 40,isSort:false, align: "center",render:function(item, index){
        ...
        {display: "时间", name: "lxDate",type: 'text',width:190},
        /*
        {display: "大小", name: "len",type: 'text', align: "center",width:80},
        ...
        */
        {display: "文件位置", name: "filePath", type: 'text', align: "left",width:240}
      ];
