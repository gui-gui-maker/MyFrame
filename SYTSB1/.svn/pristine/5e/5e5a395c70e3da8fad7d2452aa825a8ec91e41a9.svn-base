...
<table border="0" cellpadding="0" cellspacing="0" id="ow_big_table">
    ...
    <tr>
        <td class="obt3" align="right" style="">
            ...
            <a class="l-button-warp l-button" ligeruiid="Button1009" style="margin-top:30px;"
               onclick="javasript:api.close();"><span class="l-button-main l-button-hasicon"><span
                    class="l-button-text">关闭</span><span class="l-button-icon iconfont l-icon-cancel"></span></span></a>
        </td>
    </tr>
</table>
