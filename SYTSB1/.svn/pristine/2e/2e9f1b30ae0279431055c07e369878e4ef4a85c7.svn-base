...
<script type="text/javascript">
	var qmUserConfig = {
			...
			sp_fields:[
				{name:"projectName",compare:"like",value:""},
			    {name:"forward_bm",compare:"like",value:""}, 
		        {name:"forward_man",compare:"like",value:""}
		            ],
	            tbar:[
	...
	function selectOk (){
		...
		var project_name = Qm.getValuesByName("project_name");
		var type =Qm.getValuesByName("type");
		var requirements=Qm.getValuesByName("requirements");
		api.data.window.selectTypeBack(id,project_name,type,requirements);
		api.close();
	}
...
<body>
	<qm:qm pageid="TJY2_INSTRUCTION_TYP" script="false" singleSelect="false">
	</qm:qm>
</body>
</html>
