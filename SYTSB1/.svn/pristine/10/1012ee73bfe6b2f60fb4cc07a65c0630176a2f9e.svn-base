	...
	<head>
		...
		<script type="text/javascript">
			var qmUserConfig = {
				...
				sp_fields : [
					{
						...
						compare : ">="
						       ...
						       {label:"${param.type=='2'?'保养':'维修'}日期",name:"repair_time",compare:">=",value:"",width:100,labelWidth:100},
						       {label:"到",name:"repair_time",compare:"<=",value:"",labelAlign:"center",labelWidth:20,width:100}
						       ],columnWidth:0.33
					}, {
				...
				<tbar:toolBar type="tbar" code="car_pro">
				</tbar:toolBar>,
				////            //提供以下4个事件
				listeners : {
