...
var qmUserConfig = {
        ...
        function add(){
        	 top.$.dialog({
		         ...
		         title: "新增信息",
		         content: 'url:app/humanresources/registration_datail.jsp?pageStatus=add&status=5'
	          });
        ...
        function edit(){
        	 top.$.dialog({
		         ...
		         title: "修改信息",
		         content: 'url:app/humanresources/registration_datail.jsp?pageStatus=modify&id='+Qm.getValueByName("id")+"&status=5&fkEmployee="+Qm.getValueByName("fk_employee")
	          });
...
<body>
       ...
       <qm:param name="emp_status" value="5" compare="in" />
       </qm:qm>
</body>
</html>