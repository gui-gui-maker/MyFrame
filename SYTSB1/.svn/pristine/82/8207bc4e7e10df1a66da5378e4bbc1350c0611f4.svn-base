	...
	<div data-role="content">
		<div id="a-guide-menu" class="a-guide-menu">
			...
			<div id="a_menu_item_an_ywbl" class="bar bar02">
				<div class="item" onclick="tiao('${pageContext.request.contextPath}/app/weixin/rs/index_gr.jsp');">
					<div id="aMenu_dibao" class="a" 
							menuid="dibao" url="">
							<div class="icon clr_3" style___="background-color:#0ffe76;">
								<img src="k/kui/images/icons/64/m1-default.jpg" alt="">
							</div>
							<div class="bartxt">个人中心</div>
						</div>		
				</div>
			    <div class="item" onclick="tiao('${pageContext.request.contextPath}/app/weixin/rs/index_rs.jsp');">
