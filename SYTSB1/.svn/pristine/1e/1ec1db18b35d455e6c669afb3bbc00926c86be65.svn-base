...
<body>
    <form id="form1" action="TechExchangeAction/save.do?status=${param.pageStatus}" getAction="TechExchangeAction/detail.do?id=${param.id}">
     ...
     <input type="hidden" name="type" id="type" value="nldb"/>
       <table border="1" cellpadding="3" cellspacing="0" width="" class="l-detail-table">
	  <tr> 
        <td class="l-t-td-left"> 比对项目</td>
        <td class="l-t-td-right"> 
        <input name="actTitle" id="actTitle" type="text" ltype='text'/>
        </td>
      </tr>
      <tr> 
        <td class="l-t-td-left"> 比对机构</td>
        <td class="l-t-td-right"> 
        <input name="actOrg" id="actOrg" type="text" ltype='text'/>
        </td>
      </tr>
      <tr>
        <td class="l-t-td-left"> 比对内容</td>
        <td class="l-t-td-right"> 
       ...
       <tr> 
        <td class="l-t-td-left"> 比对时间</td>
        <td class="l-t-td-right"> 
        <input name="actDate" id="actDate" type="text" ltype='date'/>
        </td>
        </tr>
         <tr> 
        <td class="l-t-td-left"> 检验项目</td>
        <td class="l-t-td-right"> 
        <input name="inspectType" id="inspectType" type="text" ltype='text'/>
        </td>
      </tr>
       <tr>
