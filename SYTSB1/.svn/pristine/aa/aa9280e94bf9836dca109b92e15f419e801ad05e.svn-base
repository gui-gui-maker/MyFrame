...
<script type="text/javascript">
	...
	function initPage(){
		...
		var d_url = $("base").attr("href") + "upload/"+api.data.date+"/"+api.data.report_sn+"/"+api.data.report_sn+".pdf";
		if(api.data.date == "" || api.data.date == null || api.data.date == "undefined"){
			d_url = $("base").attr("href") + "fileupload/download.do?id="+api.data.pdf_export_att;
		}
