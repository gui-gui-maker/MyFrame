			...
			<table border="0" cellpadding="0" cellspacing="0" id="tree_big_tb" height="100%">
				<tr>
					<td id="tree_big_tb_td_left">
						<iframe name="left" src="report/query/showExport.do?id=${param.id}&acc_id=${param.acc_id}&flow_num=${param.flow_num}&printType=${param.printType}" width="100%" height="100%" scrolling="atuo" frameborder="0" border="0"></iframe>
					</td>
