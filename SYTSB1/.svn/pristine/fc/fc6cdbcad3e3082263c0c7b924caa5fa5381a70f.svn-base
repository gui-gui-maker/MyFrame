     ...
     <input type="hidden" value="<%=user %>" id="peopleConcerned" name="peopleConcerned" />
      ...
      <input type="hidden" value="<%=useres.getDepartment().getId()%>" id="departmentId" name="departmentId">
            ...
            <th style="border:0px;width:40px"></th>
                ...
                <tr>
                  <td class="l-t-td-left" colspan="2">科研项目</td>
                ...
                <tr>
                  <td class="l-t-td-right" colspan="2">
                    <input type="text"
				id="projectItemId1" name="projectItemId1" ltype="select"
				ligerui="{
					selectBoxHeight:300,
					initValue:'',
					readonly:true,
				  ...
				  <td class="l-t-td-right" colspan="2">
                    <u:combo attribute="initValue:''" name="subItem1" code="fybx_ky_jjlx" /></td>
                  <td class="l-t-td-right" colspan="2">
                    <u:combo name="costItem1" code="ky_type"></u:combo></td>
                  <td class="l-t-td-right" colspan="2">
                ...
                <tr>
                  <td class="l-t-td-right" colspan="2">
                   <input type="text"
				id="projectItemId2" name="projectItemId2" ltype="select"
				ligerui="{
					selectBoxHeight:300,
					initValue:'',
					readonly:true,
					...
					<td class="l-t-td-right" colspan="2">
                    <u:combo attribute="initValue:''" name="subItem2" code="fybx_ky_jjlx" /></td>
                  <td class="l-t-td-right" colspan="2">
	                 <u:combo name="costItem2" code="ky_type"></u:combo></td>
                  <td class="l-t-td-right" colspan="2">
                ...
                <tr>
                   <td class="l-t-td-right" colspan="2">
                       <input type="text"
				id="projectItemId3" name="projectItemId3" ltype="select"
				ligerui="{
					selectBoxHeight:300,
					initValue:'',
					readonly:true,
					...
					<td class="l-t-td-right" colspan="2">
                    <u:combo attribute="initValue:''" name="subItem3" code="fybx_ky_jjlx" /></td>
                  <td class="l-t-td-right" colspan="2">
                     <u:combo name="costItem3" code="ky_type"></u:combo></td>
                  <td class="l-t-td-right" colspan="2">
                ...
                <tr>
                   <td class="l-t-td-right" colspan="2">
                     <input type="text"
				id="projectItemId4" name="projectItemId4" ltype="select"
				ligerui="{
					selectBoxHeight:300,
					initValue:'',
					readonly:true,
                  ...
                  <td class="l-t-td-right" colspan="2">
                    <u:combo attribute="initValue:''" name="subItem4" code="fybx_ky_jjlx" /></td>
                  <td class="l-t-td-right" colspan="2">
                  <u:combo name="costItem4" code="ky_type"></u:combo>
                  </td>
                  <td class="l-t-td-right" colspan="2">
