	...
	$(function () {
	    ...
	    //验证表单数据
			if($('#formObj').validate().form()){
		        ...
		        $.ajax({
		            url: "maintenance/info/develops.do?ids="+ids,
		...
		<table width="100%">		
			<tr>
				...
				<td class="l-t-td-right">
					<input name="develop_user_name" id="develop_user_name" type="text" ltype='text' validate="{required:true,maxlength:20}" value="高雅"/>
				</td>
