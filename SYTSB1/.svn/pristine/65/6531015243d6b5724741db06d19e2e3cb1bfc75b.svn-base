...
$(function() {
	...
	var treeData=<u:dict sql="select id,parent_id pid,regional_code code, regional_name text from BASE_ADMINISTRATIVE_DIVISIONS where REGIONAL_CODE in('510104','510106','510109','510122','510189')"/>;
...
function ztreeClick(event,treeId,treeNode){
	api.data.window.callStreet(treeNode.id,treeNode.text);
	api.close();
}
...
<body class="p5">
	<div id="layout1">
		<div position="left" title="设备所在街道" class="overflow-auto">
