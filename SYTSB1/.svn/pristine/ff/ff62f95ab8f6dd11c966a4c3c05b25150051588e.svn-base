    ...
    <script type="text/javascript">
                ...
                getSuccess: function (resp) {
                    if (resp.success) {
                        ...
                        var formData = {
                            ...
                            lqsj: resp.data.lqsj.substring(0, 10)
                        }
        ...
        function chooseGoods() {
            winOpen({
                lock: true,
                title: "选择存货",
                content: 'url:app\\fwxm\\recipients\\ch_lq_choose.jsp',
                data: {
                    "window": window,
    ...
    <fieldset class="l-fieldset">
        ...
        <table class="l-detail-table">
            ...
            <tr>
                ...
                <td class="l-t-td-right"><input name="lqbm" type="text" ltype="text"/></td>
            ...
            <tr>
                ...
                <td class="l-t-td-right"><input name="lqsj" type="text" ltype="text" ligerui="{disabled:true}"
                                                value="<%=date%>" ligerui="{format:'yyyy-MM-dd'}"/></td>
            </tr>
            <tr>
