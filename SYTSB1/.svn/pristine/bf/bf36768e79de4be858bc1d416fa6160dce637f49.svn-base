...
%>
        ...
        var qmUserConfig = {
            ...
            sp_fields:[
                ...
                {name:"contact_man",compare:"like",value:""}, 
                {group:[{name:"create_date",compare:">=",value:""},
        ...
        /*   tbar: [{ text:'详情', id:'detail',icon:'detail', click:detail } ], */
          listeners: {
                ...
                selectionChange :function(rowData,rowIndex){
                    ...
                    if(count==1){
                            Qm.setTbar({detail:true,call:true});
                    }else{
                        Qm.setTbar({detail:false,call:false});
                    }
                },
	...
	<body>
		...
		<qm:qm pageid="tjy2_discipline_msg" singleSelect="true">
