...
var selectOk = {"tab0":true};
	...
	$(function () {
		...
		var isBatchBusiness = api.data.params.isBatchBusiness;
		var path = 'rtbox/app/templates';
		if(isBatchBusiness=="1"){
			path = 'rtbox/app/templates/batchBusiness';
		}
		for (var i = 0; i < ids.length; i++) {
			if(i==0){
				...
				$("#mainTab").append('<div title="<span id=\'title'+i+'\'>'+report_sn[i]+'</span>"  lselected ="true" id="Tab'+i+'" tabid="Tab'+i+'">'
