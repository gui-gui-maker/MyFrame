		...
		<script type="text/javascript">
			var qmUserConfig = {
				...
				sp_fields:[
					...
					{name:"flow_note_name", id:"flow_note_name", compare:"=", value:"打印报告"}
	            ],
	            tbar:[
	...
	<body>
		<div class="item-tm" id="titleElement">
		    <div class="l-page-title">
				<div class="l-page-title-note"><font color='red'><b>提示：
					默认查询已签发待打印的报告，如需查询已打印的报告，请选择“当前流程”查询。</b></font>
				</div>
			</div>
		</div>
		<qm:qm pageid="report_query_list4">
		<%
