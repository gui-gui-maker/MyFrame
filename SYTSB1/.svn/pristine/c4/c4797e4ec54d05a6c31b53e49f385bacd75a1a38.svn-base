...
/**
 * 报检大厅参数 web controller
 * 
 * @author 肖慈边 2014-1-27
 */
@Entity
@JsonIgnoreProperties(ignoreUnknown = true, value = { "inspectionHall" })
@Table(name = "TZSB_INSPECTION_HALL_PARA")
public class InspectionHallPara implements BaseEntity {
...
//		private String	fk_hall_id	;	//	报检大厅ID
		...
		public InspectionHall inspectionHall;

		@ManyToOne(fetch = FetchType.EAGER)
		@JoinColumn(name = "fk_hall_id")
		public InspectionHall getInspectionHall() {
			return inspectionHall;
		}

		public void setInspectionHall(InspectionHall inspectionHall) {
			this.inspectionHall = inspectionHall;
		}
