	...
	var qmUserConfig = {
		...
		listeners: {
			...
			selectionChange : function(rowData, rowIndex) {
				...
				var status={};
				if(count==0){
					status={detail:false, edit:false, del:false,submit:false,dy:false,sh: false,gc:false,turnHistory:false,deal: false};
				}else if(count==1){
					if("已提交"==up_status){
						if("undefined"==sp_status){
							status={detail:true, edit:false, del:true,submit:false,dy:false};
						}else{
							status={detail:true, edit:false, del:false,submit:false,dy:false,sh: true,gc:true,turnHistory:true,deal: true};
						}
					}else if("审核中"==up_status){
						if("undefined"==sp_status){
							status={detail:true, edit:false, del:true,submit:false,dy:false};
						}else{
							status={detail:true, edit:false, del:false,submit:false,sdy:false,sh: true,gc:true,turnHistory:true,deal: true};
						}
					}else if("审核通过"==up_status){
						if("undefined"==sp_status){
							status={detail:true, edit:false, del:true,submit:false,dy:true};
						}else{
							status={detail:true, edit:false, del:false,submit:false,dy:true,sh: false,gc:true,turnHistory:true,deal: true};
						}
						...
						if("undefined"==sp_status){
							...
							status={detail:true, edit:true, del:true,submit:true,dy:false,sh: false,gc:true,turnHistory:true,deal: true};
						}
					}else if("审核未通过"==up_status){
						if("undefined"==sp_status){
							status={detail:true, edit:false, del:true,submit:false,dy:false};
						}else{
							status={detail:true, edit:false, del:true,submit:false,dy:false,sh: false,gc:true,turnHistory:true,deal: true};
						}
					}else{
						status={detail:true, edit:true, del:true,submit:true,dy:false,sh: false,gc:false,turnHistory:false,deal: false};
					}
				}else{
					if("已提交"==sp_status){
						status={detail:false, edit:false, del:true,submit:false,dy:true,sh: false,gc:true,turnHistory:true,deal: true};
					}else{
						status={detail:false, edit:false, del:false,submit:false,dy:false,sh: false,gc:true,turnHistory:true,deal: true};
					}
				}
				Qm.setTbar(status);
			},
...
//                	 }
	...
	function turnHistory(){	
		top.$.dialog({
   			...
   			lock : true, 
   			title: "流程卡",
   			content: 'url:archives/print/getFlowStep.do?id='+Qm.getValueByName("id"),
   			data : {"window" : window}
   		});
	}
	function submit() {
