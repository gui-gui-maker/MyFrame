...
@Entity
@Table(name = "TJY2_PXFBXD")
@JsonIgnoreProperties(ignoreUnknown=true)
public class Pxfbxd implements BaseEntity{
	...
	private String carApplyIds;//派车单ids
	private String carApplyNumbers;//派车单号

	private java.util.Date abolishTime; //作废时间
	private java.math.BigDecimal xiaoji1; //合计第2个空
	
	private java.math.BigDecimal  clXj1 ;      //合计1个空
    ...
    private java.util.Date bxQrTime;//处理时间报销确认
	  private String  clQdR5;
	  private String  clQdDm5;
	  private String  clZdR5;
	  private String  clZdDd5;
	  private java.math.BigDecimal  clJtfDj5;
	  private java.math.BigDecimal  clJtfJe5;
	  private java.math.BigDecimal  clZsfDj5;
	  private java.math.BigDecimal  clZsfJe5;
	  private java.math.BigDecimal  clHsbzTs5;
	  private java.math.BigDecimal  clHsbzJe5;
	  private java.math.BigDecimal  clGzfTs5;
	  private java.math.BigDecimal  clGzfJe5;
	  private java.math.BigDecimal  clQtDj5;
	  private java.math.BigDecimal  clQtJe5;
    ...
    */
    ...
    public void setXiaoji1(java.math.BigDecimal value){
        this.xiaoji1 = value;
    }
    public void setClXj1(java.math.BigDecimal value){
        this.clXj1 = value;
    }
    ...
    @Column(name ="CLXJ1",unique=false,nullable=true,insertable=true,updatable=true)
    public java.math.BigDecimal getClXj1(){
        return this.clXj1;
    }
    @Column(name ="XIAOJI1",unique=false,nullable=true,insertable=true,updatable=true)
    public java.math.BigDecimal getXiaoji1(){
        return this.xiaoji1;
    }
    ...
    @Column(name ="CAR_APPLY_IDS")
    public String getCarApplyIds() {
		return carApplyIds;
	}
	public void setCarApplyIds(String carApplyIds) {
		this.carApplyIds = carApplyIds;
	}
	@Column(name ="CAR_APPLY_NUMBERS")
	public String getCarApplyNumbers() {
		return carApplyNumbers;
	}
	public void setCarApplyNumbers(String carApplyNumbers) {
		this.carApplyNumbers = carApplyNumbers;
	}
