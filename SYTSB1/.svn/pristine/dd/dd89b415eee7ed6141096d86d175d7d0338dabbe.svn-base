...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        function detail(id){
			...
			top.$.dialog({
				...
				lock:true,
				title:"详情",
				content: 'url:app/equipment/apply/equipment_scrap_detail.jsp?status=detail&id=' + id+'&apply_type=04',
				data:{window:window},
				cancel:true
			});
		}
        ...
        function add(){
			top.$.dialog({
				...
				title:"新增",
				data: {window:window},
				content: 'url:app/equipment/apply/equipment_scrap_detail.jsp?status=add&apply_type=04'
			});
        }
        ...
        function modify(){
			...
			top.$.dialog({
				...
				title:"修改",
				data: {window:window},
				content: 'url:app/equipment/apply/equipment_scrap_detail.jsp?status=modify&id='+Qm.getValueByName("id")+'&apply_type=04'
			});
        } 
	...
	<body>
		<qm:qm pageid="eq2_scrap_list" singleSelect="false">
			<qm:param name="apply_type" value="04" compare="="/>
		</qm:qm>
	</body>
</html>
