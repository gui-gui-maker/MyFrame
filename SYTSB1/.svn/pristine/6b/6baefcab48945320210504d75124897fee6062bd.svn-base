...
<body>
	<form name="formObj" id="formObj" method="post"
        ...
        <input name="state" type="hidden" id="state" value="未派车"/>
		...
		<table border="1" cellpadding="3" cellspacing="0"
			...
			<tr>
				...
				<input type="hidden" name="applyRoomCode" id="applyRoomCode" value="<sec:authentication property="principal.department.id"/>"/>
				<input name="applyRoom" id="applyRoom" type="text" ltype='text' value="<sec:authentication property="principal.department.orgName"/>" validate="{required:true,maxlength:50}"  readonly onClick="selectUnitOrUser(0,0,'applyRoomCode','applyRoom','')"
				ligerui="{iconItems:[
				                   {img:'k/kui/images/icons/16/icon-down.png',click:function(val,e,srcObj){selectUnitOrUser(0,0,'applyRoomCode','applyRoom','')}}
				                   ]}" />
