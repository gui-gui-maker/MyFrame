...
<%
    ...
    for (int i = 0; i < reportItemValueList.size(); i++)
    {
    	...
    	}else if (reportItemValue.getItem_name().startsWith("INSPECTION_DATE")
    			|| "INSPECTION_END_DATE".equals(reportItemValue.getItem_name())
    			|| "INSPECT_NEXT_DATE".equals(reportItemValue.getItem_name())
    			|| reportItemValue.getItem_name().contains("INSPECTION_DATE")) {
