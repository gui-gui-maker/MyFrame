    ...
    var a = function (b, c) {
        ...
        var p = function (C, D) {
            ...
            if (D.getCustomData('isReady') == 'true') {
                ...
                //2012-03-27 28222205@qq.com修改-默认图片的宽度为700px
                if ( D.$.width <=700) {
                    E && E.setValue(D.$.width);
                    F && F.setValue(D.$.height);
                } else {
                    //450 * oImageOriginal.height / oImageOriginal.width
                    E && E.setValue(700);
                    F && F.setValue(parseInt(700*D.$.height/D.$.width));
                }
                //E && E.setValue(D.$.width);
                //F && F.setValue(D.$.height);
            }
