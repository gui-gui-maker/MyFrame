...
<body>
	<form name="basePeop" id="basePeop" method="post"
		action="contractInfoAction/warnDate.do" >
		<input type="hidden" name="ids" value="${param.ids }"/>
		<br/>
		<table cellpadding="3" cellspacing="0" class="l-detail-table">
			<tr>
				<td class="l-t-td-left">预警时间：</td>
				<td class="l-t-td-right" >
					<input id="warnDate" name="warnDate" type="text" ltype='date' validate="{required:false}" value="${param.effect_date }"
