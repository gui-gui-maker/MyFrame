...
<head>
    ...
    function query(){
        ...
        $.getJSON(encodeURI("disciplinePlanAction/selectOldTj.do?startTime="+startTime+"&endTime="+endTime),function(res){
    ...
    function out()
    {
    	...
    	$("#form1").attr("action","disciplinePlanAction/exportCheckedCountOld.do");
    	$("#form1").submit();
    	$("body").unmask();
    };
    </script>
...
%>
<body style="overflow: auto;" onload="query()">
