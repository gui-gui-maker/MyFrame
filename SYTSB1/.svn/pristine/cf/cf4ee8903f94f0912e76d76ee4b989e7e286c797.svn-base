...
public class PrintJsTask implements Callable<PrintPdfLog> {
	...
	public PrintJsTask(PrintPdfTask printPdfTask, String pageNo, String url, String savePath, String printBatch) {
	...
	static Log log = LogFactory.getLog(PrintJsTask.class);
