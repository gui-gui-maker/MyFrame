$('.classification .yj').unbind('click').click(function () {
    ...
    if($('.yj img').attr('src') == 'rtdroc/app/view2/images/zhankai_03.png'){
        $('.yj img').attr('src','rtdroc/app/view2/images/zedie_03.png');
    }else{
        $('.yj img').attr('src','rtdroc/app/view2/images/zhankai_03.png');
    }
});
$('.classification1 .yj1').unbind('click').click(function () {
    $('.classification1 .yjnr1').slideToggle();
    if($('.yj1 img').attr('src') == 'rtdroc/app/view2/images/zhankai_03.png'){
        $('.yj1 img').attr('src','rtdroc/app/view2/images/zedie_03.png');
    }else{
        $('.yj1 img').attr('src','rtdroc/app/view2/images/zhankai_03.png');
    }
});
$('.classification2 .yj2').unbind('click').click(function () {
    $('.classification2 .yjnr2').slideToggle();
    if($('.yj2 img').attr('src') == 'rtdroc/app/view2/images/zhankai_03.png'){
        $('.yj2 img').attr('src','rtdroc/app/view2/images/zedie_03.png');
    }else{
        $('.yj2 img').attr('src','rtdroc/app/view2/images/zhankai_03.png');
    }
});

$('.classification3 .yj3').unbind('click').click(function () {
    $('.classification3 .yjnr3').slideToggle();
    if($('.yj3 img').attr('src') == 'rtdroc/app/view2/images/zhankai_03.png'){
        $('.yj3 img').attr('src','rtdroc/app/view2/images/zedie_03.png');
    }else{
        $('.yj3 img').attr('src','rtdroc/app/view2/images/zhankai_03.png');
    }
});
...
$('.dianjileft').mouseover(function () {
    $('.left').show();
    $('.dianjileft').css('left','232px');
    //$('.center').css('width','75%');
    $('.center').css('left','237px');
    if($('.right').css('display') == 'none'){
        $('.center').css('left','237px');
        $('.center').css('right','237px');
    }
});
...
$('.yjnr ul li').click(function () {
    ...
    $('.yjnr1 ul li').removeClass('active');
    $('.yjnr2 ul li').removeClass('active');
    $('.yjnr3 ul li').removeClass('active');
});
$('.yjnr1 ul li').click(function () {
    var index = $(this).index();
    $('.yjnr1 ul li').eq(index).addClass('active').siblings().removeClass('active');
    //$('.yjnr ul li').siblings().removeClass('active');
    $('.yjnr2 ul li').removeClass('active');
    $('.yjnr3 ul li').removeClass('active');
...
$('.yjnr2 ul li').click(function () {
    ...
    $('.yjnr1 ul li').removeClass('active');
    //$('.yjnr ul li').removeClass('active');
    $('.yjnr3 ul li').removeClass('active');
});
$('.yjnr3 ul li').click(function () {
	var index = $(this).index();
	$('.yjnr3 ul li').eq(index).addClass('active').siblings().removeClass('active');
    $('.yjnr1 ul li').removeClass('active');
    $('.yjnr2 ul li').removeClass('active');
    // $('.yjnr ul li').removeClass('active');
});
