...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>供货商查询列表(NO)</title>
		<%@include file="/k/kui-base-list.jsp"%>
		<script type="text/javascript">
			var qmUserConfig = {
	         	sp_fields:[
					{name:"supplier_name",compare:"like",value:""}
	            ],
	            tbar:[
			...
			function selectValue(){			
				api.data.parentWindow.callBack(Qm.getValueByName("id"),Qm.getValueByName("supplier_name"));
	...
	<body>
		<qm:qm pageid="eq2_supplier" script="false" singleSelect="true"></qm:qm>
	</body>
</html>