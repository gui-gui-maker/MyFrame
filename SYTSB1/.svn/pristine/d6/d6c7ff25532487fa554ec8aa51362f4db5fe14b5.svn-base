...
<script type="text/javascript" charset="utf-8" src="<%=uriPre%>/jquery_mobile_datepicker.js"></script>
<script type="text/javascript" charset="utf-8" src="<%=uriPre%>/datepicker.js"></script>
<script type="text/javascript" charset="utf-8" src="<%=uriPre%>/iscroll.js"></script>
<script type="text/javascript" charset="utf-8" src="<%=uriPre%>/jquery_mobile_iscrollview.js"></script>
<script type="text/javascript" charset="utf-8" src="<%=uriPre%>/mobile_lib.js"></script>
<%}%>
