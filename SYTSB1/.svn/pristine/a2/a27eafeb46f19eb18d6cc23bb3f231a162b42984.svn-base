 ...
 * @see 地址为https://blog.csdn.net/jadyer/article/details/8087960
 * @see 还有一个使用Java原生API编写发送HTTP_POST请求的工具类
 * @see 地址为https://blog.csdn.net/jadyer/article/details/8637228
...
public static void main(String[] args) throws Exception { 
    ...
    params.put("serverCallUrl", "https://blog.csdn.net/jadyer"); 
    ...
    Map<String, String> respMap = sendPostRequest("https://127.0.0.1/tra/trade/noCardNoPassword.htm", params, "GB18030"); 
    System.out.println("============================================================================="); 
