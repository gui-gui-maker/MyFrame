...
<script type="text/javascript">
		...
		sp_defaults:{columnWidth:0.3,labelAlign:'right',labelSeparator:'',labelWidth:120},	// 默认值，可自定义
		 sp_fields:[
			...
			tbar:[{
				...
				text: '审核', id: 'edit', icon: 'modify', click: edit 
			} ],
			listeners:{
	...
	function edit(){
		...
		top.$.dialog({
			...
			title:"审核",
			content:'url:app/finance/cw_bill_audit_detail.jsp?id=' + id + '&pageStatus=modify'
		});
	}
...
<body>
	...
	<qm:qm pageid="cw_bill_list" script="false" singleSelect="false" >
		<qm:param name="data_status" value="(1,2)" compare="in" />
