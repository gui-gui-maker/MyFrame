...
(function() {
	if (!window.FusionCharts || !window.FusionCharts.version) {
		var a = {},
			...
			m = function(a, b) {
				var e, k;
				if (b instanceof Array) for (e = 0; e < b.length; e += 1) typeof b[e] !== "object" ? a[e] = b[e] : (typeof a[e] !== "object" && (a[e] = b[e] instanceof Array ? [] : {}), m(a[e], b[e]));
				else for (e in b) typeof b[e] === "object" ? (k = o.call(b[e]), k === "[object Object]" ? (typeof a[e] !== "object" && (a[e] = {}), m(a[e], b[e])) : k === "[object Array]" ? (a[e] instanceof Array || (a[e] = []), m(a[e], b[e])) : a[e] = b[e]) : a[e] = b[e];
				return a
			};
		...
		d.stat = ["swfUrl", "id", "width", "height", "debugMode", "registerWithJS", "backgroundColor", "scaleMode", "lang", "detectFlashVersion", "autoInstallRedirect"];
		a.parsePolicies = function(b, e, i) {
			var k, c, d;
			for (c in e) if (a.policies[c] instanceof Array) d = i[e[c][0]], b[c] = d === void 0 ? e[c][1] : d;
			else for (k in typeof b[c] !== "object" && (b[c] = {}), e[c]) d = i[e[c][k][0]], b[c][k] = d === void 0 ? e[c][k][1] : d
		};
		...
		a.core = function(b) {
			...
			a.raiseEvent("Initialized", e, this);
			return this
		};
		a.core.prototype = {};
		...
		function() {
			...
			if (c) try {
				f.location.protocol === "https:" ? g.write('<script id="__ie_onload_fusioncharts" defer="defer" src="//:"><\/script>') : g.write('<script id="__ie_onload_fusioncharts" defer="defer" src="javascript:void(0)"><\/script>'), g.getElementById("__ie_onload_fusioncharts").onreadystatechange = function() {
		...
		var f = function(a, d, h, c) {
			...
			g = function(j, d, h) {
				if (j instanceof Array) for (var c = 0, b; c < j.length; c += 1) {
					if (j[c][1] === d.sender || j[c][1] === void 0) if (b = j[c][1] === d.sender ? d.sender : a.core, f(j[c], b, d, h), d.detached === !0) j.splice(c, 1), c -= 1, d.detached = !1;
			...
			h = {
				...
				addListener: function(j, d, g) {
					if (j instanceof Array) for (var c = 0; c < j.length; c += 1) h.addListener(j[c], d, g);
					else typeof j !== "string" ? a.raiseError(g || a.core, "03091549", "param", "::EventTarget.addListener", Error("Unspecified Event Type")) : typeof d !== "function" ? a.raiseError(g || a.core, "03091550", "param", "::EventTarget.addListener", Error("Invalid Event Listener")) : (j = j.toLowerCase(), h.listeners[j] instanceof Array || (h.listeners[j] = []), h.listeners[j].push([d, g]))
				},
				removeListener: function(j, d, g) {
					...
					else if (j instanceof Array) for (c = 0; c < j.length; c += 1) h.removeListener(j[c], d, g);
					else if (typeof j !== "string") a.raiseError(g || a.core, "03091559", "param", "::EventTarget.removeListener", Error("Unspecified Event Type"));
					else if (j = j.toLowerCase(), j = h.listeners[j], j instanceof Array) for (c = 0; c < j.length; c += 1) j[c][0] === d && j[c][1] === g && (j.splice(c, 1), c -= 1)
				},
		...
		a.extend(a.core, {
			debugMode: {
				...
				outputFormat: function(a) {
					if (a && typeof a.toLowerCase === "function" && typeof h.outputHelpers[a = a.toLowerCase()] === "function") return h.currentOutputHelper = h.outputHelpers[a], !0;
					return !1
				},
				outputTo: function(g) {
				...
				enabled: function(g, d, f) {
					...
					if (typeof d === "function") h.outputTo = d;
...
FusionCharts(["private", "modules.mantle.ajax", function() {
	...
	f.prototype.transact = function(i, d, e, m) {
		...
		try {
			...
			if (i) if (l.open("POST", d, !0), typeof e === "string") f = e;
			else {
				f = [];
...
(function() {
	...
	if (a !== void 0) {
		...
		a.core.options.scriptBaseUri = function() {
			...
			if (b === void 0) return a.raiseError(FusionCharts, "1603111624", "run", ">GenericRuntime~scriptBaseUri", "Unable to locate FusionCharts script source location (URL)."), "";
			return b
		}();
		var g = /[\\\"<>;&]/,
		...
		a.capitalizeString = function(a, b) {
			return a ? a.replace(b ? /(^|\s)([a-z])/g : /(^|\s)([a-z])/, function(a, b, e) {
		...
		var i = a.purgeDOM = function(a) {
			...
			t = function(a, b, e) {
				for (var i in a) {
					...
					else for (c in a[i]) b[a[i][c][0]] = e[i][c]
				}
			},
			e = /[^\%\d]*$/ig,
...
(function() {
	...
	if (a !== void 0) {
		...
		a.normalizeCSSDimension = function(a, i, c) {
			...
			if (a.match(/^\s*\d*\.?\d*\%\s*$/) && !a.match(/^\s*0\%\s*$/) && c.offsetWidth === 0) for (e = c; e = e.offsetParent;) if (e.offsetWidth > 0) {
		...
		var f = function() {
			...
			j = a.renderer = {
				...
				setDefault: function(b) {
					if (!b || typeof b.toString !== "function") return a.raiseError(a.core, "25081731", "param", "::RendererManager>setDefault", 'Invalid renderer name specified in "name"'), !1;
				...
				notifyRender: function(b) {
					...
					(!i || b.success === !1 && !b.silent) && a.raiseError(a.core.items[b.id], "25081850", "run", "::RendererManager", Error("There was an error rendering the chart. Enable FusionCharts JS debugMode for more information."));
				...
				dispose: function(a) {
					h[a.id].dispose.apply(a, Array.prototype.slice.call(arguments, 1))
				}
			},
			d = function(b) {
				return function() {
		...
		a.extend(a.core, {
			render: function(b) {
				var i, d;
				((i = window[this.id]) && i.FusionCharts && i.FusionCharts === this || (i = this.ref) && i.FusionCharts && i.FusionCharts === this) && a.renderer.dispose(this);
				...
				d === "prepend" && b.firstChild ? b.insertBefore(i, b.firstChild) : b.appendChild(i);
	...
	if (a !== void 0) {
		...
		a.addEventListener("BeforeInitialize", function(a) {
			...
			if (c !== void 0 && c !== null) {
				...
				a.setChartData(c, a.options.dataFormat)
			}
		});
		a.addEventListener("BeforeDispose", function(a) {
			var c = a.sender;
		...
		a.extend(a.core, {
			setChartDataUrl: function(b, c, f) {
				if (c === void 0 || c === null || typeof c.toString !== "function") a.raiseError(a.core, "03091609", "param", ".setChartDataUrl", Error("Invalid Data Format"));
					...
					var c = c.toString().toLowerCase(),
						e, m = this,
						g = m.options && m.options.renderer === "flash" && m.options.useLegacyXMLTransport || !1;
			...
			getChartData: function(b, c) {
				var e;
				var d;
				if (b === void 0 || typeof b.toString !== "function" || (d = f[b = b.toString().toLowerCase()]) === void 0) a.raiseError(this, "25081543", "param", "~getChartData()", Error('Unrecognized data-format specified in "format"'));
		...
		a.extend(a.core, {
			transcodeData: function(b, c, d, e, m) {
				if (!c || typeof c.toString !== "function" || !d || typeof d.toString !== "function" || f[d = d.toString().toLowerCase()] === void 0 || f[c = c.toString().toLowerCase()] === void 0) a.raiseError(this, "14090217", "param", "transcodeData()", Error("Unrecognized data-format specified during transcoding."));
				else {
		...
		a.addEventListener("Loaded", function(b) {
			...
			if (b.chartType && c[b.chartType()] && c[b.chartType()][0]) {
				for (f in a.transcoders) e = a.transcoders[f].name, e = "get" + e + "Data", b[e] = function(e, b) {
					return function(c) {
						return c === !1 ? b.apply(this) : this.ref.getUpdatedXMLData ? a.core.transcodeData(this.ref.getUpdatedXMLData(), "xml", e) : this.getData ? this.getData(e) : b.apply(this)
					}
...
var swfobject = window.swfobject = function() {
			...
			if (a > 0) for (var e = 0; e < a; e++) {
				...
				if (q.pv[0] > 0) {
					...
					if (h) if (l(s[e].swfVersion) && !(q.wk && q.wk < 312)) {
						...
						for (var u = {}, h = h.getElementsByTagName("param"), j = h.length, p = 0; p < j; p++) h[p].getAttribute("name").toLowerCase() != "movie" && (u[h[p].getAttribute("name")] = h[p].getAttribute("value"));
						c(g, u, i, f)
					} else b(h), f && f(g)
				} else if (k(i, !0), f) {
		...
		function o() {
			return !H && l("6.0.65") && (q.win || q.mac) && !(q.wk && q.wk < 312)
		}
		function c(a, e, b, c) {
			H = !0;
			K = c || null;
		...
		function i(a) {
			...
			else if (a = a.getElementsByTagName(y)[0]) if (a = a.childNodes) for (var b = a.length, c = 0; c < b; c++)!(a[c].nodeType == 1 && a[c].nodeName == "PARAM") && a[c].nodeType != 8 && e.appendChild(a[c].cloneNode(!0));
			return e
		}
		function t(a, e, b) {
			var c, b = m(b);
			...
			if (b) {
				...
				if (q.ie && q.win) {
					var d = "",
						i;
					for (i in a) if (a[i] != Object.prototype[i]) i.toLowerCase() == "data" ? e.movie = a[i] : i.toLowerCase() == "styleclass" ? d += ' class="' + a[i] + '"' : i.toLowerCase() != "classid" && (d += " " + i + '="' + a[i] + '"');
					i = "";
					...
					for (var g in a) a[g] != Object.prototype[g] && (g.toLowerCase() == "styleclass" ? k.setAttribute("class", a[g]) : g.toLowerCase() != "classid" && k.setAttribute(g, a[g]));
		...
		function r(a, e, b, c) {
			if (!q.ie || !q.mac) {
				...
				if (d) {
					...
					c && (L = C = null);
					if (!C || L != b) c = n.createElement("style"), c.setAttribute("type", "text/css"), c.setAttribute("media", b), C = d.appendChild(c), q.ie && q.win && typeof n.styleSheets != v && n.styleSheets.length > 0 && (C = n.styleSheets[n.styleSheets.length - 1]), L = b;
		...
		var v = "undefined",
			...
			q = function() {
				var a = typeof n.getElementById != v && typeof n.getElementsByTagName != v && typeof n.createElement != v,
					...
					e = /webkit/.test(e) ? parseFloat(e.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1,
					d = !+"\u000b1",
					i = [0, 0, 0],
					k = null;
		...
		(function() {
			q.w3 && ((typeof n.readyState != v && n.readyState == "complete" || typeof n.readyState == v && (n.getElementsByTagName("body")[0] || n.body)) && a(), D || (typeof n.addEventListener != v && n.addEventListener("DOMContentLoaded", a, !1), q.ie && q.win && (n.attachEvent("onreadystatechange", function() {
				n.readyState == "complete" && (n.detachEvent("onreadystatechange", arguments.callee), a())
			}), w == top &&
			function() {
				if (!D) {
					try {
...
FusionCharts(["private", "modules.renderer.flash", function() {
		...
		if (!(c instanceof a.core)) return setTimeout(function() {
			...
			if (b = e !== void 0) {
				...
				if (!c && typeof c.tagName !== "string") b = void 0;
					...
					if ((d = c.parentNode) && d.tagName && d.tagName.toLowerCase() === "object" && d.parentNode) d = d.parentNode;
					if (d) {
						b.renderAt = d;
	...
	var t = function(e) {
			...
			if (e.options.renderer === "flash") {
				...
				if (e.flashVars.DOMId === void 0) e.flashVars.DOMId = e.id;
				...
				if (e.options.dataFormat === void 0 && e.options.dataSource === void 0) e.options.dataFormat = FusionChartsDataFormats.XMLURL, e.options.dataSource = "Data.xml"
			}
		};
	a.renderer.register("flash", {
		...
		resize: function() {
			...
			if (this.ref !== void 0) this.ref.width = this.width, this.ref.height = this.height, h(this.ref.resize) && this.ref.resize(this.ref.offsetWidth, this.ref.offsetHeight)
		},
		config: function(e) {
		...
		events: {
			...
			DataLoadError: function(a, b) {
				var c = a.sender;
				c.ref && h(c.ref.showChartMessage) && b.source === "XmlHttpRequest" ? c.ref.showChartMessage("LoadDataErrorText") : (delete c.flashVars.dataURL, c.flashVars.dataXML = "<JSON parsing error>", delete c.flashVars.stallLoad)
			},
...
FusionCharts(["private", "modules.renderer.js", function() {
	...
	var e = d.hasModule = function(b) {
			...
			if (b instanceof Array) {
				c = 0;
				for (e = b.length; c < e; c += 1) if (!Boolean(a.modules["modules.renderer.js-" + b]) || b === "jquery" && !Boolean(f.jQuery)) return !1;
				return !0
			}
				...
				j = function() {
					if (m >= h) d && d();
						...
						if (l) if (e(l)) {
							...
							if (i[l]) {
								a.raiseError(f || a.core, "1112201445A", "run", "JavaScriptRenderer~loadModule() ", "required resources are absent or blocked from loading.");
								g && g(l);
								return
							}
						} else g && g(l);
	...
	d.cleanupWaitingCommands = function(a) {
		for (var b = a.chartType(), b = t(b), c, e = [], d; c = b.shift();) {
			for (c = o[c] || []; d = c.shift();) typeof d === "object" && d.obj !== a && e.push(d);
			c.concat(e);
			e = []
		}
	};
	...
	a.extend(j, {
		...
		config: function(a, b) {
			var c, e = this.jsVars,
				d = e.msgStore,
				e = e.cfgStore;
			typeof a === "string" && arguments.length > 1 && (c = a, a = {}, a[c] = b);
		...
		events: {
			...
			DataLoadRequested: function(a) {
				var a = a.sender,
					b = a.jsVars;
				delete b.loadError;
				a.ref && a.options.showDataLoadingMessage ? b.hcObj && !b.hasNativeMessage && b.hcObj.showLoading ? b.hcObj.showMessage(b.msgStore.XMLLoadingText) : a.ref.showChartMessage ? a.ref.showChartMessage("XMLLoadingText") : b.stallLoad = !0 : b.stallLoad = !0
			},
	...
	a.extend(j.prototype, {
		...
		setTransparent: function(a) {
			var b;
			if (b = this.jsVars) typeof a !== "boolean" && a !== null && (a = !0), b.transparent = a === null ? !1 : a === !0 ? !0 : !1
		}
	});
	a.extend(a.core, {
...
(function() {
	...
	if (typeof JSON.stringify !== "function") JSON.stringify = function(a, c, e) {
		var f;
		o = d = "";
		if (typeof e === "number") for (f = 0; f < e; f += 1) o += " ";
	...
	if (typeof JSON.parse !== "function") JSON.parse = function(a, b) {
		...
		if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) return d = eval("(" + a + ")"), typeof b === "function" ? c({
			"": d
		}, "") : d;
					...
					d = {
						...
						child: function(c, b, i, f) {
							...
							case 1:
								...
								} else typeof k === "object" && typeof k[i] === "string" ? h = k[i] : typeof k === "string" && (h = k);
					...
					f = function(c) {
						...
						try {
							...
							if (!g || !g.childNodes || !(g.childNodes.length === 1 && (h = g.childNodes[0]) && h.nodeName && (e = h.nodeName.toLowerCase()) && (e === "chart" || e === "map" || e === "graph"))) return f.errorObject = new TypeError("xml2json.parse()"), b;
								...
								for (k = (l = h.attributes) && l.length || 0; k--;) j.setAttribute(l[k].name, l[k].value), l.removeNamedItem(l[k].name);
			...
			h = function() {
				var a = {
					...
					d = function(g, c, b, h) {
						...
						if (g instanceof Array) for (l = 0; l < g.length; l += 1) u += typeof g[l] === "string" ? f(g[l]) : d(g[l], c, b, h);
						else {
							for (l in g) r = l.toLowerCase(), g[l] instanceof Array && (k = a.qualify("group", r, c)) ? e += "<" + r + ">" + d(g[l], k, c, h) + "</" + r + ">" : typeof g[l] === "object" ? (k = a.qualify("attr", r, c)) ? (m = d(g[l], k, c, h).replace(/\/\>/ig, ""), c = r) : e += d(g[l], r, c, h) : h.applyDSV && (k = a.qualify("dsv", r, c)) ? e += g[l] : (k = a.qualify("text", r, c)) ? e += "<" + k + ">" + g[l] + "</" + k + ">" : r === "vline" && Boolean(g[l]) ? c = "vline" : t += " " + r + '="' + f(g[l]).toString().replace(/\"/ig, "&quot;") + '"';
...
FusionCharts(["private", "CSVDataHandler", function() {
	...
	f.prototype.setRow = function(a, h) {
		var f;
		if (this.rowCount <= a) {
	...
	a.addDataHandler("CSV", {
		...
		decode: function(g) {
			var g = a.core.transcodeData(g, "xml", "json") || {},
			...
			if (j) h.setRow(0, ["Id", " Short Name", "Long Name", "Value", "Formatted Value"]);
			else if ((p = g.dials && g.dials.dial || g.pointers && g.pointers.pointer || g.value) !== void 0) if (typeof p === "string") h.set(0, 0, p), typeof g.target === "string" && h.set(0, 1, g.target);
			else {
				h.setRow(0, ["Id", "Value"]);
				c = 0;
				i = 1;
				...
				c = 0;
				for (x = p.length; c < x; c += 1) s = p[c], s.vline || (n = parseFloat(s.value ? s.value : ""), n = isNaN(n) ? "" : n, h.setRow(c + 1, [s.label || s.name, n]))
			}
			if (l) {
				h.clear();
				r = !1;
				...
				for (t = u.length; c < t; c += 1, b += 1) n = u[c], n.id && (l[n.id.toLowerCase()] = b, h.set(0, b, n.label || n.id));
	...
	a.core.addEventListener("Loaded", function(a) {
		a = a.sender;
		if (a.options.renderer === "javascript" && !a.getDataAsCSV) a.getDataAsCSV = a.ref.getDataAsCSV = a.getCSVData
	})
}]);
(function() {
	...
	a !== void 0 && a.extend(a.core, {
		...
		getChartAttribute: function(f) {
			var g = (g = this.getChartData(FusionChartsDataFormats.JSON)).chart || g.graph || g.map;
...
(function() {
	...
	if (a !== void 0) {
		...
		var f = window.FusionChartsDOMInsertModes = {
			...
			j = function(a, g) {
				return (a.options.containerElement === g.options.containerElement || a.options.containerElementId === g.options.containerElementId) && a.options.insertMode === f.REPLACE
			};
		...
		a.extend(a.core, {
			configureLink: function(d, f) {
				...
				if (d instanceof Array) {
					...
					a.extend(g[this.link.root.id][f], d)
		...
		a.addEventListener("Loaded", function(d) {
			if ((d = d.sender) && d.link !== void 0 && d.link.root !== d && d.link.parent instanceof a.core) if (d.ref && typeof d.ref.drawOverlayButton === "function") {
				var f = a.extend({
					show: !0,
					id: "LinkManager"
...
(function() {
	...
	if (a !== void 0) {
		var f = {
			...
			g = {
				...
				rle2array: function(a, b) {
					...
					for (d in c) {
						c[d] = c[d].split(/[_,]/);
						for (f = 0; f < c[d].length; f += 2) c[d][f] = c[d][f] === "" ? b : ("000000" + c[d][f]).substr(-6)
					}
					return c
				},
		...
		g.drawRLE = function(a, b, c, d, f) {
			...
			else for (f in c = g.rle2array(b, f), d = f = b = 0, c) for (d = b = 0; d < c[f].length; d += 2) a.fillStyle = "#" + c[f][d], a.fillRect(b, f, c[f][d + 1], 1), b += parseInt(c[f][d + 1], 10);
			return !0
		};
		var h = {
			styles: {
		...
		var b = function(b) {
				...
				if (d === void 0 || typeof d.prepareImageDataStream !== "function" || d.prepareImageDataStream() === !1) c(b.sender);
					...
					try {
						...
						h.invoke("error"), a.raiseError(b.sender, "25081807", "run", "::PrintManager>onDrawComplete", "There was an error while showing message to user via canvas.")
					}
				}
			},
			i = function(b, c) {
		...
		a.extend(a.core, {
			printManager: {
				...
				enabled: function(d) {
					...
					if (a.renderer.currentRendererName() !== "flash" || typeof document.createElement("canvas").getContext !== "function") return f.bypass = !0, a.raiseEvent("PrintReadyStateChange", {
						ready: !0,
						bypass: f.bypass
					...
					if (d === !0) {
						...
						for (o in a.core.items) c(a.core.items[o]), c()
					} else {
						var l;
						h.invoke("error");
				...
				managedPrint: function(b) {
					f.bypass ? window.print() : a.core.printManager.isReady() ? typeof b === "object" && b.ready !== !0 || (a.removeEventListener("PrintReadyStateChange", a.core.printManager.managedPrint), window.print()) : a.core.printManager.enabled(!0) !== !0 ? window.print() : a.addEventListener("PrintReadyStateChange", a.core.printManager.managedPrint)
				}
			}
		}, !1);
