/**
			 * 双向箭头
			 */
			function RtArrowDouble(rtLayer, start, addToLayer) {
				this.name="RtArrowDouble";
				this.cname = "双向箭头";
			...
			RtArrowDouble.prototype = {
				...
				assistDraw: function(ctx, fromX, fromY, toX, toY) { 
					...
					var barrowX = fromX - botX; 
				    var barrowY = fromY - botY;
				...
				copy : function() {
					...
					var copyData = new RtArrowDouble(this.rtLayer,start);
					copyData.end = end;
