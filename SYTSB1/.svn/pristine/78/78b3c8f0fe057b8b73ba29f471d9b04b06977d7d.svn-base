...
<head pageStatus="${param.pageStatus}" pageKeys="detail1">
	...
	$(function () {
		...
		//$("#title").pageTitle({text:"sdfasdf"});
		pageTitle({to: "#titleElement", text: "软件开发管理系统——编辑", note: '<a href="javascript:void(0);">点击操作1</a><a href="javascript:void(0);">点击操作2</a><a href="javascript:void(0);">点击操作3</a><a href="javascript:void(0);">点击操作4</a><a href="javascript:void(0);">点击操作5</a><a href="javascript:void(0);">点击操作6</a>这里是副标题，可带操作说明', icon: "k/kui/images/icons/32/places.png"});
		$("#toolbar1").ligerButton({
			items: [
				{text: "保存", id: "save", icon: "save", disabled: true, click: function () {
					top.$.dialog.tips("系统开发完成系统开发完成系统开发完成系统开发完成系统开发完成", 5, "k/kui/images/icons/dialog/32X32/i.png", function () {
				...
				{text: "打开窗口1", id: "gwrhb", click: function () {
					var wObj = top.$.dialog({
						...
						content: 'url:demo/demo_detail8.jsp'
					});
				}},
		...
		$("#zdyToolbar").ligerToolBar({
			items: [
				...
				{icon: "del", id: "bwef", click: function () {
					$("#buttonBar").ligerButton({
						items: [
							{title: "1111111", id: "xbnd9ero8g93w4tg", img: "/k/kui/images/icons/16/card.png", click: function () {
								alert("3333")
							}},
							{text: "2222222222", icon: "del", disabled:true, click: function () {
								alert("我被点了吗")
							}},
							"-",
				...
				{id: "test1", img: "/k/kui/images/icons/16/car-2.png"},
				{id: "test2", disabled: true, img: "/k/kui/images/icons/16/book2.png"},
				{id: "test3", img: "/k/kui/images/icons/16/dialog.png"},
				{id: "test4", img: "/k/kui/images/icons/16/calendar.png"},
				{img: "/k/kui/images/icons/16/car.png"},
				"-",
				{img: "/k/kui/images/icons/16/card.png"},
				{img: "/k/kui/images/icons/16/chest.png"},
				{img: "/k/kui/images/icons/16/door.png"},
				{img: "/k/kui/images/icons/16/file-set.png"},
				"-",
				{img: "/k/kui/images/icons/16/forbid.png"},
				{img: "/k/kui/images/icons/16/next.png"},
				{img: "/k/kui/images/icons/16/operate-adjust.png"},
				{img: "/k/kui/images/icons/16/msn.png"},
				{img: "/k/kui/images/icons/16/mail.png"},
				"-",
				{text: "删除按钮", icon: "del", id: "del", click: function () {
					var g = $.ligerui.get("bwef").destroy();
					$.ligerui.get("del").destroy()
	...
	function init_detail1() {
		//top.$.dialog.alert("自定义初始化页面init函数",function(){api.close();},api);
		...
		//top.$.dialog.tips("系统开发完成系统开发完成系统开发完成系统开发完成系统开发完成",3,"k/kui/images/icons/dialog/32X32/hits.png",function(){alert("是不");},0);
		//top.$.dialog.notice("系统开发完成系统开发完成系统开发完成系统开发完成系统开发完成",3,"k/kui/images/icons/dialog/32X32/hits.png",function(){alert("是不");},0);
		...
		var manager = $.ligerDialog.waitting('正在保存中2,请稍候...'); setTimeout(function () { manager.close(); }, 1000);
		$.ligerDialog.open({url: 'demo/demo_detail8.jsp', title: "我们是窗口", width: 400, height: 300, modal: true, showMax: true, showMin: true});
	}
	;
...
<div class="scroll-tm">
<form id="form1" action="demo/test.json" getAction="demo/test.json" showToolbar="false">
    ...
    <table border="1" cellpadding="3" cellspacing="0" width="" class="l-detail-table">
        ...
        <tr>
            ...
            <td class="l-t-td-right"><input type="text" name="com2" id="com2-txt" ltype="select" value="2"
											validate="{required:true}"
											ligerui="{explain:'说明是什么。',onSelected:tt,treeLeafOnly:false,valueField:'code',initValue:'1',tree:{async:false,checkbox:false,url: 'demo/tree.json' }}"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="l-t-td-right"><input type="checkbox" name="checkbox1" ltype="checkboxGroup"
											validate="{required:true}"
											ligerui="{onSuccess:test,initValue:'1', url:'demo/group.json' }"/></td>
        ...
        <tr>
            ...
            <td class="l-t-td-right"><input type="checkbox" name="checkbox2" ltype="checkboxGroup"
											validate="{required:true}"
											ligerui="{onSuccess:test,lineWrap:false, url:'demo/group.json' }"/></td>
