(function ($) {
    ...
    $.fn.extend({
        ...
        searchMeme: function (options) {
            ...
            var settings = $.extend({ animationSpeed: 300, defaultText: '搜索什么...', button: 'orange', buttonPlacement: 'left', onSearch: null, searchComplete: false }, options);
            ...
            return this.each(function () {
                ...
                searchButton.mouseenter(function () {
                    ...
                    if (settings.buttonPlacement == 'left') {
                        ...
                        searchBox.addClass('searchMeme-water-mark').animate({ marginLeft: 0, paddingLeft: p, paddingRight: p }, settings.animationSpeed,function(){
							searchButton.addClass('' + settings.button + '-hover');
						});
					}
                ...
                $(document).click(function (e) {
                    ...
                    if (settings.buttonPlacement == 'left') {
						...
						searchButton.removeClass('' + settings.button + '-hover');
