...
$(function () {
        ...
        if(pageStatus=="add"){
            ...
            $("#form1").initForm({
                ...
                getSuccess: function(resp){
                	 //初始化派车单
                    if(resp.data.carApplyIds&&resp.data.carApplyIds!=null&&resp.data.carApplyIds!='null'&&pageStatus == "${param.pageStatus}"){
  	                   	$.post("car/apply/getDetail.do",{id:resp.data.carApplyIds},function(resp){
      ...
      //签名
        ...
        /* function printView(){
            ...
            for(var i=0;i<cars.length;i++){
	            LODOP.NewPage();
	            LODOP.ADD_PRINT_HTML('90px', '80px', "770px", "520px",
	            		strBodyStyle + "<style>table{margin:0 auto;}</style><body>"+$("#car"+i).html()+"</body>");
	            LODOP.SET_PRINT_STYLEA(0,"HtmWaitMilSecs",1000);//设置上一项延迟超文本下载1000毫秒
            } 
            LODOP.SET_PRINT_PAGESIZE (2, 0, 0,"B5(ISO)");
...
<base
	...
	<form id="form1" action="finance/pxfbxd/save.do"
		getAction="finance/pxfbxd/detail.do?id=${param.id}">
		...
		<input type="hidden" value="<%=user %>" id="user" name="user" /> <input
			...
			value="" id="departmentId" name="departmentId"> <input
			type="hidden" value="" id="carApplyIds" name="carApplyIds">
		...
		<table class="l-detail-table has-head-image"
			...
			<tr>
				...
				<td class="l-t-td-right" colspan="22"><input
					validate="{maxlength:50}" ltype="text" id="carApplyNumbers"
			...
			<tr id="data_tr1">
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" name="clQdR1" type="text" ltype="date"
					validate="{required:false}" ligerui="{initValue:'',format:'MM-dd'}"
					id="advance_time"/></td>
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" ltype='text' name="clQdDm1" type="text" />
				</td>
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" name="clZdR1" type="text" ltype="date"
					validate="{required:false}" ligerui="{initValue:'',format:'MM-dd'}"
					id="advance_time"/>
				</td>
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" ltype='text' name="clZdDd1" type="text" />
				</td>
				<td class="l-t-td-right"><input validate="{maxlength:32}"
					ltype='text' name="clJtfDj1" onkeydown="NonNegative(this)"
					onkeyup="SunAmount();" type="text" id="clJtfDj1"
					class="underlineinput" /></td>
				<td class="l-t-td-right" colspan="2"><input
					onkeydown="onlyNonNegative(this)" validate="{maxlength:32}"
				...
				<td class="l-t-td-right"><input validate="{maxlength:32}"
					...
					class="underlineinput" /></td>
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" ltype='text' name="clZsfJe1"
				...
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" ltype='text' name="clHsbzJe1"
					onkeydown="onlyNonNegative(this)" onkeyup="SunAmount();"
				...
				<td class="l-t-td-right"><input validate="{maxlength:32}"
					...
					class="underlineinput" onkeyup="sumAmount();" /></td>
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" ltype='text' name="clGzfJe1"
					onkeydown="onlyNonNegative(this)" onkeyup="SunAmount();"
				...
				<td class="l-t-td-right"><input validate="{maxlength:32}"
					...
					class="underlineinput" onkeyup="sumAmount();" /></td>
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" ltype='text' name="clQtJe1"
					onkeydown="onlyNonNegative(this)" type="text"
					onkeyup="SunAmount();" id="clQtJe1" title="只能输入数字"
					class="underlineinput" /></td>
				<td class="l-t-td-right" colspan="2"><input
					validate="{maxlength:32}" ltype='text' name="clJexj1"
			...
			<tr id="data_tr2">
				<td class="l-t-td-right" colspan="2"><input name="clQdR2"
					...
					ligerui="{initValue:'',format:'MM-dd'}" id="advance_time"/></td>
			...
			<tr id="data_tr5">
                <td class="l-t-td-right" colspan="2">
                	<input  name="clQdR5"type="text" ltype="date" 
                	validate="{required:false}"ligerui="{initValue:'',format:'MM-dd'}" 
                	id="advance_time"/></td>
                <td class="l-t-td-right" colspan="2">
			...
			<tr>
				...
				<td class="l-t-td-right"><input ltype='text' name="clHjQtDj"
					onfocus="this.blur()" onkeyup="sumAmount();"
					onkeydown="SunAmount();" type="text" id="clHjQtDj"
					class="underlineinput" /></td>
				<td class="l-t-td-right" colspan="2"><input ltype='text'
					...
					onkeyup="sumAmount();" /></td>
				<td class="l-t-td-right" colspan="2"><input
					onfocus="this.blur()" ltype='text' onkeydown="SunAmount();"
					type="text" class="underlineinput" /></td>
			</tr>
			<tr>
				<td class="l-t-td-left" colspan="8" align="center">合计</td>
				<td colspan="12" class="l-t-td-right"><input ltype='text'
					onfocus="this.blur()" onkeydown="SunAmount();" type="text"
					name="clXj1" id="clXj1" class="underlineinput" /></td>
				</td>
				<td class="l-t-td-right" colspan="3"><input ltype='text'
					onfocus="this.blur()" name="xiaoji1" id="xiaoji1"
					onkeydown="SunAmount();" type="text" class="underlineinput"
					onkeyup="sumAmount();" /></td>
				<td class="l-t-td-right" colspan="2"><input
					onfocus="this.blur()" ltype='text' onkeydown="SunAmount();"
					type="text" class="underlineinput" /></td>
			...
			<tr>
				...
				<td class="l-t-td-right" colspan="7" rowspan="2"><span><input
						readonly="readonly" name="clHjRmbdx" ltype='text' id="clHjRmbdx"
						value="" /></span></td>
				<td class="l-t-td-left" rowspan="2" colspan="3">金额合计</td>
				<td class="l-t-td-right" colspan="3" rowspan="2"><input
					onfocus="this.blur()" ltype='text' onkeydown="SunAmount();"
					name="clHjJexj" type="text" id="clHjJexj" class="underlineinput" />
				</td>
			...
			<tr>
				<td class="l-t-td-right" colspan="2"><input ltype='text'
					validate="{maxlength:32}" name="clXj" type="text" id="Cash"
					class="underlineinput" /></td>
				<td class="l-t-td-right" colspan="2"><input ltype='text'
					validate="{maxlength:32}" name="clGwk" type="text"
					id="BusinessCard" class="underlineinput" /></td>
				<td class="l-t-td-right" colspan="2"><input ltype='text'
					validate="{maxlength:32}" name="clZz" type="text" id="Transfer"
					class="underlineinput" /></td>
				<td class="l-t-td-right" colspan="2"><input ltype='text'
					validate="{maxlength:32}" name="clCz" type="text" id="clCz"
					class="underlineinput" /></td>
			</tr>
		</table>
		...
		<div id="car0" style="display: none;">
			<h2
				style='text-align: left; text-indent: 200px; letter-spacing: 8px; margin-bottom: 10px;'>四川省特检院派公务用车申请单</h2>
			<table class="l-detail-table has-head-image"
				style="margin: 0px; padding: 0px" width="770px">
				<tr>
					...
					<td class="l-t-td-right" style="width: 150px"><input
						type="text" ltype="text" name="apply_sn0"></td>
				</tr>
				<tr>
					<td class="l-t-td-left">用车部门</td>
					<td class="l-t-td-right"><input name="use_dep_name0"
						type="text" ltype='text' /></td>
					<td class="l-t-td-left">联系人</td>
					<td class="l-t-td-right"><input type="text"
						name="use_user_name0" ltype="text" /></td>
					<td class="l-t-td-left">联系电话</td>
					<td class="l-t-td-right"><input type="text"
						name="use_user_phone0" ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left" rowspan="2">具体用车任务</td>
					<td class="l-t-td-right" rowspan="2"><input type="text"
						name="apply_reason0" ltype="text" /></td>
					<td class="l-t-td-left">出车时间</td>
					<td class="l-t-td-right"><input name="out_date0" type="text"
						ltype="date" ligerui="{format:'yyyy-MM-dd hh:mm'}" /></td>
					<td class="l-t-td-left" rowspan="2">用车部门负责人签字</td>
					<td class="l-t-td-right" rowspan="2"><img class="dept_id"
						src=""></td>
				</tr>
				<tr>
					<td class="l-t-td-left">返回时间</td>
					<td class="l-t-td-right"><input name="back_date0" type="text"
						ltype="date" ligerui="{format:'yyyy-MM-dd hh:mm'}" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">行驶线路</td>
					<td class="l-t-td-right" colspan="5"><input type="text"
						name="drive_route0" ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">分院领导意见</td>
					<td class="l-t-td-right" style="border-right: none;"><input
						type="radio" name="leader_deal_result0" ltype="radioGroup"
						ligerui="{data: [ { text:'同意', id:'1' }, { text:'不同意', id:'2' } ] }" />
					</td>
					<td class="l-t-td-right" style="border-left: none;"><img
						class="leader_id" alt="" src=""></td>
					<td class="l-t-td-left">办公室负责人意见</td>
					<td class="l-t-td-right" style="border-right: none;"><input
						type="radio" name="office_deal_result0" ltype="radioGroup"
						ligerui="{data: [ { text:'同意', id:'1' }, { text:'不同意', id:'2' } ] }" />
					</td>
					<td class="l-t-td-right" style="border-left: none;"><img
						class="office_id" alt="" src=""></td>
				</tr>
				<tr>
					<td class="l-t-td-left" rowspan="2">车队负责人签字</td>
					<td class="l-t-td-right" rowspan="2"><img class="fleet_id"
						alt="" src=""></td>
					<td class="l-t-td-left">车牌号</td>
					<td class="l-t-td-right"><input type="text"
						name="plate_number0" ltype="text" /></td>
					<td class="l-t-td-left">公里起数</td>
					<td class="l-t-td-right"><input type="text" name="start_km0"
						ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">驾驶员</td>
					<td class="l-t-td-right"><input type="text"
						name="driver_user_name0" ltype="text" /></td>
					<td class="l-t-td-left">公里止数</td>
					<td class="l-t-td-right"><input type="text" name="end_km0"
						ltype="text" /></td>
				</tr>
				<tr>
		...
		<div id="car1" style="display: none;">
			...
			<table class="l-detail-table has-head-image"
				...
				<tr>
					...
					<td class="l-t-td-left" style="width: 100px">编号</td>
					<td class="l-t-td-right" style="width: 150px"><input
						type="text" ltype="text" name="apply_sn1"></td>
				</tr>
				<tr>
					<td class="l-t-td-left">用车部门</td>
					<td class="l-t-td-right"><input name="use_dep_name1"
						type="text" ltype='text' /></td>
					<td class="l-t-td-left">联系人</td>
					<td class="l-t-td-right"><input type="text"
						name="use_user_name1" ltype="text" /></td>
					<td class="l-t-td-left">联系电话</td>
					<td class="l-t-td-right"><input type="text"
						name="use_user_phone1" ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left" rowspan="2">具体用车任务</td>
					<td class="l-t-td-right" rowspan="2"><input type="text"
						name="apply_reason1" ltype="text" /></td>
					<td class="l-t-td-left">出车时间</td>
					<td class="l-t-td-right"><input name="out_date1" type="text"
						ltype="date" ligerui="{format:'yyyy-MM-dd hh:mm'}" /></td>
					<td class="l-t-td-left" rowspan="2">用车部门负责人签字</td>
					<td class="l-t-td-right" rowspan="2"><img class="dept_id"
						src=""></td>
				...
				<tr>
					<td class="l-t-td-left">返回时间</td>
					<td class="l-t-td-right"><input name="back_date1" type="text"
						ltype="date" ligerui="{format:'yyyy-MM-dd hh:mm'}" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">行驶线路</td>
					<td class="l-t-td-right" colspan="5"><input type="text"
						name="drive_route1" ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">分院领导意见</td>
					<td class="l-t-td-right" style="border-right: none;"><input
						type="radio" name="leader_deal_result1" ltype="radioGroup"
						ligerui="{data: [ { text:'同意', id:'1' }, { text:'不同意', id:'2' } ] }" />
					</td>
					<td class="l-t-td-right" style="border-left: none;"><img
						class="leader_id" alt="" src=""></td>
					<td class="l-t-td-left">办公室负责人意见</td>
					<td class="l-t-td-right" style="border-right: none;"><input
						type="radio" name="office_deal_result1" ltype="radioGroup"
						ligerui="{data: [ { text:'同意', id:'1' }, { text:'不同意', id:'2' } ] }" />
					</td>
					<td class="l-t-td-right" style="border-left: none;"><img
						class="office_id" alt="" src=""></td>
				...
				<tr>
					...
					<td class="l-t-td-left">车牌号</td>
					<td class="l-t-td-right"><input type="text"
						name="plate_number1" ltype="text" /></td>
					<td class="l-t-td-left">公里起数</td>
					<td class="l-t-td-right"><input type="text" name="start_km1"
						ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">驾驶员</td>
					<td class="l-t-td-right"><input type="text"
						name="driver_user_name1" ltype="text" /></td>
					<td class="l-t-td-left">公里止数</td>
					<td class="l-t-td-right"><input type="text" name="end_km1"
						ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left" colspan="6"
		...
		<div id="car2" style="display: none;">
			...
			<table class="l-detail-table has-head-image"
				...
				<tr>
					...
					<td class="l-t-td-left" style="width: 100px">编号</td>
					<td class="l-t-td-right" style="width: 150px"><input
						type="text" ltype="text" name="apply_sn2"></td>
				</tr>
				<tr>
					<td class="l-t-td-left">用车部门</td>
					<td class="l-t-td-right"><input name="use_dep_name2"
						type="text" ltype='text' /></td>
					<td class="l-t-td-left">联系人</td>
					<td class="l-t-td-right"><input type="text"
						name="use_user_name2" ltype="text" /></td>
					<td class="l-t-td-left">联系电话</td>
					<td class="l-t-td-right"><input type="text"
						name="use_user_phone2" ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left" rowspan="2">具体用车任务</td>
					<td class="l-t-td-right" rowspan="2"><input type="text"
						name="apply_reason2" ltype="text" /></td>
					<td class="l-t-td-left">出车时间</td>
					<td class="l-t-td-right"><input name="out_date2" type="text"
						ltype="date" ligerui="{format:'yyyy-MM-dd hh:mm'}" /></td>
					<td class="l-t-td-left" rowspan="2">用车部门负责人签字</td>
					<td class="l-t-td-right" rowspan="2"><img class="dept_id"
						src=""></td>
				...
				<tr>
					<td class="l-t-td-left">返回时间</td>
					<td class="l-t-td-right"><input name="back_date2" type="text"
						ltype="date" ligerui="{format:'yyyy-MM-dd hh:mm'}" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">行驶线路</td>
					<td class="l-t-td-right" colspan="5"><input type="text"
						name="drive_route2" ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">分院领导意见</td>
					<td class="l-t-td-right" style="border-right: none;"><input
						type="radio" name="leader_deal_result2" ltype="radioGroup"
						ligerui="{data: [ { text:'同意', id:'1' }, { text:'不同意', id:'2' } ] }" />
					</td>
					<td class="l-t-td-right" style="border-left: none;"><img
						class="leader_id" alt="" src=""></td>
					<td class="l-t-td-left">办公室负责人意见</td>
					<td class="l-t-td-right" style="border-right: none;"><input
						type="radio" name="office_deal_result2" ltype="radioGroup"
						ligerui="{data: [ { text:'同意', id:'1' }, { text:'不同意', id:'2' } ] }" />
					</td>
					<td class="l-t-td-right" style="border-left: none;"><img
						class="office_id" alt="" src=""></td>
				...
				<tr>
					...
					<td class="l-t-td-left">车牌号</td>
					<td class="l-t-td-right"><input type="text"
						name="plate_number2" ltype="text" /></td>
					<td class="l-t-td-left">公里起数</td>
					<td class="l-t-td-right"><input type="text" name="start_km2"
						ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left">驾驶员</td>
					<td class="l-t-td-right"><input type="text"
						name="driver_user_name2" ltype="text" /></td>
					<td class="l-t-td-left">公里止数</td>
					<td class="l-t-td-right"><input type="text" name="end_km2"
						ltype="text" /></td>
				</tr>
				<tr>
					<td class="l-t-td-left" colspan="6"
