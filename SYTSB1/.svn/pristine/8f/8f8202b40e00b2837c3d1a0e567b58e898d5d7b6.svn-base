...
@Entity
@Table(name = "TJY2_SEAL_REG_SUG")
public class TxwjspSealRegSug implements BaseEntity{
    ...
    private String spName;//当前处理环节名称
    ...
    @Column(name ="SP_TIME",unique=false,nullable=true,insertable=true,updatable=true,length=100)
    public java.util.Date getSpTime(){
        return this.spTime;
    }
    @Column(name ="SP_RESULT",unique=false,nullable=true,insertable=true,updatable=true,length=100)
    public String getSpResult(){
        return this.spResult;
    }
    @Column(name ="SP_LEVEL",unique=false,nullable=true,insertable=true,updatable=true,length=100)
    ...
    @Column(name ="SP_NAME",unique=false,nullable=true,insertable=true,updatable=true,length=100)
