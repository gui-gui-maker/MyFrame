...
<script type="text/javascript">
	...
	function initPage(){
  	...
  	function saveCurrentDocument() {
		...
		var response = TANGER_OCX_OBJ.SaveToURL("${pageContext.request.contextPath}/fileupload/fileUp.do?attType=0&id=&folder="+folder+"&fname=${param.report_sn}_b","docFile", "","cs.pdf");
