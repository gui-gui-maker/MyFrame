...
<script type="text/javascript">
	...
	function doAudit(){
		...
		$.post("report/query/getTime.do",{"id":"${param.id}"},function(data){
			if(data.success){
				//取时间
...
<body>
	<form id="formObj" action="" getAction="" style="border: 0px;width: 100%;height:100%;">

		<iframe id="contain"
			src="rtbox/app/templates/index.jsp?code=${param.code}
			&pageStatus=detail&status=modify&fk_report_id=${param.fk_report_id }&id=${param.id }"
