...
/**
 * 检验报告/证书不符合纠正流转明细数据传输对象
 * ReportErrorRecordDTO 
 * @author GaoYa
 * @date 2015-09-25 11:05:00
 */
public class ReportErrorRecordDTO{	
	private String id;	//	ID
	private String sn;	//  纠正编号（编号规则： 2015-0001）
	...
	/*业务服务部外借报告*/
	private String is_borrow_report;	// 是否借报告（数据字典IS_BORROW_REPORT 0：否 1：是）		
	...
	private String info_id;				// 纠错报告业务id
