...
/**
 * 压力容器制造监督检验报检业务明细表数据传输对象
 * @ClassName InspectionZZJDInfoDTO
 * @JDK 1.6
 * @author GaoYa
 * @date 2015-01-23 下午05:35:00
 */
public class InspectionZZJDInfoDTO{
	...
	private String  glsjwj_jdqd_gtbh;		// 锅筒、汽水分离器、储水罐编号/设计/审核/批准人员/批准日期/备注
	...
	private String  glsjwj_jdqd_rylxttbh;	// 有机热载体锅炉系统图编号/设计/审核/批准人员/批准日期/备注
	...
	private String	inspection_date_str;	// 检验日期/编制日期
	...
	public void setcode_valueC(String code_value) {
	...
	@Transient
	public String getInspection_date_str() {
		return inspection_date_str;
	}
	public void setInspection_date_str(String inspection_date_str) {
		this.inspection_date_str = inspection_date_str;
	}
