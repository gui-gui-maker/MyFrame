...
//                  { text:'查看', id:'detail',icon:'detail', click:detail}
        ...
        function test(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"录入体检结果",
                content: 'url:app/zp/jltd/otherShowDetail.do?status='+status+'&id='+selectedId+'&flag=1',
                data: {"window": window}
            });
        }
        ...
        function recheck(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"录入复检结果",
                content: 'url:app/zp/jltd/otherShowDetail.do?status='+status+'&id='+selectedId+'&flag=2',
                data: {"window": window}
            });
        }
        //公示结果
        function publicity(){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"录入公示结果",
                content: 'url:app/zp/jltd/otherShowDetail.do?status='+status+'&id='+selectedId+'&flag=4',
                data: {"window": window}
            });
        }
        ...
        function result(item){
            ...
            var windows=top.$.dialog({
                ...
                lock:true,
                title:"选择进入部门",
                content: 'url:app/zp/jltd/otherShowDetail.do?status='+status+'&id='+selectedId+'&flag=5',
                data: {"window": window}
            });
        }
...
<body>
<qm:qm pageid="hr_zp_027" script="false" singleSelect="true" >
