...
function sendMsg(){
	...
	$.post("employee/basic/resetSecondPwd.do?send_msg_type="+send_msg_type, function(resp) {
		if (resp.success) {
...
<body>
	<form name="formObj2" id="formObj2" method="post"
		action="employee/basic/resetSecondPwd.do" style="margin:2em">
			...
			<table id="tab1" border="0" cellpadding="3" cellspacing="0" width="" align="center">
				...
				<tr>
					...
					<td class="l-t-td-right"><c:out
							value="点击【发送】按钮，系统会生成新的独立密码发送至您的手机，请注意查收！"></c:out><br />
					</td>
				</tr>
				<tr>
