...
<head>
    ...
    function init(){
	    ...
	    $.post("department/basic/deviceCountByMedia.do",{"startDate":startDate,"endDate":endDate},function(data){
	    	inputGrid = $("#countGrid").ligerGrid({
	            columns: [
	                 { display: '容器介质', name: 'mediaCode',align: 'center', width: 130},
					 { display: '设备数量', name: 'count',align: 'center', width: 120}              
	            ], 
...
<div class="item-tm" >
	<div class="l-page-title2 has-icon has-note" style="height: 80px">
		...
		<div class="l-page-title2-text"><h1>容器介质统计</h1></div>
		<div class="l-page-title2-note">以介质为统计对象。</div>
