...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head pageStatus="${param.status}">
		...
		function save(url){
				...
				url = "reportHallAction/saveTransfer.do?device_id=${param.id}&unit_code="+unit_code;
	...
	<form id="form1"  >
				...
				<tr>
						...
						ligerui="{
						readonly:true,
						tree:{checkbox:false,data: <u:dict sql="select t.id, t.parent_id, t.id code, t.org_name text from sys_org t where t.parent_id is not null and status='used' and org_code like '%jd%' and org_code !='jd6'"/>}
						}"/>
