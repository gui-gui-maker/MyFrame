    ...
    var qmUserConfig = {
    	...
    	function add() {
    		top.$.dialog({
    			...
    			title: "新增",
    			content: 'url:app/fwxm/dining/food_detail.jsp?pageStatus=add'
    		});
    	}
    	function detail() {
    		...
    		top.$.dialog({
    			...
    			title: "详情",
    			content: 'url:app/fwxm/dining/food_detail.jsp?id=' + id + '&pageStatus=detail'
    		});
    	}
    	function edit() {
    		var id = Qm.getValueByName("id");
    		top.$.dialog({
    			...
    			title: "修改",
    			content: 'url:app/fwxm/dining/food_detail.jsp?id=' + id + '&pageStatus=modify'
    		});
    	}
    	function del() {
    		$.del(kFrameConfig.DEL_MSG, "dining/food/deleteFood.do", {
...
<body>
	<qm:qm pageid="food_maintenace"></qm:qm>
</body>
</html>
