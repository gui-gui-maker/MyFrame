	...
	$(function(){
		$.get("report/query/getPrintTagsDataNew.do?id=${param.inspection_info_id}&report_id=${param.report_id}&device_id=${param.device_id}",function(res){
			if(res.success){
				...
				LODOP.SET_PRINT_PAGESIZE(0,"30.0cm","45.0cm","");
			 	LODOP.ADD_PRINT_TEXT("5.45cm","10cm",400,50,getDeviceType(res.device_sort_code));
			 	 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				 LODOP.SET_PRINT_STYLEA(0,"Bold",1); 
				 if(res.device_sort!=null&&res.device_sort!="undefined"&&res.device_sort.length>9){
					 LODOP.ADD_PRINT_TEXT("4.47cm","31.4cm",430,50,res.device_sort);
					 LODOP.SET_PRINT_STYLEA(0,"LineSpacing",-10); 
				}else{
					LODOP.ADD_PRINT_TEXT("5.45cm","31.4cm",430,50,res.device_sort);
				} 
				 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				 LODOP.SET_PRINT_STYLEA(0,"Bold",1);
				
				if(res.company_name!=null&&res.company_name.length>24){
					 LODOP.ADD_PRINT_TEXT("8.65cm","10cm",1000,110,res.company_name);
					 LODOP.SET_PRINT_STYLEA(0,"LineSpacing",-7);
				}else{
					LODOP.ADD_PRINT_TEXT("8.65cm","10cm",1000,50,res.company_name);
				}
				 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				 LODOP.SET_PRINT_STYLEA(0,"Bold",1);
				
				LODOP.ADD_PRINT_TEXT("11.72cm","10cm",400,50,res.internal_num);
				 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				 LODOP.SET_PRINT_STYLEA(0,"Bold",1);
				 
				LODOP.ADD_PRINT_TEXT("11.72cm","31.4cm",430,50,res.device_code);
				 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				 LODOP.SET_PRINT_STYLEA(0,"Bold",1);
				
				LODOP.ADD_PRINT_TEXT("14.75cm","10cm",800,50,res.registration_agencies);
				 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				 LODOP.SET_PRINT_STYLEA(0,"Bold",1);
				
				LODOP.ADD_PRINT_TEXT("17.82cm","10cm",800,50,"四川省特种设备检验研究院");
				 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				 LODOP.SET_PRINT_STYLEA(0,"Bold",1);
				

				LODOP.ADD_PRINT_TEXT("20.71cm","10cm",400,50,res.registration_num);
				 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 if(res.registration_num!=null&&res.registration_num.length<18){
					 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				}else{
					 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				}
				...
				LODOP.ADD_PRINT_TEXT("20.81cm","31.4cm",430,50,res.inspect_next_date);
				 LODOP.SET_PRINT_STYLEA(0,"ReadOnly",2);
				 LODOP.SET_PRINT_STYLEA(0,"FontSize",30);
				 LODOP.SET_PRINT_STYLEA(0,"Bold",1);
				
				 LODOP.ADD_PRINT_HTM("23.8cm","37.28cm","5.3cm","5.3cm",
				...
				//LODOP.ADD_PRINT_BARCODE("5.0cm","10.5cm","2.6cm","2.6cm","QRCode","http://111.9.177.232//baseDeviceDocumentAction/getMobileInfo.do?id=${param.id}");
			  	...
			  	//LODOP.PREVIEW();
			  	/* LODOP.ADD_PRINT_SETUP_BKIMG("<img border='0' src='"+$("base").attr("href")+"/app/device/usesign/img/yl.jpg'>");
...
<img style="width: 52mm;height: 52mm;" 
					src="" alt=""
					id="cs" />
</div>
</body>
