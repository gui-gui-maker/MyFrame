...
<html lang="zh-CN">
	...
	<body class="no-skin">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form id="fileUploadForm" class="form-horizontal" role="form" enctype="multipart/form-data" action="/lyjh/uploadDbf">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											<button class="btn btn-info" type="button" onclick="UpladFile()">
		...
		function UpladFile() {
            ...
            var fileObj = document.getElementById("id-input-file-3").files[0]; // 获取文件对象

            var FileController = $("#fileUploadForm").attr("action");   // 接收上传文件的后台地址 
            ...
            xhr.onload = function () {
            	...
            	//只有在readyState==4时才会执行

            };
            xhr.onreadystatechange = function(){
            	if (xhr.readyState == 4 && xhr.status == 200)
                {
            		var dataObj=eval("("+this.responseText+")");
            		if(dataObj.success){
            			alert("成功上传："+dataObj.data+"条数据")
            		}else{
            			alert("上传失败："+dataObj.msg)
            		}
                }
            };
