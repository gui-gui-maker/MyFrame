...
import com.guido.repository.impl.BaseListRepositoryImpl;
import com.guido.repository.impl.BaseYxRepositoryImpl;
import com.guido.util.StringUtil;


@Controller
@RequestMapping("baseList")
public class BaseListWeb {
	@Autowired
	BaseListRepositoryImpl baseListRepositoryImpl;
	@Autowired
	BaseYxRepositoryImpl baseYxRepositoryImpl;
	
	@RequestMapping(value="catalog")
	@ResponseBody
	public List<BaseList> catalog(){
		
		return baseListRepositoryImpl.findALL(null);
	}
	/*
	@RequestMapping(value="catalog")
	@ResponseBody
