...
<%
String dict_zylb = UserDictUtil.dict(CodeZylb.class, "zylbdm", "zylbmc",null);
String dict_pc = UserDictUtil.dict(CodePc.class, "pcdm", "pcmc",null);
String dict_kl = UserDictUtil.dict(CodeKl.class, "kldm","klmc",null);
String dict_jhxz = UserDictUtil.dict(CodeJhxz.class, "jhxzdm","jhxzmc",null);
String dict_jhlb = UserDictUtil.dict(CodeJhlb.class, "jhlbdm","jhlbmc",null);
String dict_zklx = UserDictUtil.dict(CodeZklx.class, "zklxdm","zklxmc",null);
							...
							<div class="panel-body" style="padding-bottom: 0px;">
								<div id="toolbar" class="btn-group">
									...
									<button id="btn_update" type="button" class="btn btn-default">
										<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>自定义筛选
									</button>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<table id="statistics" class="table table-striped table-bordered table-hover">
												    <thead>
													    <tr >
													        <th style="width:50%;"><button type="button" class="btn btn-default" style="width:100%;height:100%;">添加项</button></th>
													        <th style="width:50%;"><button type="button" class="btn btn-default" style="width:100%;height:100%;">删除项</button></th>
													    </tr>
													    <tr>
													        <th>类别</th>
													        <th>顺序</th>
												    ...
												    <tbody>
													    <tr>
													        <td>
													        	<select name="column" style="padding:0;margin:0;width:100%;height:100%;">
															      <option value=''></option>
															      <option value='yxdm'>院校代码</option>
															      <option value='yxmc'>院校名称</option>
															      <option value='yxdh'>院校代号</option>
															      <option value='yxdhmc'>院校代号名称</option>
															      <option value='dyml'>目录</option>
															      <option value='pcdm'>批次代码</option>
															      <option value='kldm'>科类代码</option>
															      <option value='ccdm'>层次代码</option>
															      <option value='jhxzdm'>计划性质代码</option>
															      <option value='jhlbdm'>计划类别代码</option>
															      <option value='zklxdm'>招考类型代码</option>
															      <option value='zklxmc'>招考类型名称</option>
															      <option value='sddm'>属地代码</option>
															      <option value='bxddssmc'>省</option>
															      <option value='bxdddjsmc'>市</option>
															      <option value='bxddqxmc'>区县</option>
															      <option value='zylbdm'>专业类别代码</option>
															      <option value='sbzydh'>省编专业代号</option>
															      <option value='xbzydh'>校编专业代号</option>
															      <option value='zydm'>专业代码</option>
															      <option value='zszymc'>专业名称</option>
															      <option value='cc'>层次</option>
															      <option value='pc'>批次</option>
													        	</select>
												        	</td>
													        <td><input name="index" value="" style="padding:0;margin:0;width:100%;height:100%;"></td>
													    </tr>
												    </tbody>
												</table>
		...
		<script type="text/javascript">
			...
			$(function() {
				$("#year").bind("change", function() {
					setSelectOptions($("#pcdm"),dict["pcdm"],{version:this.value.substring(2)},function(data){
						//如果是插件需要刷新
						$("#pcdm").selectpicker("refresh");
					});
					setSelectOptions($("#kldm"),dict["kldm"],{version:this.value.substring(2)},function(data){
						//如果是插件需要刷新
						$("#kldm").selectpicker("refresh");
					});
					setSelectOptions($("#jhxzdm"),dict["jhxzdm"],{version:this.value.substring(2)},function(data){
						//如果是插件需要刷新
						$("#jhxzdm").selectpicker("refresh");
					});
					setSelectOptions($("#jhlbdm"),dict["jhlbdm"],{version:this.value.substring(2)},function(data){
						//如果是插件需要刷新
						$("#jhlbdm").selectpicker("refresh");
					});
					setSelectOptions($("#zklxdm"),dict["zklxdm"],{version:this.value.substring(2)},function(data){
						//如果是插件需要刷新
						$("#zklxdm").selectpicker("refresh");
					});
				})
