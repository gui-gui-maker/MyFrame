...
<html lang="en">
	...
	<body class="no-skin">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<div class="col-xs-9">
								...
								<form id="resourceDetail" class="form-horizontal">
		...
		<script type="text/javascript" src="/static/assets/js/jquery.ztree.core.js"></script>
		<script type="text/javascript" src="/static/assets/js/jquery.ztree.excheck.js"></script>
		<script type="text/javascript" src="/static/assets/js/jquery.ztree.exedit.js"></script>
		<script type="text/javascript">
