	...
	<body class="no-skin">
		...
		<script type="text/javascript">
			...
			function InitMainTable() {
				var queryUrl = '/jhtzAction/statisticsPcAddJh?rnd=' + Math.random();
				$table= $("#dataTable").bootstrapTable({
					...
					columns : [ [{"title": "各批次计划增加","halign":"center","align":"center","colspan": 7}],
	                    		[
	                    			{field:'pcdm',title:'批次代码'},
	                    			{field:'pcmc',title:'批次'},
									{field:'kldm',title:'科类代码'},
									{field:'jhxz',title:'计划性质代码'},
									{field:'jhxzmc',title:'计划性质'},
									{field:'cc',title:'层次'},
									{field:'zjjh',title:'计划数'}
								]
