							...
							<div class="col-xs-12">
								<form id="formSearch" class="form-horizontal">
				                    <div class="form-group" style="margin-top:15px">
				                        <label class="control-label col-sm-1" style="margin-left: 20px;" for="yxdh">院校名称</label>
				                        <div class="col-sm-2">
				                            <input type="text" class="form-control" id="yxdh" name="yxdh">
				                        </div>
				                        <label class="control-label col-sm-1" style="width: 120px" for="yxmc">科类</label>
				                        <div class="col-sm-2">
				                            <input type="text" class="form-control" id="yxmc">
				                        </div>
				                        <label class="control-label col-sm-1" style="width: 120px" for="yxmc">专业</label>
				                        <div class="col-sm-2">
				                            <input type="text" class="form-control" id="yxmc">
				                        </div>
			...
			jQuery(function($) {
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "json",
					height: 140,
					colNames:[' ','JHID','院校名称','院校代码', '专业', '批次','科类','层次','计划性质','计划类别','专业类别','报考类型','计划数'],
					colModel:[
						...
						{name:'yxmc',index:'yxmc', width:60, autowidth:true, sorttype:"text"},
						{name:'yxdm',index:'yxdm', width:60, autowidth:true, sorttype:"text"},
						{name:'zszymc',index:'zszymc', width:60, autowidth:true, sorttype:"text"},
						{name:'pcdm',index:'pcdm', width:60, autowidth:true,sorttype:"text"},
						{name:'kldm',index:'kldm', width:60, autowidth:true, sorttype:"text"},
						{name:'ccdm',index:'ccdm', width:60, autowidth:true, sorttype:"text"},
						{name:'jhxzdm',index:'jhxzdm', width:60, autowidth:true, sorttype:"text"},
						{name:'jhlbdm',index:'jhlbdm', width:60, autowidth:true, sorttype:"text"},
						{name:'zylbdm',index:'zylbdm', width:60, autowidth:true, sorttype:"text"},
						{name:'zklxdm',index:'zklxdm', width:60, autowidth:true, sorttype:"text"},
						{name:'zsjhs',index:'zsjhs', width:60, autowidth:true,sorttype:"text"}
					], 
					...
					editurl: "/jyjh/save",//nothing is saved
