...
<html lang="en">
	<head>
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="/static/bootstrap/css/ace-part2.min.css" />
		<![endif]-->
	...
	<body class="login-layout">
		...
		<![endif]-->
		<script src="/static/bootstrap/js/form.js"></script>
		...
		<script type="text/javascript">
			...
			$(function(){
		        ...
		        var rememberMe = logininfo[2];
		        //èªå¨å¡«åç¨æ·ååå¯ç 
		        if(rememberMe){
