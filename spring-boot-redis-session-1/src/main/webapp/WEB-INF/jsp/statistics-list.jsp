...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/static/bootstrap/css/ui.jqgrid.min.css" />
	...
	<body class="no-skin">
		...
		<script type="text/javascript">
			...
			function InitMainTable() {
				var queryUrl = '/statisticsWeb/statisticsJhsByCatalog?rnd=' + Math.random();
