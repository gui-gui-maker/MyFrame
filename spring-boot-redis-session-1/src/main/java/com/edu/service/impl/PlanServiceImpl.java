...
public class PlanServiceImpl implements PlanService{
	...
	@Override
	public List<Plan> findAllApplyPlan() throws Exception {
		// TODO Auto-generated method stub
		return planDao.findAllApplyPlan();
	}
	@Override
	public List<PlanParam> findByYxdhAndDyml(String yxdh, String dyml) throws Exception {
		// TODO Auto-generated method stub
		return planJDao.findByYxdhAndDyml(yxdh,dyml);
	}
	@Override
	public List<PlanParam> queryMajors(String yxdh, String dyml) throws Exception {
		// TODO Auto-generated method stub
		return planJDao.queryMajors(yxdh, dyml);
	}
