...
import com.neo.repository.AnalysisDao;
...
public class AnalysisDaoImpl implements AnalysisDao{
    ...
    public List<Analysis> findByParams(String yxdh,String kldm,String zydh,int Score) {
		...
		if(!StringUtils.isEmpty(zydh)) {
			sql.append("        and yxdh in ('"+zydh.replaceAll(",", "','")+"')");
		} 
        ...
        return jdbcTemplate.query(sql.toString(), new BeanPropertyRowMapper(Analysis.class));
    }
}
