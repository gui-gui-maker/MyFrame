...
public class User2MapperTest {
	...
	public void testInsert() throws Exception {
		userMapper.insert(new User("aammxd2", "a123456", UserSexEnum.MAN));
		userMapper.insert(new User("bbmmxd2", "b123456", UserSexEnum.WOMAN));
		userMapper.insert(new User("ccmmxd2", "b123456", UserSexEnum.WOMAN));
